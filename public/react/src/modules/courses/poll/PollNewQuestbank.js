...
const $ = window.$;
class PollNewQuestbank extends Component {
	// 题库的问卷新建和编辑
	//
	// * addonAfter  字数限制
	// * q_counts  题目总数
		...
		if (object.question.new === "new") {
			...
			if (object.question.question_type === 1) {
				...
				questiontwo = {
					...
					"is_necessary": object.question.is_necessary,
					"question_number": 3,
					"question_title": this.contentMdRef.current.getValue().trim(),
					"question_type": 3,
					"new": "",
					"answers": answers
				};
		...
		return (
			<div className=" clearfix">
				...
				<div className="educontent mb50">
					...
					{/*		 onClick={() => this.gotohome()}>{this.props.coursedata.name}</a>*/}
					...
					{/*<Form {...formItemLayout} onSubmit={this.handleSubmit}>*/}
					{
						this.state.mysave === false ?
							<div style={{background: '#fff', minHeight: "75px", padding: "30px"}} className="mt10">
								...
								<div className="displayDescription color-grey-9"
                  ...
                  `}
									...
									<WordNumberTextarea
										placeholder={"请输入本次问卷答题的相关说明，最大限制100个字符"}
					...
					<div className="edu-back-white">
                      ...
                      <a onClick={() => this.adddomedit(item,index)}><Tooltip title="编辑"><i
								...
								<p className="mt20"><span className="font-16  flex1" style={{
					...
					>
						<li className="clearfix mt30 mb50 fr">
							{/*<a className="defalutCancelbtn fl mr20" onClick={() => this.toWorkDetail()}></a>*/}
							<a type="primary" className="  defalutSubmitbtn fl"
								 onClick={() => this.submitQuestionnaire()}>完成</a>
						</li>
					</div>
					{/*</Form>*/}
				</div>
