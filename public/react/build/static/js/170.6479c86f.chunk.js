...
// module
exports.push([module.i, ".branchDropdown{border:1px solid #eee;border-radius:4px;display:-ms-flexbox;display:flex;-ms-flex-pack:center;justify-content:center;padding:0 10px;height:35px;line-height:35px}", "", {"version":3,"sources":["/Users/jasder/work/trustie3.0/forgeplus-react/src/forge/Branch/branch.css"],"names":[],"mappings":"AAAA,gBACE,sBAAsB,AACtB,kBAAmB,AACnB,oBAAqB,AACrB,aAAc,AACd,qBAAsB,AAClB,uBAAwB,AAC5B,eAAiB,AACjB,YAAa,AACb,gBAAkB,CACnB","file":"branch.css","sourcesContent":[".branchDropdown{\n  border:1px solid #eee;\n  border-radius: 4px;\n  display: -ms-flexbox;\n  display: flex;\n  -ms-flex-pack: center;\n      justify-content: center;\n  padding:0px 10px;\n  height: 35px;\n  line-height: 35px;\n}"],"sourceRoot":""}]);
