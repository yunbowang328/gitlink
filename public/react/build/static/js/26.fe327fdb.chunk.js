...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_antd_lib_breadcrumb_style_css__ = __webpack_require__(1328);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_antd_lib_breadcrumb__ = __webpack_require__(1329);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__tpm_TPMIndexHOC__ = __webpack_require__(321);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__courses_common_CNotificationHOC__ = __webpack_require__(332);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__usersInfo_css__ = __webpack_require__(1599);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__usersInfo_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__usersInfo_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__courses_css_members_css__ = __webpack_require__(312);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__courses_css_members_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8__courses_css_members_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__courses_css_Courses_css__ = __webpack_require__(311);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__courses_css_Courses_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9__courses_css_Courses_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_react_loadable__ = __webpack_require__(324);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__Loading__ = __webpack_require__(323);
...
var GtopicBanks=__WEBPACK_IMPORTED_MODULE_10_react_loadable___default()({loader:function loader(){return __webpack_require__.e/* import() */(59/* duplicate */).then(__webpack_require__.bind(null, 3706));},loading:__WEBPACK_IMPORTED_MODULE_11__Loading__["a" /* default */]});var BanksTabIndex=__WEBPACK_IMPORTED_MODULE_10_react_loadable___default()({loader:function loader(){return __webpack_require__.e/* import() */(213).then(__webpack_require__.bind(null, 4874));},loading:__WEBPACK_IMPORTED_MODULE_11__Loading__["a" /* default */]});var GtopicBanksEdit=__WEBPACK_IMPORTED_MODULE_10_react_loadable___default()({loader:function loader(){return __webpack_require__.e/* import() */(105).then(__webpack_require__.bind(null, 4877));},loading:__WEBPACK_IMPORTED_MODULE_11__Loading__["a" /* default */]});var HomeworkBanksEdit=__WEBPACK_IMPORTED_MODULE_10_react_loadable___default()({loader:function loader(){return __webpack_require__.e/* import() */(99).then(__webpack_require__.bind(null, 3510));},loading:__WEBPACK_IMPORTED_MODULE_11__Loading__["a" /* default */]});var ExerciseBanksEdit=__WEBPACK_IMPORTED_MODULE_10_react_loadable___default()({loader:function loader(){return __webpack_require__.e/* import() */(88).then(__webpack_require__.bind(null, 4879));},loading:__WEBPACK_IMPORTED_MODULE_11__Loading__["a" /* default */]});//普通作业题库详情
var Generaljobbankdetails=__WEBPACK_IMPORTED_MODULE_10_react_loadable___default()({loader:function loader(){return __webpack_require__.e/* import() */(200).then(__webpack_require__.bind(null, 4880));},loading:__WEBPACK_IMPORTED_MODULE_11__Loading__["a" /* default */]});//分组作业题库详情
var GroupjobbankPage=__WEBPACK_IMPORTED_MODULE_10_react_loadable___default()({loader:function loader(){return __webpack_require__.e/* import() */(201).then(__webpack_require__.bind(null, 4883));},loading:__WEBPACK_IMPORTED_MODULE_11__Loading__["a" /* default */]});//毕设选题详情
var CompletetopicdePage=__WEBPACK_IMPORTED_MODULE_10_react_loadable___default()({loader:function loader(){return __webpack_require__.e/* import() */(202).then(__webpack_require__.bind(null, 4886));},loading:__WEBPACK_IMPORTED_MODULE_11__Loading__["a" /* default */]});//毕设任务详情
var Completetaskpage=__WEBPACK_IMPORTED_MODULE_10_react_loadable___default()({loader:function loader(){return __webpack_require__.e/* import() */(203).then(__webpack_require__.bind(null, 4890));},loading:__WEBPACK_IMPORTED_MODULE_11__Loading__["a" /* default */]});//问卷编辑
var PollNewQuestbank=__WEBPACK_IMPORTED_MODULE_10_react_loadable___default()({loader:function loader(){return __webpack_require__.e/* import() */(111).then(__webpack_require__.bind(null, 4894));},loading:__WEBPACK_IMPORTED_MODULE_11__Loading__["a" /* default */]});var GtaskBanksEdit=__WEBPACK_IMPORTED_MODULE_10_react_loadable___default()({loader:function loader(){return __webpack_require__.e/* import() */(98).then(__webpack_require__.bind(null, 4895));},loading:__WEBPACK_IMPORTED_MODULE_11__Loading__["a" /* default */]});var BanksIndex=function(_Component){_inherits(BanksIndex,_Component);function BanksIndex(props){_classCallCheck(this,BanksIndex);var _this=_possibleConstructorReturn(this,(BanksIndex.__proto__||Object.getPrototypeOf(BanksIndex)).call(this,props));_this.componentDidMount=function(){// let pathname = this.props.location.pathname;
// this.setState({
//   publicly:pathname.indexOf("/publicly") > -1
// })
};_this.initPublic=function(crumbData,data){if(data&&data.status&&data.status==-2){_this.props.history.push('/topicbank/publicly');}_this.setState({crumbData:crumbData});};_this.state={crumbData:undefined,publicly:undefined};return _this;}_createClass(BanksIndex,[{key:'componentDidUpdate',value:function componentDidUpdate(prevProps){// if(prevProps.current_user!=this.props.current_user){
...
// }
}},{key:'render',value:function render(){var _this2=this;var crumbData=this.state.crumbData;var common={initPublic:this.initPublic};return __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('div',{className:'newMain'},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('div',{className:'educontent'},crumbData&&__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_breadcrumb___default.a,{separator:'>',className:'breadcrumb mt22'},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_breadcrumb___default.a.Item,{href:crumbData&&crumbData.is_public==true?'/topicbank/publicly':'/users/'+(this.props.current_user&&this.props.current_user.login)+'/topics/personal'},crumbData&&crumbData.is_public==true?'公共':'我的','\u9898\u5E93'),crumbData.crumbArray&&crumbData.crumbArray.map(function(item,key){return __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_breadcrumb___default.a.Item,{key:key,href:item.to||""},item.content);})),crumbData&&__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('p',{className:'clearfix mt15 mb10 '},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('span',{className:'fl font-24 color-grey-3 task-hide lineh-30',style:{maxWidth:'800px'}},crumbData&&crumbData.title),crumbData.is_public==true?__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('span',{className:'bank_is_public'},'\u516C\u5F00'):__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('span',{className:'bank_is_private'},'\u79C1\u6709')),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_react_router_dom__["f" /* Switch */],this.props,__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_react_router_dom__["e" /* Route */],{path:'/banks/gtask/:workId/edit/:type',render:function render(props){return __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(GtaskBanksEdit,Object.assign({},_this2.props,props,_this2.state,common));}}),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_react_router_dom__["e" /* Route */],{path:'/banks/normal/:workId/edit/:type',render:function render(props){return __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(HomeworkBanksEdit,Object.assign({},_this2.props,props,_this2.state,common,{isGroup:false}));}}),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_react_router_dom__["e" /* Route */],{path:'/banks/group/:workId/edit/:type',render:function render(props){return __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(HomeworkBanksEdit,Object.assign({},_this2.props,props,_this2.state,common,{isGroup:true}));}}),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_react_router_dom__["e" /* Route */],{path:'/banks/exercise/:Id/edit/:type',render:function render(props){return __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(ExerciseBanksEdit,Object.assign({},_this2.props,props,_this2.state,common));}}),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_react_router_dom__["e" /* Route */],{path:'/banks/gtopic/:bankId/edit/:type',render:function render(props){return __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(GtopicBanksEdit,Object.assign({},_this2.props,props,_this2.state,common));}}),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_react_router_dom__["e" /* Route */],{path:'/banks/poll/:workid/edit/:type',render:function render(props){return __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(PollNewQuestbank,Object.assign({},_this2.props,props,_this2.state,common));}}),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_react_router_dom__["e" /* Route */],{path:'/banks/poll/:bankId/:type',render:function render(props){return __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(BanksTabIndex,Object.assign({},_this2.props,props,_this2.state,common));}}),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_react_router_dom__["e" /* Route */],{path:'/banks/exercise/:Id/:type',render:function render(props){return __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(BanksTabIndex,Object.assign({},_this2.props,props,_this2.state,common));}}),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_react_router_dom__["e" /* Route */],{path:'/banks/gtask/:workid/:type',render:function render(props){return __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(Completetaskpage,Object.assign({},_this2.props,props,_this2.state,common));}}),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_react_router_dom__["e" /* Route */],{path:'/banks/gtopic/:workid/:type',render:function render(props){return __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(CompletetopicdePage,Object.assign({},_this2.props,props,_this2.state,common));}}),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_react_router_dom__["e" /* Route */],{path:'/banks/group/:workid/:type',render:function render(props){return __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(GroupjobbankPage,Object.assign({},_this2.props,props,_this2.state,common));}}),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_react_router_dom__["e" /* Route */],{path:'/banks/normal/:workid/:type',render:function render(props){return __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(Generaljobbankdetails,Object.assign({},_this2.props,props,_this2.state,common));}}))));}}]);return BanksIndex;}(__WEBPACK_IMPORTED_MODULE_2_react__["Component"]);/* harmony default export */ __webpack_exports__["default"] = (Object(__WEBPACK_IMPORTED_MODULE_6__courses_common_CNotificationHOC__["a" /* CNotificationHOC */])()(Object(__WEBPACK_IMPORTED_MODULE_4_educoder__["w" /* SnackbarHOC */])()(Object(__WEBPACK_IMPORTED_MODULE_5__tpm_TPMIndexHOC__["a" /* TPMIndexHOC */])(BanksIndex))));//       <Route path='/banks/gtopic/:bankId'
//               render={
//                 (props) => {
