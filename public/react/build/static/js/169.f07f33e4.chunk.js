...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Images_nodata_png__ = __webpack_require__(1737);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_antd_lib_popconfirm_style_css__ = __webpack_require__(1356);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_antd_lib_popconfirm__ = __webpack_require__(1355);
...
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var OrderItem=function(_Component){_inherits(OrderItem,_Component);function OrderItem(props){_classCallCheck(this,OrderItem);var _this=_possibleConstructorReturn(this,(OrderItem.__proto__||Object.getPrototypeOf(OrderItem)).call(this,props));_this.set_issue_tags=function(issue_tags){if(issue_tags&&issue_tags.length>0){return issue_tags.map(function(item,key){return __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('span',{className:'issue-tag-show',style:{background:item.color}},item.name);});}else{return"--";}};_this.deletedetail=function(id){// 学习挣钱，调用父组件方法
_this.props.deletedetail(id);};_this.onMouseMove=function(type){_this.setState({isdisplay:true,orderid:type});};_this.onMouseOut=function(){_this.setState({isdisplay:false});};_this.state={//显示 隐藏
isdisplay:false,orderid:''};return _this;}_createClass(OrderItem,[{key:'render',value:function render(){var _this2=this;var _props=this.props,issues=_props.issues,search_count=_props.search_count,page=_props.page,limit=_props.limit;var projectsId=this.props.match.params.projectsId;var current_user=this.props.current_user;var renderList=function renderList(){if(issues&&issues.length>0){return issues.map(function(item,key){return __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('div',{className:'issueItem',key:key},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('div',{className:'flex-1'},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('p',{className:'mb15 df'},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('span',{className:item.issue_status==="关闭"?"issueNo":"issueNo issueOpen"},'# ',search_count-(key+(page-1)*limit)),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_react_router_dom__["b" /* Link */],{to:'/projects/'+projectsId+'/orders/'+item.id+'/detail',className:'flex-1 hide-1 font-16 color-grey-3 lineh-30'},item.name)),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('p',{className:'color-grey-6 font-12'},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('span',null,item.format_time),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('span',{className:'ml5'},'\u53D1\u5E03'),item.updated_at===item.format_time?"":__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('span',{className:'ml20'},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('span',null,item.updated_at),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('span',{className:'ml5'},'\u66F4\u65B0')))),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('ul',{className:'topWrapper_select',onMouseMove:function onMouseMove(){return _this2.onMouseMove(item.id);},onMouseOut:function onMouseOut(){return _this2.onMouseOut();}},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('li',null,_this2.set_issue_tags(item.issue_tags)),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('li',null,item.tracker||"--"),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('li',null,item.author_name||"--"),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('li',null,item.assign_user_name||"--"),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('li',null,__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('p',{style:{width:60,height:25,margin:'auto',paddingTop:2,background:item.priority==='高'?'#e67e22':item.priority==='正常'?'#28be6c':item.priority==='低'?'#1abc9c':'#e74c3c',color:'#ffffff',borderRadius:4}},item.priority||"--")),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('li',null,item.done_ratio||"--"),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('li',null,__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('div',{className:'flex-1'},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('p',null,item.journals_count?__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_react_router_dom__["b" /* Link */],{to:'/projects/'+projectsId+'/orders/'+item.id+'/detail'},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('i',{className:'iconfont icon-pinglun1 mr3 font-16'}),item.journals_count):""),current_user&&current_user.login?__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('div',{className:'milepostleft',style:{display:_this2.state.orderid===item.id&&_this2.state.isdisplay?'flex':'none'}},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('div',{className:'grid-item mr15 color-grey-9'},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_react_router_dom__["b" /* Link */],{to:'/projects/'+projectsId+'/orders/'+item.id+'/updatedetail',className:'color-grey-9'},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('i',{className:'iconfont icon-bianji3 font-14 mr5'}))),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('div',{className:'grid-item color-grey-9'},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_popconfirm___default.a,{placement:'bottom',title:'您确定要删除吗',okText:'\u662F',cancelText:'\u5426',onConfirm:function onConfirm(){return _this2.deletedetail(item.id);}},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('i',{className:'iconfont icon-yiguanbi1 font-14'})))):""))));});}};return __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('div',null,renderList());}}]);return OrderItem;}(__WEBPACK_IMPORTED_MODULE_2_react__["Component"]);/* harmony default export */ __webpack_exports__["a"] = (OrderItem);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_antd_lib_dropdown_style_css__ = __webpack_require__(960);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_antd_lib_dropdown__ = __webpack_require__(956);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_antd_lib_pagination_style_css__ = __webpack_require__(895);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_antd_lib_pagination__ = __webpack_require__(896);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__order_css__ = __webpack_require__(1402);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__order_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_12__order_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__Nodata__ = __webpack_require__(1736);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__OrderItem__ = __webpack_require__(3486);
 ...
 */var MilepostDetail=function(_Component){_inherits(MilepostDetail,_Component);function MilepostDetail(props){_classCallCheck(this,MilepostDetail);var _this=_possibleConstructorReturn(this,(MilepostDetail.__proto__||Object.getPrototypeOf(MilepostDetail)).call(this,props));_this.componentDidMount=function(){_this.getSelectList();_this.getIssueList();};_this.getSelectList=function(){var projectsId=_this.props.match.params.projectsId;var url='/projects/'+projectsId+'/issues/index_chosen.json';__WEBPACK_IMPORTED_MODULE_15_axios___default.a.get(url).then(function(result){if(result){_this.setState({issue_chosen:result.data.issue_chosen});}}).catch(function(error){console.log(error);});};_this.getIssueList=function(page,limit,search,author_id,assigned_to_id,status_type,id,value,order_name,order_type){var _this$props$match$par=_this.props.match.params,projectsId=_this$props$match$par.projectsId,meilid=_this$props$match$par.meilid;var url='/projects/'+projectsId+'/versions/'+meilid+'.json';__WEBPACK_IMPORTED_MODULE_15_axios___default.a.get(url,{params:_defineProperty({page:page,limit:limit,search:search,author_id:author_id,assigned_to_id:assigned_to_id,status_type:status_type,order_name:order_name,order_type:order_type},id,value)}).then(function(result){if(result){_this.setState({data:result.data,issues:result.data.issues,search_count:result.data.search_count,isSpin:false});}}).catch(function(error){console.log(error);});};_this.getOption=function(e,id,name){if(id+'s'==="issue_tag_ids"){var _this$setState;_this.setState((_this$setState={},_defineProperty(_this$setState,id,e.key),_defineProperty(_this$setState,'issue_tag_ids',name),_this$setState));}if(id+'s'==="tracker_ids"){var _this$setState2;_this.setState((_this$setState2={},_defineProperty(_this$setState2,id,e.key),_defineProperty(_this$setState2,'tracker_ids',name),_this$setState2));}if(id+'s'==="author_ids"){var _this$setState3;_this.setState((_this$setState3={},_defineProperty(_this$setState3,id,e.key),_defineProperty(_this$setState3,'author_ids',name),_this$setState3));}if(id+'s'==="assigned_to_ids"){var _this$setState4;_this.setState((_this$setState4={},_defineProperty(_this$setState4,id,e.key),_defineProperty(_this$setState4,'assigned_to_ids',name),_this$setState4));}if(id+'s'==="priority_ids"){var _this$setState5;_this.setState((_this$setState5={},_defineProperty(_this$setState5,id,e.key),_defineProperty(_this$setState5,'priority_ids',name),_this$setState5));}if(id+'s'==="done_ratios"){var _this$setState6;_this.setState((_this$setState6={},_defineProperty(_this$setState6,id,e.key),_defineProperty(_this$setState6,'done_ratios',name),_this$setState6));}if(e.key==="created_on"){if(e.item.props.value==="desc"){var _this$setState7;_this.setState((_this$setState7={},_defineProperty(_this$setState7,id,e.key),_defineProperty(_this$setState7,'paix','最新创建'),_this$setState7));}else{var _this$setState8;_this.setState((_this$setState8={},_defineProperty(_this$setState8,id,e.key),_defineProperty(_this$setState8,'paix','最早创建'),_this$setState8));}}else if(e.key==="updated_on"){if(e.item.props.value==="desc"){var _this$setState9;_this.setState((_this$setState9={},_defineProperty(_this$setState9,id,e.key),_defineProperty(_this$setState9,'paix','最新更新'),_this$setState9));}else{var _this$setState10;_this.setState((_this$setState10={},_defineProperty(_this$setState10,id,e.key),_defineProperty(_this$setState10,'paix','最早更新'),_this$setState10));}}_this.setState(_defineProperty({},id,e.key));var _this$state=_this.state,page=_this$state.page,limit=_this$state.limit,search=_this$state.search,author_id=_this$state.author_id,assigned_to_id=_this$state.assigned_to_id,status_type=_this$state.status_type;if(e.key==="all"){_this.getIssueList(page,limit,search,author_id,assigned_to_id,status_type,id);}else if(e.key==="created_on"||e.key==="updated_on"){_this.setState({order_name:e.key,order_type:e.item.props.value});_this.getIssueList(page,limit,search,author_id,assigned_to_id,status_type,id,undefined,undefined,e.key,e.item.props.value);}else{_this.getIssueList(page,limit,search,author_id,assigned_to_id,status_type,id,e.key);}};_this.renderMenu=function(array,name,id){return __WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_menu___default.a,null,__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_menu___default.a.Item,{key:"all",onClick:function onClick(e){return _this.getOption(e,id,name);}},name),array&&array.length>0&&array.map(function(item,key){return __WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_menu___default.a.Item,{key:item.id,onClick:function onClick(e){return _this.getOption(e,id,item.name);}},item.name);}));};_this.ChangePage=function(page){_this.setState({page:page,isSpin:true});var _this$state2=_this.state,limit=_this$state2.limit,search=_this$state2.search,status_type=_this$state2.status_type,author_id=_this$state2.author_id,assigned_to_id=_this$state2.assigned_to_id;_this.getIssueList(page,limit,search,author_id,assigned_to_id,status_type);};_this.searchFunc=function(value){_this.setState({search:value,isSpin:true});var _this$state3=_this.state,page=_this$state3.page,limit=_this$state3.limit,status_type=_this$state3.status_type,author_id=_this$state3.author_id,assigned_to_id=_this$state3.assigned_to_id;_this.getIssueList(page,limit,value,author_id,assigned_to_id,status_type);};_this.openorder=function(type){if(type){var current_user=_this.props.current_user;if(type===1){_this.setState({status_type:'1',openselect:current_user.user_id,closeselect:undefined,issue_tag_ids:'标签',tracker_ids:'所有分类',author_ids:'发布人',assigned_to_ids:'指派人',priority_ids:'优先度',done_ratios:'完成度',paix:'排序'});_this.getIssueList("","","","","",1,"");}else{_this.setState({status_type:'2',openselect:undefined,closeselect:current_user.user_id,issue_tag_ids:'标签',tracker_ids:'所有分类',author_ids:'发布人',assigned_to_ids:'指派人',priority_ids:'优先度',done_ratios:'完成度',paix:'排序'});_this.getIssueList("","","","","",2,"");}}};_this.state={issue_chosen:undefined,data:undefined,issues:undefined,isSpin:false,search:undefined,author_id:undefined,assigned_to_id:undefined,limit:15,page:1,search_count:undefined,issue_type:undefined,status_type:'1',//设置选择高亮
openselect:1,closeselect:undefined,// status_type: undefined
issue_tag_ids:'标签',tracker_ids:'所有分类',author_ids:'发布人',assigned_to_ids:'指派人',priority_ids:'优先度',done_ratios:'完成度',paix:'排序'};return _this;}// 获取列表数据
// 翻页
// 搜索
_createClass(MilepostDetail,[{key:'render',value:function render(){var _this2=this;var _state=this.state,issue_chosen=_state.issue_chosen,issues=_state.issues,limit=_state.limit,page=_state.page,search_count=_state.search_count,data=_state.data,isSpin=_state.isSpin,openselect=_state.openselect,closeselect=_state.closeselect;var _props$match$params=this.props.match.params,projectsId=_props$match$params.projectsId,meilid=_props$match$params.meilid;var menu=__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_menu___default.a,{onClick:function onClick(e){return _this2.getOption(e);}},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_menu___default.a.Item,{key:'created_on',value:'desc'},'\u6700\u65B0\u521B\u5EFA'),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_menu___default.a.Item,{key:'created_on',value:'asc'},'\u6700\u65E9\u521B\u5EFA'),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_menu___default.a.Item,{key:'updated_on',value:'desc'},'\u6700\u65B0\u66F4\u65B0'),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_menu___default.a.Item,{key:'updated_on',value:'asc'},'\u6700\u65E9\u66F4\u65B0'));var Paginations=__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_10_react___default.a.Fragment,null,search_count>limit?__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('div',{className:'mt30 mb50 edu-txt-center'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_pagination___default.a,{simple:true,defaultCurrent:page,total:search_count,pageSize:limit,onChange:this.ChangePage})):"");return __WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('div',{className:'main'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('div',{className:'miledetail'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('div',{className:'topmilepost'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('p',null,data&&data.name),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('div',{className:'milepostdiv'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11_react_router_dom__["b" /* Link */],{to:'/projects/'+projectsId+'/orders/'+meilid+'/meilpost',className:'topWrapper_btn',style:{marginRight:15}},'\u7F16\u8F91\u91CC\u7A0B\u7891'),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11_react_router_dom__["b" /* Link */],{to:'/projects/'+projectsId+'/orders/new',className:'topWrapper_btn'},'\u521B\u5EFA\u4EFB\u52A1'))),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('div',{className:'grid-item mr10'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',{className:'mr10'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('i',{className:'iconfont icon-rili font-14 mr5'}),data&&data.effective_date?__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',null,data&&data.effective_date):__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',null,'\u6682\u65E0\u622A\u6B62\u65F6\u95F4')),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',{className:'font-weight-bold'},data&&data.percent.toFixed(2),'%\u5B8C\u6210'))),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('div',{className:'topWrapper',style:{borderBottom:"none"}}),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_spin___default.a,{spinning:isSpin},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('div',{className:'f-wrap-between mb20'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('ul',{className:'topWrapper_type'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('li',{className:openselect?"active":"",onClick:function onClick(){return _this2.openorder(1);}},data&&data.open_issues_count,'\u4E2A\u5F00\u542F\u4E2D'),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('li',{className:closeselect?"active":"",onClick:function onClick(){return _this2.openorder(2);}},data&&data.close_issues_count,'\u4E2A\u5DF2\u5173\u95ED')),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('ul',{className:'topWrapper_select'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('li',null,__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_dropdown___default.a,{className:'topWrapperSelect',overlay:this.renderMenu(issue_chosen&&issue_chosen.issue_tag,'标签','issue_tag_id'),trigger:['click'],placement:'bottomCenter'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',null,this.state.issue_tag_ids,__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_icon___default.a,{type:'caret-down',className:'ml5'})))),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('li',null,__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_dropdown___default.a,{className:'topWrapperSelect',overlay:this.renderMenu(issue_chosen&&issue_chosen.tracker,'所有分类','tracker_id'),trigger:['click'],placement:'bottomCenter'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',null,this.state.tracker_ids,__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_icon___default.a,{type:'caret-down',className:'ml5'})))),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('li',null,__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_dropdown___default.a,{className:'topWrapperSelect',overlay:this.renderMenu(issue_chosen&&issue_chosen.assign_user,'发布人','author_id'),trigger:['click'],placement:'bottomCenter'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',null,this.state.author_ids,__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_icon___default.a,{type:'caret-down',className:'ml5'})))),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('li',null,__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_dropdown___default.a,{className:'topWrapperSelect',overlay:this.renderMenu(issue_chosen&&issue_chosen.assign_user,'指派人','assigned_to_id'),trigger:['click'],placement:'bottomCenter'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',null,this.state.assigned_to_ids,__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_icon___default.a,{type:'caret-down',className:'ml5'})))),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('li',null,__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_dropdown___default.a,{className:'topWrapperSelect',overlay:this.renderMenu(issue_chosen&&issue_chosen.priority,'优先度','priority_id'),trigger:['click'],placement:'bottomCenter'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',null,this.state.priority_ids,__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_icon___default.a,{type:'caret-down',className:'ml5'})))),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('li',null,__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_dropdown___default.a,{className:'topWrapperSelect',overlay:this.renderMenu(issue_chosen&&issue_chosen.done_ratio,'完成度','done_ratio'),trigger:['click'],placement:'bottomCenter'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',null,this.state.done_ratios,__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_icon___default.a,{type:'caret-down',className:'ml5'})))),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('li',null,__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_dropdown___default.a,{className:'topWrapperSelect',overlay:menu,trigger:['click'],placement:'bottomCenter'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',null,this.state.paix,__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_icon___default.a,{type:'caret-down',className:'ml5'})))))),search_count===0?__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13__Nodata__["a" /* default */],{_html:'\u6682\u65F6\u8FD8\u6CA1\u6709\u76F8\u5173\u6570\u636E\u54E6!'}):__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_14__OrderItem__["a" /* default */],Object.assign({issues:issues,search_count:search_count,page:page,limit:limit},this.props,this.state)),Paginations));}}]);return MilepostDetail;}(__WEBPACK_IMPORTED_MODULE_10_react__["Component"]);/* harmony default export */ __webpack_exports__["default"] = (MilepostDetail);
