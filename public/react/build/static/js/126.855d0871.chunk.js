...
// module
exports.push([module.i, ".branchDropdown{border:1px solid #eee;border-radius:4px;display:-ms-flexbox;display:flex;-ms-flex-pack:center;justify-content:center;padding:0 10px;height:35px;line-height:35px}.branchOptions{width:200px;padding:10px;-webkit-box-shadow:0 0 1px 1px hsla(0,0%,53%,.1);box-shadow:0 0 1px 1px hsla(0,0%,53%,.1);border-radius:3px;background:#fff;max-height:200px}.OptionsUl{max-height:100px;overflow-y:auto}.OptionsUl li{height:22px;line-height:22px;cursor:pointer}.OptionsUl li a{display:block;padding-left:2px}.OptionsInput{height:32px;padding-left:4px;line-height:32px;width:100%}", "", {"version":3,"sources":["/Users/hs/forgeplus-react/src/forge/Branch/branch.css"],"names":[],"mappings":"AAAA,gBACE,sBAAsB,AACtB,kBAAmB,AACnB,oBAAqB,AACrB,aAAc,AACd,qBAAsB,AAClB,uBAAwB,AAC5B,eAAiB,AACjB,YAAa,AACb,gBAAkB,CACnB,AACD,eACE,YAAa,AACb,aAAa,AACb,iDAA6D,AACrD,yCAAqD,AAC7D,kBAAmB,AACnB,gBAAiB,AACjB,gBAAkB,CACnB,AACD,WACE,iBAAkB,AAClB,eAAiB,CAClB,AACD,cACE,YAAa,AACb,iBAAkB,AAClB,cAAgB,CACjB,AACD,gBACE,cAAe,AACf,gBAAkB,CACnB,AACD,cACE,YAAa,AACb,iBAAkB,AAClB,iBAAkB,AAClB,UAAY,CACb","file":"branch.css","sourcesContent":[".branchDropdown{\n  border:1px solid #eee;\n  border-radius: 4px;\n  display: -ms-flexbox;\n  display: flex;\n  -ms-flex-pack: center;\n      justify-content: center;\n  padding:0px 10px;\n  height: 35px;\n  line-height: 35px;\n}\n.branchOptions{\n  width: 200px;\n  padding:10px;\n  -webkit-box-shadow: 0px 0px 1px 1px rgba(134, 134, 134, 0.1);\n          box-shadow: 0px 0px 1px 1px rgba(134, 134, 134, 0.1);\n  border-radius: 3px;\n  background: #fff;\n  max-height: 200px;\n}\n.OptionsUl{\n  max-height: 100px;\n  overflow-y: auto;\n}\n.OptionsUl li{\n  height: 22px;\n  line-height: 22px;\n  cursor: pointer;;\n}\n.OptionsUl li a{\n  display: block;\n  padding-left: 2px;\n}\n.OptionsInput{\n  height: 32px;\n  padding-left: 4px;\n  line-height: 32px;\n  width: 100%;\n}"],"sourceRoot":""}]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__branch_css__ = __webpack_require__(2635);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Branch_SelectBranch__ = __webpack_require__(3560);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__DetailTop__ = __webpack_require__(3217);
