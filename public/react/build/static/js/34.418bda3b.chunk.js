...
// load the styles
var content = __webpack_require__(5088);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__modules_tpm_TPMIndexHOC__ = __webpack_require__(343);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__css_messagemy_css__ = __webpack_require__(2668);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__Loading__ = __webpack_require__(345);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_react_loadable__ = __webpack_require__(346);
...
// MessagePrivate 私信
var MessagSub=__WEBPACK_IMPORTED_MODULE_8_react_loadable___default()({loader:function loader(){return __webpack_require__.e/* import() */(195).then(__webpack_require__.bind(null, 5089));},loading:__WEBPACK_IMPORTED_MODULE_7__Loading__["a" /* default */]});var MessagePrivate=__WEBPACK_IMPORTED_MODULE_8_react_loadable___default()({loader:function loader(){return __webpack_require__.e/* import() */(193).then(__webpack_require__.bind(null, 5090));},loading:__WEBPACK_IMPORTED_MODULE_7__Loading__["a" /* default */]});var MessagChat=__WEBPACK_IMPORTED_MODULE_8_react_loadable___default()({loader:function loader(){return __webpack_require__.e/* import() */(218).then(__webpack_require__.bind(null, 5091));},loading:__WEBPACK_IMPORTED_MODULE_7__Loading__["a" /* default */]});var Messagerouting=function(_Component){_inherits(Messagerouting,_Component);function Messagerouting(props){_classCallCheck(this,Messagerouting);var _this=_possibleConstructorReturn(this,(Messagerouting.__proto__||Object.getPrototypeOf(Messagerouting)).call(this,props));_this.Messageprivatemessageunreadmessage=function(user_id){var url='/users/'+user_id+'/unread_message_info.json';__WEBPACK_IMPORTED_MODULE_3_axios___default.a.get(url).then(function(result){if(result===undefined){return;}// console.log("消息未读1");
// console.log(result);
