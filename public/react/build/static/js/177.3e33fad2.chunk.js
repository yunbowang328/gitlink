...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__courses_coursesPublic_NoneData__ = __webpack_require__(313);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__usersInfo_css__ = __webpack_require__(1599);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__usersInfo_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_15__usersInfo_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__publicCreatNew__ = __webpack_require__(2011);
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var Projects=function(_Component){_inherits(Projects,_Component);function Projects(props){_classCallCheck(this,Projects);var _this=_possibleConstructorReturn(this,(Projects.__proto__||Object.getPrototypeOf(Projects)).call(this,props));_this.componentDidMount=function(){_this.setState({isSpin:true});var _this$state=_this.state,category=_this$state.category,status=_this$state.status,page=_this$state.page,sort_by=_this$state.sort_by,sort_direction=_this$state.sort_direction;_this.getCourses(category,status,page,sort_by,sort_direction);};_this.getCourses=function(category,status,page,sort_by,sort_direction){var url='/users/'+_this.props.match.params.username+'/projects.json';__WEBPACK_IMPORTED_MODULE_13_axios___default.a.get(url,{params:{category:category,status:status,page:page,sort_by:sort_by,sort_direction:sort_direction,per_page:_this.props.is_current&&category&&page==1?17:16}}).then(function(result){if(result){if(result.data.status===403||result.data.status===401||result.data.status===500||result.data.status===404){_this.setState({isSpin:false,totalCount:0});}else{_this.setState({totalCount:result.data.count,data:result.data,sort_by:sort_by,sort_direction:sort_direction,isSpin:false});}}}).catch(function(error){console.log(error);_this.setState({isSpin:false});});};_this.changeCategory=function(cate){_this.setState({category:cate,page:1,isSpin:true});var _this$state2=_this.state,status=_this$state2.status,sort_by=_this$state2.sort_by,sort_direction=_this$state2.sort_direction;_this.getCourses(cate,status,1,sort_by,sort_direction);};_this.changeStatus=function(status){_this.setState({status:status,page:1,isSpin:true});var _this$state3=_this.state,category=_this$state3.category,sort_by=_this$state3.sort_by,sort_direction=_this$state3.sort_direction;_this.getCourses(category,status,1,sort_by,sort_direction);};_this.changePage=function(page){_this.setState({page:page,isSpin:true});var _this$state4=_this.state,category=_this$state4.category,status=_this$state4.status,sort_by=_this$state4.sort_by,sort_direction=_this$state4.sort_direction;_this.getCourses(category,status,page,sort_by,sort_direction);};_this.turnToCourses=function(url,flag){if(flag){window.location.href=url;}};_this.state={category:undefined,status:undefined,page:1,per_page:16,sort_by:"updated_on",sort_direction:"desc",totalCount:undefined,data:undefined,isSpin:false};return _this;}//切换种类
//切换状态
//切换页数
// 进入项目
_createClass(Projects,[{key:'updatedlist',//切换种类
value:function updatedlist(sort_by){//按照什么样子排序
this.setState({isSpin:true});var _state=this.state,category=_state.category,status=_state.status,page=_state.page,sort_direction=_state.sort_direction;this.getCourses(category,status,1,sort_by,"desc");}//排序
},{key:'updatedlists',value:function updatedlists(sort_directions){//是否是倒序
this.setState({isSpin:true});var _state2=this.state,category=_state2.category,status=_state2.status,page=_state2.page,sort_by=_state2.sort_by,sort_direction=_state2.sort_direction;var sort_directiony=sort_directions;if(sort_directions==="asc"){if(sort_directions===sort_direction){sort_directiony="desc";}}else if(sort_directions==="desc"){if(sort_directions===sort_direction){sort_directiony="asc";}}this.getCourses(category,status,page,sort_by,sort_directiony);}},{key:'render',value:function render(){var _this2=this;var _state3=this.state,category=_state3.category,status=_state3.status,page=_state3.page,data=_state3.data,totalCount=_state3.totalCount,isSpin=_state3.isSpin,sort_by=_state3.sort_by,sort_direction=_state3.sort_direction;var isStudent=this.props.isStudent();var is_current=this.props.is_current;var current_user=this.props.current_user;var menu=__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_menu___default.a,null,__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_menu___default.a.Item,{onClick:function onClick(){return _this2.updatedlist("updated_on");}},'\u6700\u65B0\u52A8\u6001'),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_menu___default.a.Item,{onClick:function onClick(){return _this2.updatedlist("created_on");}},'\u6700\u65B0\u521B\u5EFA'));return __WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('div',{className:'educontent'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_spin___default.a,{size:'large',spinning:isSpin},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('style',null,'\n             .whitepanelyslli {\n                width: 32px !important;\n             height: 48px !important;\n              line-height: 46px !important;\n             }\n              .whitepanelyslliss {\n                width: 32px !important;\n                  height: 48px !important;\n              line-height: 46px !important;\n             }\n\n              .whitepanelysllis {\n             width: 66px !important;\n              height: 48px !important;\n              line-height: 46px !important;\n              margin-left: 40px !important;\n              }\n\n                 .whitepanelysllisyt {\n             width: 60px !important;\n              height: 48px !important;\n              line-height: 46px !important;\n              margin-left: 40px !important;\n              }\n\n\n              .white-panel li.active {\n                  border-radius: 24px;\n                  border: none !important;\n                  color: #4CACFF;\n              }\n\n\n\n              '),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('div',{className:'white-panel edu-back-white pt20 pb20  clearfix '},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('li',{className:category?" font-16 whitepanelyslli":"active font-16 whitepanelyslli"},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('a',{href:'javascript:void(0)',onClick:function onClick(){return _this2.changeCategory();},className:'font-16 w32'},'\u5168\u90E8')),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('li',{className:category=="manage"?"active font-16 whitepanelysllis":"font-16 whitepanelysllis"},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('a',{href:'javascript:void(0)',onClick:function onClick(){return _this2.changeCategory("manage");},className:is_current?"font-16 w66":"font-16 w80"},is_current?"我":"TA",'\u7BA1\u7406\u7684')),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('li',{className:category=="study"?"active font-16 whitepanelysllis":"font-16 whitepanelysllis"},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('a',{href:'javascript:void(0)',onClick:function onClick(){return _this2.changeCategory("study");},className:is_current?"font-16 w66":"font-16 w80"},is_current?"我":"TA",'\u53C2\u4E0E\u7684'))),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('style',null,'  .secondNavs li {\n                color: #676767;\n                /* margin: 0px 20px; */\n                float: left;\n             }\n             .secondNavs li a:hover{\n             color: #4CACFF\n             }\n             .secondNavs li.active a{\n             color: #4CACFF\n             }\n             '),is_current&&__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('div',{className:'edu-back-white padding10-30 clearfix secondNavs bor-top-greyE'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('li',{className:status?"whitepanelyslliss":"active whitepanelyslliss"},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('a',{href:'javascript:void(0)',onClick:function onClick(){return _this2.changeStatus();},className:' w32'},'\u5168\u90E8')),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('li',{className:status=="publicly"?"active whitepanelysllisyt":"whitepanelysllisyt"},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('a',{href:'javascript:void(0)',onClick:function onClick(){return _this2.changeStatus("publicly");},className:' w60'},'\u516C\u5F00')),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('li',{className:status=="personal"?"active whitepanelysllisyt":"whitepanelysllisyt"},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('a',{href:'javascript:void(0)',onClick:function onClick(){return _this2.changeStatus("personal");},className:' w60'},'\u79C1\u6709'))),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('p',{className:'clearfix font-12 ',style:{lineHeight:"41px",marginTop:"10px"}},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',{className:'fl color-grey-9'},'\u5171\u53C2\u4E0E',totalCount,'\u4E2A',category?category=="manage"?"发布":"学习":"项目"),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('sapn',{className:'relativef color-grey-9  fr',style:{display:"flex",flexDirection:"column",height:"40px",lineHeight:"40px"}},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',{style:{flexDirection:"column",textAlign:"center",height:"10px",lineHeight:"10px",display:"table",marginTop:"9px"}},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('i',{className:sort_direction==="asc"?"iconfont icon-sanjiaoxing-up font-12  color-blue h10 ":"iconfont icon-sanjiaoxing-up font-12 h10",onClick:function onClick(){return _this2.updatedlists("asc");}})),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',{style:{flexDirection:"column",height:"10px",lineHeight:"10px",textAlign:"center",display:"table"}},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('i',{className:sort_direction==="desc"?"iconfont icon-sanjiaoxing-down font-12 yslbottomsj color-blue h10":"iconfont icon-sanjiaoxing-down font-12 yslbottomsj h10",onClick:function onClick(){return _this2.updatedlists("desc");}}))),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_dropdown___default.a,{overlay:menu},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',{className:'fr color-grey-9 mr10 pointer ',style:{display:"flex",flexDirection:"initial"}},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',null,sort_by==="updated_on"?'最近更新':sort_by==="created_on"?'最新创建':"")))),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('style',null,'\n\t\t\t\t\t\t\t.square-list{width: 100%;box-sizing: border-box;margin-top:10px}\n\t\t\t\t\t\t\t'),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('div',{className:'square-list clearfix'},page==1&&is_current?__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_16__publicCreatNew__["a" /* default */],Object.assign({href:'/projects/deposit/new',name:"新建开发项目",index:'4',Createtype:"projects"},this.props,this.state)):"",(!data||data&&data.projects.length==0)&&category&&__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_14__courses_coursesPublic_NoneData__["a" /* default */],null),data===undefined||data.projects.length===0?category=="manage"||category=="study"?"":__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_14__courses_coursesPublic_NoneData__["a" /* default */],null):"",data&&data.projects&&data.projects.map(function(item,key){return __WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('div',{className:'square-Item',onClick:function onClick(){return _this2.turnToCourses('/projects/'+item.id,item.can_visited);},style:{"cursor":"pointer","height":"289px"}},item.is_public==1&&__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_10_react___default.a.Fragment,null,__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('div',{className:'publicpart'}),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',{className:'smalltrangle'}),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',{className:'publicword'},'\u516C\u5F00')),item.can_visited==false?__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('div',{className:'closeSquare'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('img',{src:Object(__WEBPACK_IMPORTED_MODULE_11_educoder__["M" /* getImageUrl */])("images/educoder/icon/lockclose.svg"),className:'mt80 mb25'}),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('p',{className:'font-14 color-white'},'\u975E\u6210\u5458\u4E0D\u80FD\u8BBF\u95EE')):"",__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('div',{className:'substance'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('p',{className:'subName font-16'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',null,item.name)),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',null,__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('img',{alt:'\u7528\u6237',className:'radius mt15',height:'60',src:Object(__WEBPACK_IMPORTED_MODULE_11_educoder__["M" /* getImageUrl */])('images/'+item.owner.avatar_url),width:'60'})),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('p',{className:'font-14 mt10 task-hide'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',null,item.owner.real_name)),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('p',{className:'font-16 mb15 mt10 task-hide'},item.category&&item.category.name&&__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',{className:'projectTag categoryTag'},item.category.name),item.language&&item.language.name&&__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',{className:'projectTag languageTag'},item.language.name))),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('div',{className:'edu-txt-center course-bottom'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('div',{className:'inline color-grey-6'},item.members_count>0&&__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_tooltip___default.a,{placement:'bottom',title:"成员数"},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',{className:'mr10 ml10 fl squareIconSpan'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('i',{className:'iconfont icon-chengyuan fl mr3'}),item.members_count)),item.issues_count>0&&__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_tooltip___default.a,{placement:'bottom',title:"任务数"},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',{className:'mr10 ml10 fl squareIconSpan'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('i',{className:'iconfont icon-issue fl mr3'}),item.issues_count)),item.changesets_count>0&&__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_tooltip___default.a,{placement:'bottom',title:"版本库"},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',{className:'mr10 ml10 fl squareIconSpan'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('i',{className:'iconfont icon-banbenku fl mr3'}),item.changesets_count)))));})),totalCount>15&&__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('div',{className:'mt30 mb50 edu-txt-center'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_pagination___default.a,{showQuickJumper:true,total:totalCount,onChange:this.changePage,pageSize:16,current:page}))));}}]);return Projects;}(__WEBPACK_IMPORTED_MODULE_10_react__["Component"]);/* harmony default export */ __webpack_exports__["default"] = (Projects);
