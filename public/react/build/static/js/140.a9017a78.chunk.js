...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_antd_lib_tooltip_style_css__ = __webpack_require__(172);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_antd_lib_tooltip__ = __webpack_require__(171);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_antd_lib_divider_style_css__ = __webpack_require__(1324);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_antd_lib_divider_style_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_12_antd_lib_divider_style_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_antd_lib_divider__ = __webpack_require__(1325);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_antd_lib_divider___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_13_antd_lib_divider__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18_react_router_dom__ = __webpack_require__(51);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__index_scss__ = __webpack_require__(5019);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__index_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_21__index_scss__);
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var TrainingObjective=function(_React$Component){_inherits(TrainingObjective,_React$Component);function TrainingObjective(props){_classCallCheck(this,TrainingObjective);var _this=_possibleConstructorReturn(this,(TrainingObjective.__proto__||Object.getPrototypeOf(TrainingObjective)).call(this,props));_this.getData=function(){var yearId=_this.props.yearId;__WEBPACK_IMPORTED_MODULE_20_axios___default.a.get('/ec_years/'+yearId+'/ec_training_objectives.json').then(function(res){if(res.status===200){_this.setState({objective:res.data,editContent:res.data.content,trainingSubitems:res.data.ec_training_items,loading:false});}}).catch(function(e){return console.log(e);});};_this.saveContentEdit=function(){var editContent=_this.state.editContent;_this.setState({validateState:editContent.length===0});if(editContent.length===0){return;}_this.setState({submitState:true},function(){_this.updateTrainingObjective({content:editContent},function(){_this.setState({submitState:false,contentEditState:false});_this.getData();},function(_e){_this.setState({submitState:false});});});};_this.cancelContentEdit=function(){_this.setState({editContent:_this.state.objective.content,contentEditState:false});};_this.editItemsContent=function(){var trainingSubitems=_this.state.trainingSubitems;if(!trainingSubitems||trainingSubitems.length===0){trainingSubitems=[{id:null,content:null}];}_this.setState({trainingSubitems:trainingSubitems,itemsEditState:true});};_this.addItemColumn=function(index){var trainingSubitems=_this.state.trainingSubitems;trainingSubitems.splice(index,0,{id:null,content:null});_this.setState({trainingSubitems:trainingSubitems});};_this.removeItemColumn=function(index){var trainingSubitems=_this.state.trainingSubitems;trainingSubitems.splice(index,1);_this.setState({trainingSubitems:trainingSubitems});};_this.onItemContentChange=function(e,index){var trainingSubitems=_this.state.trainingSubitems;trainingSubitems[index].content=e.target.value;_this.setState({trainingSubitems:trainingSubitems});};_this.saveItemsContentEdit=function(){var _this$state=_this.state,objective=_this$state.objective,trainingSubitems=_this$state.trainingSubitems;var errorItem=trainingSubitems.find(function(item){return!item.content||item.content.length===0;});_this.setState({itemValidateState:!!errorItem});if(errorItem){return;}_this.setState({itemSubmitState:true},function(){_this.updateTrainingObjective({content:objective.content,training_subitems:trainingSubitems},function(){_this.setState({itemSubmitState:false,itemsEditState:false});_this.getData();},function(_e){_this.setState({itemSubmitState:false});});});};_this.cancelItemsContentEdit=function(){_this.setState({trainingSubitems:_this.state.objective.ec_training_items,itemsEditState:false,itemValidateState:false});};_this.updateTrainingObjective=function(data,success,fail){var yearId=_this.props.yearId;var url='/ec_years/'+yearId+'/ec_training_objectives.json';__WEBPACK_IMPORTED_MODULE_20_axios___default.a.post(url,data).then(function(res){if(res){__WEBPACK_IMPORTED_MODULE_15_antd_lib_message___default.a.success('操作成功');success();}}).catch(function(e){console.log(e);fail(e);});};_this.state={loading:true,contentEditState:false,itemsEditState:false,submitState:false,validateState:false,itemSubmitState:false,itemValidateState:false,objective:{},editContent:'',trainingSubitems:[]};return _this;}_createClass(TrainingObjective,[{key:'componentDidMount',value:function componentDidMount(){this.getData();}},{key:'render',value:function render(){var _this2=this;var can_manager=this.props.year.can_manager;var _state=this.state,loading=_state.loading,contentEditState=_state.contentEditState,itemsEditState=_state.itemsEditState,objective=_state.objective,editContent=_state.editContent,trainingSubitems=_state.trainingSubitems,validateState=_state.validateState,itemValidateState=_state.itemValidateState,itemSubmitState=_state.itemSubmitState,submitState=_state.submitState;return __WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',null,__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_spin___default.a,{spinning:loading,size:'large',style:{marginTop:'15%'}},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',{className:'educontent ec-training-objective-page'},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',{className:'ec-head'},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',{className:'ec-head-left'},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',{className:'ec-head-label'},'\u57F9\u517B\u76EE\u6807'),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',{className:'ec-head-tip'},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('span',null,'\u8BF7\u7ED3\u5408\u672C\u4E13\u4E1A\u7279\u8272\u4FEE\u6539\u57F9\u517B\u76EE\u6807\u6587\u5B57\u63CF\u8FF0\u53CA\u76EE\u6807\u5206\u89E3\u67E5\u770B\u8BE6\u60C5'),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_18_react_router_dom__["b" /* Link */],{to:'/forums/3529',target:'_blank',className:'link ml10'},'\u67E5\u770B\u8BE6\u60C5'))),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('a',{href:'/api/ec_years/'+this.props.yearId+'/ec_training_objectives.xlsx'+Object(__WEBPACK_IMPORTED_MODULE_19_educoder__["O" /* getRandomNumber */])(),target:'_blank',className:'ant-btn ant-btn-primary color-white'},'\u5BFC\u51FA\u57F9\u517B\u76EE\u6807')),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13_antd_lib_divider___default.a,null),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',{className:'training-objective-body'},can_manager&&contentEditState?__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',{className:'training-objective-content block'},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',null,__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{label:false,validateStatus:validateState&&(!editContent||editContent.length===0)?'error':''},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11_antd_lib_input___default.a.TextArea,{rows:6,value:editContent,onChange:function onChange(e){return _this2.setState({editContent:e.target.value});}}))),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',{className:'training-objective-content-form'},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_button___default.a,{type:'primary',loading:submitState,onClick:this.saveContentEdit},'\u4FDD\u5B58'),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_button___default.a,{loading:submitState,onClick:this.cancelContentEdit},'\u53D6\u6D88'))):__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',{className:'training-objective-content'},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',{className:'training-objective-content-text'},objective.content),can_manager&&__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',{className:'training-objective-content-edit'},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_tooltip___default.a,{title:'\u7F16\u8F91'},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_icon___default.a,{type:'edit',theme:'filled',className:'edit-action',onClick:function onClick(){return _this2.setState({contentEditState:true});}})))),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',{className:'training-objective-items'},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',{className:'training-objective-items-head'},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',{className:'no-column'},'\u5206\u9879'),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',{className:'item-content-column'},'\u76EE\u6807\u5206\u89E3\u8BE6\u60C5'),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',{className:'operation-column'},!can_manager||itemsEditState||__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_tooltip___default.a,{title:'\u7F16\u8F91'},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_icon___default.a,{type:'edit',theme:'filled',className:'edit-action',onClick:this.editItemsContent})))),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',{className:'training-objective-items-body'},can_manager&&itemsEditState?__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',null,trainingSubitems&&trainingSubitems.map(function(item,index){return __WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',{className:'training-objective-items-body-item',key:index},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',{className:'no-column'},index+1),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',{className:'item-content-column'},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{label:false,validateStatus:itemValidateState&&(!item.content||item.content.length===0)?'error':''},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11_antd_lib_input___default.a.TextArea,{rows:2,value:item.content,onChange:function onChange(e){return _this2.onItemContentChange(e,index);}})),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',{className:'item-column-operation'},index!==0&&__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_icon___default.a,{type:'delete',onClick:function onClick(){return _this2.removeItemColumn(index);}}),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_icon___default.a,{type:'plus-circle',onClick:function onClick(){return _this2.addItemColumn(index+1);},style:{color:'#29BD8B'}}))));}),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',{className:'training-objective-content-form'},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_button___default.a,{type:'primary',loading:itemSubmitState,onClick:this.saveItemsContentEdit},'\u4FDD\u5B58'),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_button___default.a,{disabled:itemSubmitState,onClick:this.cancelItemsContentEdit},'\u53D6\u6D88'))):objective.ec_training_items&&objective.ec_training_items.map(function(item,index){return __WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',{className:'training-objective-items-body-item',key:index},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',{className:'no-column'},index+1),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',{className:'item-content-column'},item.content));})))))));}}]);return TrainingObjective;}(__WEBPACK_IMPORTED_MODULE_16_react___default.a.Component);TrainingObjective.propTypes={schoolId:__WEBPACK_IMPORTED_MODULE_17_prop_types___default.a.string,majorId:__WEBPACK_IMPORTED_MODULE_17_prop_types___default.a.string,yearId:__WEBPACK_IMPORTED_MODULE_17_prop_types___default.a.string};/* harmony default export */ __webpack_exports__["default"] = (TrainingObjective);
...
// module
exports.push([module.i, ".ec-training-objective-page{background:#fff}.ec-training-objective-page .training-objective-body{margin-top:-24px;min-height:600px}.ec-training-objective-page .training-objective-content{display:flex;padding:20px 30px;line-height:2}.ec-training-objective-page .training-objective-content.block{display:block}.ec-training-objective-page .training-objective-content-text{flex:1}.ec-training-objective-page .training-objective-content-edit{margin-left:20px}.ec-training-objective-page .training-objective-content-edit>i{color:#29bd8b;cursor:pointer;font-size:18px}.ec-training-objective-page .training-objective-content-form{margin-top:10px;text-align:right}.ec-training-objective-page .training-objective-content-form button{margin-left:10px}.ec-training-objective-page .training-objective-items-head{padding:15px 30px;display:flex;background:#f5f5f5}.ec-training-objective-page .training-objective-items-body{margin:0 30px}.ec-training-objective-page .training-objective-items-body-item{display:flex;min-height:48px;padding:10px 0;border-bottom:1px solid #eaeaea}.ec-training-objective-page .training-objective-items-body-item:last-child{border-bottom:unset}.ec-training-objective-page .training-objective-items .no-column{width:40px;text-align:center}.ec-training-objective-page .training-objective-items .item-content-column{flex:1;padding-left:10px;display:flex}.ec-training-objective-page .training-objective-items .item-content-column .ant-form-item{flex:1;margin-bottom:0}.ec-training-objective-page .training-objective-items .item-content-column .item-column-operation{display:flex;justify-content:flex-end;width:80px}.ec-training-objective-page .training-objective-items .item-content-column .item-column-operation>i{margin:15px 10px;font-size:18px}.ec-training-objective-page i.edit-action{color:#29bd8b;cursor:pointer;font-size:18px}", "", {"version":3,"sources":["/Users/jasder/work/trustie3.0/forgeplus-react/src/modules/ecs/EcSetting/TrainingObjective/index.scss"],"names":[],"mappings":"AAAA,4BAA4B,eAAkB,CAAC,qDAAqD,iBAAiB,gBAAgB,CAAC,wDAAwD,aAAa,kBAAkB,aAAe,CAAC,8DAA8D,aAAa,CAAC,6DAA6D,MAAM,CAAC,6DAA6D,gBAAgB,CAAC,+DAA+D,cAAc,eAAe,cAAc,CAAC,6DAA6D,gBAAgB,gBAAgB,CAAC,oEAAoE,gBAAgB,CAAC,2DAA2D,kBAAkB,aAAa,kBAAkB,CAAC,2DAA2D,aAAa,CAAC,gEAAgE,aAAa,gBAAgB,eAAiB,+BAA+B,CAAC,2EAA2E,mBAAmB,CAAC,iEAAiE,WAAW,iBAAiB,CAAC,2EAA2E,OAAO,kBAAkB,YAAY,CAAC,0FAA0F,OAAO,eAAe,CAAC,kGAAkG,aAAa,yBAAyB,UAAU,CAAC,oGAAoG,iBAAiB,cAAc,CAAC,0CAA0C,cAAc,eAAe,cAAc,CAAC","file":"index.scss","sourcesContent":[".ec-training-objective-page{background:#ffffff}.ec-training-objective-page .training-objective-body{margin-top:-24px;min-height:600px}.ec-training-objective-page .training-objective-content{display:flex;padding:20px 30px;line-height:2.0}.ec-training-objective-page .training-objective-content.block{display:block}.ec-training-objective-page .training-objective-content-text{flex:1}.ec-training-objective-page .training-objective-content-edit{margin-left:20px}.ec-training-objective-page .training-objective-content-edit>i{color:#29BD8B;cursor:pointer;font-size:18px}.ec-training-objective-page .training-objective-content-form{margin-top:10px;text-align:right}.ec-training-objective-page .training-objective-content-form button{margin-left:10px}.ec-training-objective-page .training-objective-items-head{padding:15px 30px;display:flex;background:#F5F5F5}.ec-training-objective-page .training-objective-items-body{margin:0 30px}.ec-training-objective-page .training-objective-items-body-item{display:flex;min-height:48px;padding:10px 0px;border-bottom:1px solid #eaeaea}.ec-training-objective-page .training-objective-items-body-item:last-child{border-bottom:unset}.ec-training-objective-page .training-objective-items .no-column{width:40px;text-align:center}.ec-training-objective-page .training-objective-items .item-content-column{flex:1;padding-left:10px;display:flex}.ec-training-objective-page .training-objective-items .item-content-column .ant-form-item{flex:1;margin-bottom:0}.ec-training-objective-page .training-objective-items .item-content-column .item-column-operation{display:flex;justify-content:flex-end;width:80px}.ec-training-objective-page .training-objective-items .item-content-column .item-column-operation>i{margin:15px 10px;font-size:18px}.ec-training-objective-page i.edit-action{color:#29BD8B;cursor:pointer;font-size:18px}\n"],"sourceRoot":""}]);
