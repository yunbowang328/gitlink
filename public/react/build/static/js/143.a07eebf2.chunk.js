...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__courses_css_Courses_css__ = __webpack_require__(311);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__common_css__ = __webpack_require__(336);
...
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var AccountSecure=function(_Component){_inherits(AccountSecure,_Component);function AccountSecure(props){_classCallCheck(this,AccountSecure);var _this=_possibleConstructorReturn(this,(AccountSecure.__proto__||Object.getPrototypeOf(AccountSecure)).call(this,props));_this.IsPC=function(){var userAgentInfo=navigator.userAgent;var Agents=["Android","iPhone","SymbianOS","Windows Phone","iPad","iPod"];var flag=true;for(var v=0;v<Agents.length;v++){if(userAgentInfo.indexOf(Agents[v])>0){flag=false;break;}}return flag;};_this.componentDidUpdate=function(prevProps){if(prevProps!=_this.props){var basicInfo=_this.props.basicInfo;var list=_this.state.list;var newlist=list;if(basicInfo===undefined||JSON.stringify(basicInfo)=="{}"||basicInfo&&basicInfo.open_users.length===0){}else{basicInfo&&basicInfo.open_users.map(function(item,key){newlist.map(function(items,keys){if(items.en_type===item.en_type){items.id=item.id;items.nickname=item.nickname;}});});}_this.setState({list:newlist});}};_this.showModal=function(){_this.setState({visible:true});};_this.handleOk=function(e){_this.setState({visible:false});};_this.handleCancel=function(){_this.setState({visible:false});};_this.Cancelundologins=function(){_this.setState({Modalstype:false,ModalCancel:_this.Cancelundologin,ModalSave:_this.Saveundologin});};_this.Saveundologin=function(type,id){var basicInfo=_this.props.basicInfo;var list=_this.state.list;var newlist=list;var url='/users/accounts/'+basicInfo.id+'/open_users/'+id+'.json';__WEBPACK_IMPORTED_MODULE_9_axios___default.a.delete(url).then(function(result){if(result.data.status===0){newlist.map(function(item,key){if(item.en_type===type){item.id=null;}});_this.setState({list:newlist});_this.props.showNotification('解绑成功');_this.Cancelundologins();_this.props.getBasicInfo();}}).catch(function(error){console.log(error);});};_this.undologin=function(type,id){_this.setState({Modalstype:true,Modalstopval:type==="wechat"?"是否确定解绑微信账号？":"是否确定解绑QQ账号？",ModalCancel:_this.Cancelundologins,ModalSave:function ModalSave(){return _this.Saveundologin(type,id);}});};_this.openqqlogin=function(){window.location.href='https://graph.qq.com/oauth2.0/show?which=Login&display=pc&client_id=101508858&redirect_uri=https%3a%2f%2fwww.educoder.net%2fotherloginqq&state=account,'+window.location.host+'&response_type=code';};_this.openphoneqqlogin=function(){window.open('https://xui.ptlogin2.qq.com/cgi-bin/xlogin?appid=716027609&pt_3rd_aid=101508858&daid=383&pt_skey_valid=0&style=35&s_url=http%3A%2F%2Fconnect.qq.com&refer_cgi=authorize&which=&client_id=101508858&response_type=code&scope=get_user_info&redirect_uri=https%3a%2f%2fwww.educoder.net%2fotherloginqq&state=account,'+window.location.host+'&response_type=code');};_this.state={Modalstype:false,list:[{en_type:"wechat",id:null,nickname:""},{en_type:"qq",id:null,nickname:""}]};return _this;}_createClass(AccountSecure,[{key:'componentDidMount',value:function componentDidMount(){var basicInfo=this.props.basicInfo;var list=this.state.list;var newlist=list;if(basicInfo===undefined||JSON.stringify(basicInfo)=="{}"||basicInfo&&basicInfo.open_users.length===0){}else{basicInfo&&basicInfo.open_users.map(function(item,key){newlist.map(function(items,keys){if(items.en_type===item.en_type){items.id=item.id;items.nickname=item.nickname;}});});}this.setState({list:newlist});}},{key:'render',value:function render(){var _this2=this;var flag=this.IsPC();//true为PC端，false为手机端
var list=this.state.list;console.log(window.location.host);return __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',null,__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'basicForm settingForm'},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_6__modals_Modals__["a" /* default */],{modalsType:this.state.Modalstype,modalsTopval:this.state.Modalstopval,modalCancel:this.state.ModalCancel,modalSave:this.state.ModalSave,loadtype:this.state.loadtype}),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('style',null,'\n\n            // .flexRow {\n            //   padding: 15px 0;\n            // }\n              .flexRow .name {\n                margin-left: 20px;\n                color: #999999;\n\n                text-align: center;\n                flex: 0 0 100px;\n              }\n              .flexRow .description {\n                flex: 1;\n                color: #CDCDCD;\n              }\n                .description span {\n                  color: #05101A;\n                }\n              .flexRow .status {\n                width: 100px;\n                color: #28AC7F;\n                text-align: right;\n              }\n            // .flexTable .flexTable {\n            //   border-bottom: 1px solid #EBEBEB;\n            // }\n\n\n            .settingForm label{\n              color: #999999;\n              font-size: 14px !important ;\n              margin-left: 120px;\n            }\n            .settingForm input {\n              width: 340px;\n            }\n            .settingForm input.validateInput  {\n              width: 220px;\n            }\n            .settingForm .formItemInline button {\n              width: 110px;\n              margin-left: 10px;\n            }\n\n            .settingForm .ant-form-item-label {\n              width: 204px;\n            }\n            .formItemInline .ant-form-explain{\n              position:absolute;\n              bottom:-17px;\n              left:0px;\n              width:100%;\n            }\n            .weixinlogo{\n               font-size: 40px !important;\n   \t\t\t\t\t\t color: #4eaf2b;\n            }\n             .qqlogo{\n               font-size: 40px !important;\n   \t\t\t\t\t\t color: #29a1e6;\n            }\n\n            .lineheight60{\n            line-height: 60px;\n            }\n            .pt19{\n    \t\t\t\t\t\tpadding-top: 19px;\n            }\n          '),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'title'},'\u7ED1\u5B9A\u767B\u5F55\u8D26\u53F7'),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_form___default.a,null,list.map(function(item,key){return __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'flexTable',key:key},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'flexTable'},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'flexRow'},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'name'},item.en_type!="qq"?__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('i',{className:"iconfont icon-weixin2 weixinlogo mr10"}):__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('i',{className:"iconfont icon-qq qqlogo mr10"}),item.en_type!="qq"?__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('span',{className:"color-ooo"},'\u5FAE\u4FE1'):__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('span',{className:"color-ooo"},'QQ')),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'description lineheight60'},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('span',{className:"color-grey-9 ml80"},item.id===null?"":item.nickname)),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'status pt19'},item.en_type!="qq"?__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_educoder__["A" /* WordsBtn */],{style:item.id===null?"blue":"colorgrey9",className:item.id===null?"borderBottom":"",onClick:item.id===null?function(){return _this2.showModal("wechat");}:function(){return _this2.undologin("wechat",item.id);}},item.id===null?"绑定":"解绑"):__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_educoder__["A" /* WordsBtn */],{style:item.id===null?"blue":"colorgrey9",className:item.id===null?"borderBottom":"",onClick:item.id===null?flag===true?function(){return _this2.openqqlogin();}:function(){return _this2.openphoneqqlogin();}:function(){return _this2.undologin("qq",item.id);}},item.id===null?"绑定":"解绑")))));})),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('style',null,'\n\t\t\t\t\t\t\t\t\t  .ml70{\n\t\t\t\t\t\t\t\t\t      margin-left: 70px;\n\t\t\t\t\t\t\t\t\t  }\n\t\t\t\t\t\t\t\t\t'),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_modal___default.a,{closable:false,footer:null,visible:this.state.visible,onOk:this.handleOk,onCancel:this.handleCancel},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',null,__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('iframe',{className:"weixinheight390 ml70",frameBorder:'0',sandbox:'allow-scripts allow-same-origin allow-top-navigation',scrolling:'no',src:'https://open.weixin.qq.com/connect/qrconnect?appid=wx6b119e2d829c13fa&redirect_uri=https%3a%2f%2fwww.educoder.net%2fotherloginstart&response_type=code&scope=snsapi_login&state=account,'+window.location.host+'#wechat_redirect'}),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('p',{className:'clearfix pagemancenter'},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('a',{className:"startlogin color-blue",onClick:function onClick(){return _this2.handleCancel();}},'\u53D6\u6D88'))))),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{style:{color:'#989898',marginLeft:'20px'}},'* \u6211\u4EEC\u786E\u4FDD\u4F60\u6240\u63D0\u4F9B\u7684\u4FE1\u606F\u5747\u5904\u4E8E\u4E25\u683C\u4FDD\u5BC6\u72B6\u6001\uFF0C\u4E0D\u4F1A\u6CC4\u9732'));}}]);return AccountSecure;}(__WEBPACK_IMPORTED_MODULE_4_react__["Component"]);var WrappedAccountSecure=__WEBPACK_IMPORTED_MODULE_3_antd_lib_form___default.a.create({name:'AccountSecure'})(AccountSecure);/* harmony default export */ __webpack_exports__["default"] = (WrappedAccountSecure);
