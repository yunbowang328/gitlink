...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__coursesDetail_CoursesBanner__ = __webpack_require__(1699);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__coursesDetail_CoursesLeftNav__ = __webpack_require__(1700);
...
// module
exports.push([module.i, ".topicTitle{margin-bottom:8px}.topicTitle .ant-form-item-control-wrapper{width:100%}.ant-pagination.coursePagination{text-align:center;margin-top:16px}.setemail{margin-left:20px}.setemail .ant-checkbox-wrapper{margin-top:8px}", "", {"version":3,"sources":["/Users/jasder/work/trustie3.0/forgeplus-react/src/modules/courses/boards/board.css"],"names":[],"mappings":"AA0BA,YACE,iBAAmB,CACpB,AACD,2CACE,UAAY,CACb,AAGD,iCACE,kBAAmB,AACnB,eAAiB,CAClB,AAED,UACI,gBAAkB,CACrB,AAED,gCACI,cAAgB,CACnB","file":"board.css","sourcesContent":["\r\n\r\n\r\n\r\n/*必填*/ \r\n/*\r\n.ant-form-item-required::before {\r\n  display: none;\r\n}\r\n.ant-form-item-control-wrapper.ant-col-xs-24.ant-col-sm-24::before {\r\n  display: inline-block;\r\n  margin-right: 8px;\r\n  color: #f5222d;\r\n  font-size: 14px;\r\n  font-family: SimSun, sans-serif;\r\n  line-height: 1;\r\n  content: '*';\r\n}*/ \r\n/*\r\n.ant-form-item-control {\r\n  display: inline-block;\r\n}*/\r\n/* form 样式 ---------------------------------------------  */\r\n\r\n\r\n\r\n.topicTitle {\r\n  margin-bottom: 8px;\r\n}\r\n.topicTitle .ant-form-item-control-wrapper {\r\n  width: 100%;\r\n}\r\n\r\n\r\n.ant-pagination.coursePagination {\r\n  text-align: center;\r\n  margin-top: 16px;\r\n}\r\n\r\n.setemail{\r\n    margin-left: 20px;\r\n}\r\n\r\n.setemail .ant-checkbox-wrapper{\r\n    margin-top: 8px;\r\n}"],"sourceRoot":""}]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_antd_lib_input__ = __webpack_require__(58);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_antd_lib_input___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_antd_lib_input__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_antd_lib_checkbox_style_css__ = __webpack_require__(307);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_antd_lib_checkbox__ = __webpack_require__(304);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__common_CourseLayoutComponent__ = __webpack_require__(1661);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__BoardsListItem__ = __webpack_require__(3294);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__common_titleSearch_TitleSearchSection__ = __webpack_require__(1390);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__common_titleSearch_ColorCountText__ = __webpack_require__(1662);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__coursesPublic_modal_SendToCourseModal__ = __webpack_require__(3038);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__coursesPublic_NoneData__ = __webpack_require__(313);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16_lodash__ = __webpack_require__(1303);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__board_css__ = __webpack_require__(3039);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__board_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_17__board_css__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__common_js__ = __webpack_require__(2234);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20_educoder__ = __webpack_require__(5);
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var Boards=function(_Component){_inherits(Boards,_Component);function Boards(props){_classCallCheck(this,Boards);var _this=_possibleConstructorReturn(this,(Boards.__proto__||Object.getPrototypeOf(Boards)).call(this,props));_this.fetchAll=function(searchText,page){_this.setState({isSpin:true});var _serachText=searchText||_this.state.searchValue;var _page=page||_this.state.pagination.page;var cid=_this.props.match.params.coursesId;var bid=_this.props.match.params.boardId;// 
// hot
var sort_type=_this.state.sort_type;// page_size
var url="/boards/"+bid+"/messages.json?page_size=15&search="+(_serachText||'')+"&page="+_page+"&sort=0&sort_type="+sort_type;__WEBPACK_IMPORTED_MODULE_15_axios___default.a.get(encodeURI(url)).then(function(response){if(response.data.status==0&&response.data.data){var _newBoards=response.data.data.messages;// if (_page > 1) {
//   _newBoards = this.state.boards.slice().concat(_newBoards)
// }
_this.setState({messages:_newBoards,boardName:response.data.data.name,boardid:response.data.data.id,parent_id:response.data.data.parent_id,pagination:response.data.pagination||Object.assign({},_this.state.pagination,{page:_page,total_count:response.data.data.total_count}),isSpin:false});}}).catch(function(error){console.log(error);this.setState({isSpin:false});});};_this.fetchBoards=function(){var boardId=_this.props.match.params.boardId;var boardsUrl="/courses/board_list.json?board_id="+boardId;__WEBPACK_IMPORTED_MODULE_15_axios___default.a.get(boardsUrl,{}).then(function(response){if(response.data.status==0){_this.setState({boards:response.data.data.boards,course_id:response.data.data.course_id});}}).catch(function(error){console.log(error);});};_this.componentDidMount=function(){_this.setState({isSpin:true});_this.fetchBoards();_this.fetchAll();Object(__WEBPACK_IMPORTED_MODULE_20_educoder__["_2" /* on */])('updateNavSuccess',_this.updateNavSuccess);};_this.updateNavSuccess=function(){_this.fetchBoards();if(_this.props.match.params.boardId==_this.state.boardid){_this.fetchAll();}};_this.componentDidUpdate=function(prevProps){if(prevProps.match.params.boardId!=_this.props.match.params.boardId){_this.setState({isSpin:true});_this.clearAllCheck();_this.fetchAll(null,1);}};_this.moveTo=function(board){var len=_this.state.checkBoxValues.length;if(len==0){_this.props.showNotification('请先在列表中选择要移动的帖子');return;}var bid=_this.props.match.params.boardId;var checkBoxValues=_this.state.checkBoxValues;var url="/boards/"+bid+"/messages/bulk_move.json";__WEBPACK_IMPORTED_MODULE_15_axios___default.a.put(url,{ids:checkBoxValues,to_board_id:board.id}).then(function(response){if(response.data.status==0){console.log('--- 成功');_this.props.showNotification('帖子移动成功');_this.props.updataleftNavfun();// TODO 停留在当前board 或 目标board
_this.clearAllCheck();_this.fetchAll();}}).catch(function(error){console.log(error);});};_this.onDelete=function(){var len=_this.state.checkBoxValues.length;if(len==0){_this.props.showNotification('请先选择要删除的帖子');return;}_this.props.confirm({// content: `确认要删除所选的${len}个帖子吗？`,
content:"\u662F\u5426\u786E\u8BA4\u5220\u9664?",onOk:function onOk(){// const cid = this.props.match.params.coursesId
var bid=_this.props.match.params.boardId;var url="/boards/"+bid+"/messages/bulk_delete.json";var board_id=5897;__WEBPACK_IMPORTED_MODULE_15_axios___default.a.delete(url,{data:{// course_id: cid,
ids:_this.state.checkBoxValues}}).then(function(response){if(response.data.status==0){// {"status":1,"message":"删除成功"}
console.log('--- 删除成功');_this.clearAllCheck();_this.fetchAll(null,1);_this.props.updataleftNavfun();}}).catch(function(error){console.log(error);});}});};_this.onSticky=function(message){var cid=_this.props.match.params.coursesId;var url="/messages/"+message.id+"/sticky_top.json";__WEBPACK_IMPORTED_MODULE_15_axios___default.a.put(url,{course_id:cid}).then(function(response){if(response.data.status==0){console.log('--- 置顶/取消置顶成功');// const boards = this.state.boards;
// for (let _i = 0; _i < boards.length; _i++) {
// boards[]
// }
_this.fetchAll();}}).catch(function(error){console.log(error);});};_this.onItemClick=function(item){var checkBoxValues=_this.state.checkBoxValues.slice(0);var index=checkBoxValues.indexOf(item.id);if(index!=-1){__WEBPACK_IMPORTED_MODULE_16_lodash___default.a.remove(checkBoxValues,function(listItem){return listItem===item.id;});}else{checkBoxValues.push(item.id);}_this.onCheckBoxChange(checkBoxValues);};_this.onPressEnter=function(e){clearTimeout(_this.timeoutHandler);_this.timeoutHandler=null;_this.fetchAll(_this.state.searchValue,1);};_this.onInputSearchChange=function(e){_this.setState({searchValue:e.target.value});if(_this.timeoutHandler){clearTimeout(_this.timeoutHandler);_this.timeoutHandler=null;}_this.timeoutHandler=setTimeout(function(){_this.fetchAll(_this.state.searchValue,1);},1200);};_this.addDir=function(){var boardid=_this.state.boardid;Object(__WEBPACK_IMPORTED_MODULE_20_educoder__["_10" /* trigger */])('boardAdd',parseInt(boardid));};_this.renameDir=function(){var boardId=_this.props.match.params.boardId;Object(__WEBPACK_IMPORTED_MODULE_20_educoder__["_10" /* trigger */])('boardRename',{category_id:parseInt(boardId),category_name:_this.state.boardName});};_this.onToBoardsNew=function(){var courseId=_this.state.course_id;var boardId=_this.props.match.params.boardId;_this.props.toNewPage(courseId,boardId);};_this.onCheckAll=function(e){_this.setState({checkAllValue:e.target.checked});var values=_this.state.messages.map(function(item){return item.id;});if(e.target.checked){var concated=_this.state.checkBoxValues.concat(values);var sortedUniqed=__WEBPACK_IMPORTED_MODULE_16_lodash___default.a.uniq(concated);_this.setState({checkBoxValues:sortedUniqed});}else{_this.setState({checkBoxValues:__WEBPACK_IMPORTED_MODULE_16_lodash___default.a.difference(_this.state.checkBoxValues,values)});}};_this.clearAllCheck=function(){_this.setState({checkBoxValues:[],checkAllValue:false});};_this.onCheckBoxChange=function(checkedValues){_this.setState({checkBoxValues:checkedValues,checkAllValue:checkedValues.length==_this.state.messages.length});console.log('checked = ',checkedValues);};_this.onPageChange=function(pageNumber){_this.setState({checkBoxValues:[]});_this.fetchAll(null,pageNumber);};_this.onSendToOtherCourse=function(){var len=_this.state.checkBoxValues.length;if(len==0){_this.props.showNotification('请先在列表中选择要发送的帖子');return;}_this.refs.sendToCourseModal.setVisible(true);};_this.onSetToOpen=function(){var checkBoxValues=_this.state.checkBoxValues;if(checkBoxValues.length==0){_this.props.showNotification('请先在列表中选择要公开的帖子');return;}var boardId=_this.props.match.params.boardId;var url="/boards/"+boardId+"/messages/bulk_public.json";__WEBPACK_IMPORTED_MODULE_15_axios___default.a.put(url,{ids:checkBoxValues}).then(function(response){if(response.data.status==0){_this.props.showNotification('操作成功');_this.fetchAll();}}).catch(function(error){console.log(error);});};_this.onSortTypeChange=function(sort_type){_this.setState({sort_type:sort_type},function(){_this.fetchAll();});};_this.state={searchValue:'',checkAllValue:false,checkBoxValues:[],pagination:{page:1,page_size:15,total_count:0},messages:[],sort_type:'time',boardid:undefined,isSpin:false};return _this;}_createClass(Boards,[{key:"componentWillUnmount",value:function componentWillUnmount(){Object(__WEBPACK_IMPORTED_MODULE_20_educoder__["_1" /* off */])('updateNavSuccess',this.updateNavSuccess);}},{key:"render",value:function render(){var _this2=this;var isAdmin=this.props.isAdmin();var isCourseEnd=this.props.isCourseEnd();var isAdminOrStudent=this.props.isAdminOrStudent();var _state=this.state,boardName=_state.boardName,searchValue=_state.searchValue,boards=_state.boards,messages=_state.messages,checkBoxValues=_state.checkBoxValues,checkAllValue=_state.checkAllValue,pagination=_state.pagination,sort_type=_state.sort_type,parent_id=_state.parent_id;var coursedata=this.props.coursedata;var bid=this.props.match.params.boardId;var haveMore=pagination.total_count-pagination.page_size*pagination.page>0;return __WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_8_react___default.a.Fragment,null,__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13__coursesPublic_modal_SendToCourseModal__["a" /* default */],Object.assign({ref:"sendToCourseModal"},this.props,{moduleName:"\u5E16\u5B50",selectedMessageIds:checkBoxValues})),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11__common_titleSearch_TitleSearchSection__["a" /* default */],{title:boardName||"帖子列表",searchValue:searchValue,onInputSearchChange:this.onInputSearchChange,allowClearonChange:this.onInputSearchChange,showSearchInput:messages.length>=10,searchPlaceholder:'请输入帖子名称进行搜索',firstRowRight:__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_8_react___default.a.Fragment,null,!isCourseEnd&&isAdmin&&!parent_id&&__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_20_educoder__["A" /* WordsBtn */],{style:"blue",className:"mr30",onClick:function onClick(){return _this2.addDir();}},"\u65B0\u5EFA\u76EE\u5F55"),isAdmin&&!!parent_id&&__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_20_educoder__["A" /* WordsBtn */],{style:"blue",className:"mr30",onClick:function onClick(){return _this2.renameDir();}},"\u76EE\u5F55\u91CD\u547D\u540D"),!isCourseEnd&&isAdminOrStudent&&__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_20_educoder__["A" /* WordsBtn */],{style:"blue",className:"",onClick:function onClick(){return _this2.onToBoardsNew();}},"\u6211\u8981\u53D1\u8D34")),secondRowLeft:pagination?__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_12__common_titleSearch_ColorCountText__["a" /* default */],{count:pagination.total_count,name:"\u4E2A\u5E16\u5B50"}):'',onPressEnter:this.onPressEnter}),messages&&messages.length==0?"":isAdmin&&__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("div",{className:"mt20 edu-back-white padding20-30"},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("div",{className:"clearfix"},isAdmin&&__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_checkbox___default.a,{className:"fl",onChange:this.onCheckAll,checked:checkAllValue},"\u5DF2\u9009 ",checkBoxValues.length," \u4E2A   \uFF08\u4E0D\u652F\u6301\u8DE8\u9875\u52FE\u9009\uFF09"),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("div",{className:"studentList_operation_ul"},!!isAdmin&&__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_8_react___default.a.Fragment,null,__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("li",{className:"li_line"},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("a",{href:"javascript:void(0)",className:"color-grey-9",onClick:this.onDelete},"\u5220\u9664")),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("li",{className:"li_line"},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("a",{href:"javascript:void(0)",className:"color-grey-9",onClick:this.onSendToOtherCourse},"\u53D1\u9001")),coursedata&&!!coursedata.course_public&&__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("li",{className:"li_line"},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("a",{href:"javascript:void(0)",className:"color-grey-9",onClick:this.onSetToOpen},"\u8BBE\u4E3A\u516C\u5F00")),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("li",{className:"li_line drop_down"},"\u79FB\u52A8\u5230...",__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("i",{className:"iconfont icon-xiajiantou font-12 ml2"}),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("ul",{className:"drop_down_menu",style:{"right":"0px","left":"unset",maxHeight:'318px',overflowY:'auto',minWidth:'200px'}},boards&&boards.length>10&&__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("p",{className:"drop_down_search"},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_input___default.a,{placeholder:"\u641C\u7D22",value:this.state.dirSearchValue,onChange:function onChange(e){_this2.setState({dirSearchValue:e.target.value});}})),boards&&boards.filter(function(item){return item.id!=bid&&(!_this2.state.dirSearchValue||item.name.indexOf(_this2.state.dirSearchValue)!=-1);}).map(function(item,index){return __WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("li",{key:"i_"+index,onClick:function onClick(){return _this2.moveTo(item);},title:item.name},item.name);}),isAdmin&&!isCourseEnd&&__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("p",{className:"drop_down_btn"},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("a",{href:"javascript:void(0)",className:"color-grey-6",onClick:function onClick(){return _this2.addDir();}},"\u65B0\u5EFA\u76EE\u5F55..."))))),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("li",{className:"drop_down"},sort_type=='time'?'时间排序':'热度排序',__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("i",{className:"iconfont icon-xiajiantou font-12 ml2"}),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("ul",{className:"drop_down_normal"},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("li",{onClick:function onClick(){return _this2.onSortTypeChange('time');}},"\u65F6\u95F4\u6392\u5E8F"),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("li",{onClick:function onClick(){return _this2.onSortTypeChange('hot');}},"\u70ED\u5EA6\u6392\u5E8F")))))),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("style",null,"\n          .panel-inner-fourm {\n            border-bottom: none;\n          }\n          .panel-inner-fourm:hover {\n            background: #fff;\n          }\n        "),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_spin___default.a,{size:"large",spinning:this.state.isSpin},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("div",{className:"clearfix stu_table"},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_checkbox___default.a.Group,{style:{width:'100%'},onChange:this.onCheckBoxChange,value:checkBoxValues},messages.map(function(item,index){return __WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("div",{className:"mt20 edu-back-white padding02010",key:"d_"+index},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_10__BoardsListItem__["a" /* default */],Object.assign({},_this2.props,{discussMessage:item,checkBox:isAdmin?__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_checkbox___default.a,{value:item.id,key:item.id}):'',onItemClick:_this2.onItemClick,onSticky:_this2.onSticky})));})))),!this.state.isSpin&&(!messages||messages.length==0)&&__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_14__coursesPublic_NoneData__["a" /* default */],null),pagination.total_count>15&&__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_pagination___default.a,{className:"coursePagination",current:pagination.page,showQuickJumper:true,pageSize:15,total:pagination.total_count,onChange:this.onPageChange}));}}]);return Boards;}(__WEBPACK_IMPORTED_MODULE_8_react__["Component"]);/* harmony default export */ __webpack_exports__["default"] = (Object(__WEBPACK_IMPORTED_MODULE_19__common_js__["a" /* RouteHOC */])()(Boards));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__boardsListItem_css__ = __webpack_require__(3295);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__boardsListItem_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__boardsListItem_css__);
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var BoardsListItem=function(_Component){_inherits(BoardsListItem,_Component);function BoardsListItem(props){_classCallCheck(this,BoardsListItem);var _this=_possibleConstructorReturn(this,(BoardsListItem.__proto__||Object.getPrototypeOf(BoardsListItem)).call(this,props));_this.onTitleClick=function(discussMessage){if(_this.props.checkIfLogin()===false){_this.props.showLoginDialog();return;}// if(this.props.checkIfProfileCompleted()===false){
// 	this.setState({
...
// 	return
// }
var isAdminOrStudent=_this.props.isAdminOrStudent();if(!isAdminOrStudent&&discussMessage.is_public==false){// 没有权限访问
return;}var cid=_this.props.match.params.coursesId;var board_id=_this.props.match.params.boardId;_this.props.toDetailPage(cid,board_id,discussMessage.id);};_this.state={};return _this;}_createClass(BoardsListItem,[{key:'render',value:function render(){var _this2=this;var addGroup=this.state.addGroup;var isAdmin=this.props.isAdmin();var isAdminOrStudent=this.props.isAdminOrStudent();var _props=this.props,checkBox=_props.checkBox,discussMessage=_props.discussMessage,onSticky=_props.onSticky,onItemClick=_props.onItemClick,current_user=_props.current_user;if(!discussMessage||!discussMessage.author){return'';}var canNotLink=!isAdminOrStudent&&discussMessage.is_public==false;return __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('div',{className:'panel-inner-fourm boardsList'},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('style',null,'\n            .boardsList .panel-list-img {\n              width: 50px;\n              height: 50px;\n            }\n          '),checkBox,__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('a',{href:'/users/'+discussMessage.author.login,alt:'\u7528\u6237',style:{"width":"50px","height":"50px","display":"block",margin:"0 10px"}},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('img',{alt:'1?1529221779',className:'panel-list-img mr15',height:'50',src:Object(__WEBPACK_IMPORTED_MODULE_4_educoder__["U" /* getUrl */])()+'/images/'+discussMessage.author.image_url,width:'50'})),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('div',{className:'clearfix ds pr pt5 contentSection',onClick:function onClick(){return onItemClick(discussMessage);}},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('h6',null,canNotLink?__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('span',{className:'fl mt3 font-16 font-bd color-dark maxwidth580 pointer',title:canNotLink?"私有属性，非课堂成员不能访问":''+discussMessage.subject},discussMessage.subject):__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('a',{className:'panel-list-title hide fl mt5 color-dark font-bd pointer',style:{fontWeight:'bold',maxWidth:'700px'},title:discussMessage.subject,onClick:canNotLink?function(){}:function(){return _this2.onTitleClick(discussMessage);}},discussMessage.subject),!!discussMessage.sticky&&__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('span',{className:'btn-cir btn-cir-red fl mt5 ml5'},'\u7F6E\u9876'),discussMessage.is_public==false?__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_tooltip___default.a,{title:'私有属性，非课堂成员不能访问',placement:'bottom'},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('i',{className:'iconfont icon-guansuo color-grey-c ml10 font-16 fl mt4'})):""),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('div',{className:'fr'},(isAdmin||discussMessage.author.login==current_user.login)&&__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4_educoder__["A" /* WordsBtn */],{style:'blue',className:'fr font-16 ml28',onClick:function onClick(e){_this2.props.toEditPage(_this2.props.match.params.coursesId,_this2.props.match.params.boardId,discussMessage.id);}},'\u7F16\u8F91'),isAdmin&&__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4_educoder__["A" /* WordsBtn */],{style:'blue',className:'fr font-16 ml28',onClick:function onClick(e){debugger;onSticky(discussMessage);e.cancelBubble=true;e.stopPropagation();}},discussMessage.sticky?'取消置顶':'置顶'),canNotLink?"":__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4_educoder__["A" /* WordsBtn */],{style:'blue',className:'font-16 fr ',onClick:canNotLink?function(){}:function(){return _this2.onTitleClick(discussMessage);}},'\u67E5\u770B\u8BE6\u60C5')),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('div',{className:'cl'}),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('p',{className:'color-grey panel-lightgrey mt18 fl'},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('span',{className:'mr50'},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('a',{href:'/users/'+discussMessage.author.login,className:'panel-name-small hide fl mr15 mr30 color-grey3 font-14'},discussMessage.author.name),discussMessage.total_replies_count!=0&&__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('span',{className:'mr15 color-grey9 font-14'},discussMessage.total_replies_count,' \u56DE\u590D'),discussMessage.praises_count!=0&&__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('span',{className:'mr15 color-grey9 font-14'},discussMessage.praises_count,' \u70B9\u8D5E'),discussMessage.visits!=0&&__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('span',{className:'mr15 color-grey9 font-14'},discussMessage.visits,' \u6D4F\u89C8'),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('span',{className:'mr15 color-light-grey-C font-14'},__WEBPACK_IMPORTED_MODULE_3_moment___default()(discussMessage.created_on).fromNow(),' '))),discussMessage.category_name&&__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('div',{className:'directory_style'},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4_educoder__["g" /* ConditionToolTip */],{title:discussMessage.category_name,condition:discussMessage.category_name},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('div',{className:' color-grey9 task-hide fr',style:{"maxWidth":"216px"},title:discussMessage.category_name},'\u6240\u5C5E\u76EE\u5F55\uFF1A',discussMessage.category_name)))));}}]);return BoardsListItem;}(__WEBPACK_IMPORTED_MODULE_2_react__["Component"]);/* harmony default export */ __webpack_exports__["a"] = (BoardsListItem);
...
// module
exports.push([module.i, ".directory_style{position:absolute;right:0;bottom:0;maxSize:20px;overflow:hidden;whiteSpace:nowrap;textOverflow:ellipsis}", "", {"version":3,"sources":["/Users/jasder/work/trustie3.0/forgeplus-react/src/modules/courses/boards/boardsListItem.css"],"names":[],"mappings":"AAAA,iBACE,kBAAmB,AACnB,QAAS,AACT,SAAU,AACV,aAAc,AACd,gBAAiB,AACjB,kBAAmB,AACnB,qBAAsB,CACvB","file":"boardsListItem.css","sourcesContent":[".directory_style {\n  position: absolute;\n  right: 0;\n  bottom: 0;\n  maxSize: 20px;\n  overflow: hidden;\n  whiteSpace: nowrap;\n  textOverflow: ellipsis\n}"],"sourceRoot":""}]);
