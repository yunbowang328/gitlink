...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__css_Courses_css__ = __webpack_require__(311);
...
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var Option=__WEBPACK_IMPORTED_MODULE_15_antd_lib_select___default.a.Option;var CheckboxGroup=__WEBPACK_IMPORTED_MODULE_13_antd_lib_checkbox___default.a.Group;var confirm=__WEBPACK_IMPORTED_MODULE_11_antd_lib_modal___default.a.confirm;var GraduationTasksedittype=true;var GraduationTasksedit=function(_Component){_inherits(GraduationTasksedit,_Component);function GraduationTasksedit(props){_classCallCheck(this,GraduationTasksedit);var _this=_possibleConstructorReturn(this,(GraduationTasksedit.__proto__||Object.getPrototypeOf(GraduationTasksedit)).call(this,props));_this.goback=function(){// let courseId = this.props.match.params.coursesId;
// if(courseId===undefined){
// 	this.props.history.push("/courses");
// }else{
// 	this.props.history.push(this.props.current_user.first_category_url);
// }
_this.props.history.replace("/courses/"+_this.state.data.course_id+"/graduation_tasks/"+_this.state.data.graduation_id);};_this.changeTitle=function(e){//   title_num:60-parseInt(e.target.value.length),
_this.setState({title_num:e.target.value.length,title_value:e.target.value});};_this.handleChange=function(info){if(info.file.status==='uploading'||info.file.status==='done'||info.file.status==='removed'){var fileList=info.fileList;// console.log(fileList)
// for(var list of fileList ){
//   console.log(fileList)
// }
_this.setState({fileList:Object(__WEBPACK_IMPORTED_MODULE_19_educoder__["C" /* appendFileSizeToUploadFileAll */])(fileList)});}};_this.cancelAttachment=function(){_this.setState({Modalstype:false,Loadtype:false,Modalstopval:'确定要删除这个附件吗?',ModalSave:"",ModalCancel:""});};_this.onAttachmentRemove=function(file){if(!file.percent||file.percent==100){// debugger
_this.cancelAttachment();var url="/attachments/"+(file.response?file.response.id:file.uid)+".json";// const url = `/attachments/${file}.json`
__WEBPACK_IMPORTED_MODULE_20_axios___default.a.delete(url,{}).then(function(response){if(response.data){if(response.data.status===0){_this.setState({Modalstype:false,Modalstopval:response.data.message,ModalSave:_this.cancelAttachment,Loadtype:true});_this.setState(function(state){var index=state.fileList.indexOf(file);var newFileList=state.fileList.slice();newFileList.splice(index,1);return{fileList:newFileList};});}}}).catch(function(error){console.log(error);});}};_this.Commoninterface=function(fileList){var listid=[];var graduation_id=_this.state.data.graduation_id;if(fileList!=undefined&&fileList.length>0){var _iteratorNormalCompletion=true;var _didIteratorError=false;var _iteratorError=undefined;try{for(var _iterator=fileList[Symbol.iterator](),_step;!(_iteratorNormalCompletion=(_step=_iterator.next()).done);_iteratorNormalCompletion=true){var list=_step.value;if(list.response!=undefined){listid.push(list.response.id);}else{listid.push(list.uid);}}}catch(err){_didIteratorError=true;_iteratorError=err;}finally{try{if(!_iteratorNormalCompletion&&_iterator.return){_iterator.return();}}finally{if(_didIteratorError){throw _iteratorError;}}}}// console.log(listid)
// if(GraduationTasksedittype===true){
_this.props.form.validateFields(function(err,values){if(!err){if(values.tasktype===undefined){_this.scrollToAnchors("tasktypes");return;}if(values.name===undefined){_this.scrollToAnchors("nametypes");return;}if(values.description===undefined){_this.scrollToAnchors("descriptiontypes");return;}else if(values.description.length>5000){_this.scrollToAnchors("descriptiontypes");return;}console.log('Received values of form: ',values);// console.log(fileList);
var tasksid=_this.props.match.params.category_id;var url="/graduation_tasks/"+tasksid+".json";__WEBPACK_IMPORTED_MODULE_20_axios___default.a.put(url,{task_type:parseInt(values.tasktype),name:values.name,description:values.description,attachment_ids:listid}).then(function(response){if(response.status===200){// console.log(response)
...
_this.goback();//this.props.history.push("/courses/"+this.props.match.params.coursesId+"/graduation_tasks/"+graduation_id+"/"+this.props.match.params.category_id +"/setting");
}}).catch(function(error){console.log(error);});}});// }
};_this.handleSubmit=function(e){var fileList=_this.state.fileList;// if(fileList.length===0){
//   this.setState({
//     shixunsreplace:true,
//   })
//   return
// }
_this.Commoninterface(fileList);};_this.hidestartshixunsreplace=function(){var fileList=_this.state.fileList;_this.Commoninterface(fileList);};_this.hidestartshixunsreplacetwo=function(){_this.setState({shixunsreplace:false});};_this.checkContent=function(rule,value,callback){if(value.length>5000){callback('最大限制为5000个字符');}else{callback();}};_this.state={coursename:"",coursesearch:"",title_num:0,title_value:"",fileList:[],contents:[{val:"",id:1}],taskid:"",taskneme:"",tasktype:undefined,name:"",description:undefined,shixunsreplace:false,graduationtask_id:undefined};return _this;}_createClass(GraduationTasksedit,[{key:"componentDidMount",value:function componentDidMount(){var _this2=this;var title_num=this.state.title_num;var tasksid=this.props.match.params.category_id;var url="/graduation_tasks/"+tasksid+"/edit.json";__WEBPACK_IMPORTED_MODULE_20_axios___default.a.get(url).then(function(result){// console.log(result)
// let newfilelist=[];
...
//
// }
var namelength=result.data.task_name.length;// let sixlength=title_num-namelength
var fileList=result.data.attachments.map(function(item){return{id:item.id,uid:item.id,name:Object(__WEBPACK_IMPORTED_MODULE_19_educoder__["B" /* appendFileSizeToUploadFile */])(item),url:item.url,filesize:item.filesize,status:'done'};});_this2.setState({// fileList:newfilelist,
description:result.data.description,tasktype:result.data.task_type,name:result.data.task_name,data:result.data,title_num:namelength,attachments:result.data.attachments,fileList:fileList,graduationtask_id:result.data.graduation_id});_this2.props.form.setFieldsValue({tasktype:result.data.task_type,name:result.data.task_name});}).catch(function(error){console.log(error);});}// 输入title
// 附件相关 START
...
//确认
//取消
},{key:"render",value:function render(){var _this3=this;var getFieldDecorator=this.props.form.getFieldDecorator;var _state=this.state,title_num=_state.title_num,pageType=_state.pageType,name=_state.name,description=_state.description,Loadtype=_state.Loadtype,attachments=_state.attachments,fileList=_state.fileList,Modalstype=_state.Modalstype,Modalstopval=_state.Modalstopval,ModalCancel=_state.ModalCancel,ModalSave=_state.ModalSave,shixunsreplace=_state.shixunsreplace,graduationtask_id=_state.graduationtask_id;var coursedata=this.props.coursedata;var courseId=this.props.match.params.coursesId;var category_id=this.props.match.params.category_id;var uploadProps={width:600,fileList:fileList,// https://github.com/ant-design/ant-design/issues/15505
// showUploadList={false}，然后外部拿到 fileList 数组自行渲染列表。
// showUploadList: false,
action:""+Object(__WEBPACK_IMPORTED_MODULE_19_educoder__["R" /* getUploadActionUrl */])(),onChange:this.handleChange,onRemove:this.onAttachmentRemove,beforeUpload:function beforeUpload(file){console.log('beforeUpload',file.name);var isLt150M=file.size/1024/1024<150;if(!isLt150M){_this3.props.showNotification('文件大小必须小于150MB!');}return isLt150M;}};document.title=this.props.current_user&&this.props.current_user.course_name;return __WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_16_react___default.a.Fragment,null,__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",null,__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_21__modals_Modals__["a" /* default */],{modalsType:Modalstype,modalsTopval:Modalstopval,modalCancel:ModalCancel,modalSave:ModalSave,loadtype:Loadtype}),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11_antd_lib_modal___default.a,{keyboard:false,title:"\u63D0\u793A",visible:shixunsreplace,closable:false,footer:null},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{className:"task-popup-content"},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("p",{className:"task-popup-text-center font-16 "},"\u8FD8\u672A\u4E0A\u4F20\u9644\u4EF6"),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("p",{className:"task-popup-text-center font-16 pb20"},"\u662F\u5426\u786E\u8BA4\u63D0\u4EA4\u4F5C\u54C1?")),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{className:"task-popup-submit clearfix"},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("a",{className:"task-btn task-btn-orange fr ",onClick:function onClick(){return _this3.hidestartshixunsreplace();}},"\u786E\u8BA4"),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("a",{className:"task-btn fr mr50",onClick:function onClick(){return _this3.hidestartshixunsreplacetwo();}},"\u53D6\u6D88"))),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{className:"newMain clearfix"},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{className:"educontent mb20"},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("p",{className:"clearfix mt10"},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_19_educoder__["A" /* WordsBtn */],{style:"grey",className:"fl"},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_17_react_router_dom__["b" /* Link */],{to:"/courses/"+graduationtask_id,className:"color-grey-6"},this.props.current_user&&this.props.current_user.course_name)),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("span",{className:"color-grey-9 fl ml3 mr3"},">"),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_19_educoder__["A" /* WordsBtn */],{style:"grey",className:"fl"}," ",__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_17_react_router_dom__["b" /* Link */],{to:"/courses/"+courseId+"/graduation_tasks/"+graduationtask_id,className:"color-grey-6"},"\u6BD5\u8BBE\u4EFB\u52A1")),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("span",{className:"color-grey-9 fl ml3 mr3"},">"),name===""?"":__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_19_educoder__["A" /* WordsBtn */],{style:"grey",className:"fl"},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_17_react_router_dom__["b" /* Link */],{to:"/courses/"+courseId+"/graduation_tasks/"+graduationtask_id+"/detail/"+category_id+"/list",className:"color-grey-6"},name),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("span",{className:"color-grey-9 ml3 mr3"},">")),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("span",null,"编辑")),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{style:{width:'100%',height:'75px'}},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("p",{className:" fl color-black mt25 summaryname"},"\u7F16\u8F91\u6BD5\u8BBE\u4EFB\u52A1"),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("a",{className:"color-grey-6 fr font-16 ml30 mt10 mr20",onClick:this.goback},"\u8FD4\u56DE")),description===undefined?"":__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",null,__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{className:"stud-class-set bor-bottom-greyE pt20 pl20 pr20 pb0 edu-back-white"},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{label:"\u7C7B\u578B"},getFieldDecorator('tasktype',{rules:[{required:true,message:"请选择任务类型"}]})(__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_15_antd_lib_select___default.a,{className:"greyInput",style:{width:'20%'},disabled:true,placeholder:"\u8BF7\u9009\u62E9\u4EFB\u52A1\u7C7B\u578B"},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(Option,{value:1},"\u666E\u901A"),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(Option,{value:2},"\u5206\u7EC4"))),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("input",{type:"hidden",id:"tasktypes"}),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("span",{className:"newcoursestitle"},"\uFF08\u9009\u62E9\u786E\u8BA4\u540E\uFF0C\u65E0\u6CD5\u4FEE\u6539\uFF09")),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("style",null,"\n\t\t\t\t\t\t\t\t\t\t\t.yslgraduainputedit .ant-input{\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tborder-right: none !important;\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\theight: 40px !important;\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t}\n\n\t\t\t\t\t\t\t\t\t\t\t"),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{label:"\u4EFB\u52A1\u6807\u9898"},getFieldDecorator('name',{rules:[{required:true,message:"请输入标题"}]})(__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_input___default.a,{placeholder:"\u8BF7\u8F93\u5165\u4EFB\u52A1\u540D\u79F0\uFF0C\u6700\u5927\u9650\u523660\u4E2A\u5B57\u7B26",value:name,onInput:this.changeTitle,className:"searchView searchViewAfter yslgraduainputedit",style:{"width":"100%"},maxLength:"60",addonAfter:String(title_num)+"/60"}))),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("input",{type:"hidden",id:"nametypes"})),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{className:"stud-class-set pt20 pl20 pr20 pb0 coursenavbox edu-back-white"},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("style",null,"\n                .uploadBtn.ant-btn {\n                  border: none;\n                  color: #4CACFF;\n                  box-shadow: none;\n                  background: transparent;\n                  padding: 0 6px;\n                }\n                .ant-upload-list-item:hover .ant-upload-list-item-info{\n                  background-color:#fff;\n                }\n                .upload_1 .ant-upload-list {\n                  width: 350px;\n                }\n\n              "),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{label:"\u5185\u5BB9",className:"mdInForm",style:{marginBottom:'0px'}},getFieldDecorator('description',{rules:[{required:true,message:'请输入内容'},{max:5000,message:'最大限制5000个字符'}]})(__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_18__tpm_challengesnew_TPMMDEditor__["a" /* default */],Object.assign({ref:this.mdRef,placeholder:'请输入任务内容说明，最大限制5000个字符'},this.state,this.props,{mdID:'courseMessageMD',initValue:description,className:"courseMessageMD"})))),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("input",{type:"hidden",id:"descriptiontypes"}),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_upload___default.a,Object.assign({},uploadProps,{fileList:this.state.fileList,className:"upload_1 ml5"}),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_button___default.a,{className:"uploadBtn"},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_icon___default.a,{type:"upload"})," \u4E0A\u4F20\u9644\u4EF6"),"(\u5355\u4E2A\u6587\u4EF6150M\u4EE5\u5185)")),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,null,__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{className:"clearfix mt30 mb30"},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_button___default.a,{type:"primary",htmlType:"submit",onClick:function onClick(){return _this3.handleSubmit();},className:"defalutSubmitbtn fl mr20"},"\u63D0\u4EA4"),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("a",{onClick:this.goback,className:"defalutCancelbtn fl"},"\u53D6\u6D88"))))))));}}]);return GraduationTasksedit;}(__WEBPACK_IMPORTED_MODULE_16_react__["Component"]);var GraduationTaskseditApp=__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.create({name:'coursesNew'})(GraduationTasksedit);/* harmony default export */ __webpack_exports__["default"] = (GraduationTaskseditApp);
