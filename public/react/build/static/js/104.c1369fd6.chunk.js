...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_antd_lib_select_style_css__ = __webpack_require__(306);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_antd_lib_select__ = __webpack_require__(302);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__tpm_challengesnew_TPMMDEditor__ = __webpack_require__(319);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__common_formCommon_css__ = __webpack_require__(1316);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__common_formCommon_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_20__common_formCommon_css__);
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}// import './board.css'
// import { RouteHOC } from './common.js'
var confirm=__WEBPACK_IMPORTED_MODULE_15_antd_lib_modal___default.a.confirm;var $=window.$;var Option=__WEBPACK_IMPORTED_MODULE_13_antd_lib_select___default.a.Option;// 提交作品
...
var GraduateTopicPostWorksNew=function(_Component){_inherits(GraduateTopicPostWorksNew,_Component);function GraduateTopicPostWorksNew(props){_classCallCheck(this,GraduateTopicPostWorksNew);var _this=_possibleConstructorReturn(this,(GraduateTopicPostWorksNew.__proto__||Object.getPrototypeOf(GraduateTopicPostWorksNew)).call(this,props));_this.componentDidMount=function(){var topicId=_this.props.match.params.topicId;var cid=_this.props.match.params.coursesId;var boardsUrl='/courses/'+cid+'/get_all_boards.json';__WEBPACK_IMPORTED_MODULE_18_axios___default.a.get(boardsUrl,{}).then(function(response){if(response.data.status==0){_this.setState({boards:response.data.data});}}).catch(function(error){console.log(error);});var isEdit=!!topicId;_this.isEdit=isEdit;if(isEdit){var url='/messages/'+topicId+'.json';__WEBPACK_IMPORTED_MODULE_18_axios___default.a.get(url,{}).then(function(response){if(response.data.status==0){var _response$data=response.data,id=_response$data.id,data=_response$data.data;if(data){_this.editTopic=data;_this.props.form.setFieldsValue({content:data.content,subject:data.subject,board_id:data.board_id});_this.mdRef.current.setValue(data.content);var _fileList=data.attachments.map(function(item){return{id:item.id,uid:item.id,name:item.title,url:item.url,status:'done'};});_this.setState({fileList:_fileList});}}}).catch(function(error){console.log(error);});}else{var boardId=_this.props.match.params.boardId;_this.props.form.setFieldsValue({board_id:parseInt(boardId)});}};_this.handleSubmit=function(e){e.preventDefault();var cid=_this.props.match.params.coursesId;var boardId=_this.props.match.params.boardId;_this.props.form.validateFieldsAndScroll(function(err,values){if(!err){console.log('Received values of form: ',values);if(_this.isEdit==true){var editTopic=_this.editTopic;var editUrl='/messages/'+editTopic.id+'.json';var attachment_ids=undefined;if(_this.state.fileList){attachment_ids=_this.state.fileList.map(function(item){return item.response?item.response.id:item.id;});}__WEBPACK_IMPORTED_MODULE_18_axios___default.a.put(editUrl,{subject:values.subject,board_id:values.board_id,content:values.content,sticky:values.sticky,attachment_ids:attachment_ids// board_id: 3779,
}).then(function(response){if(response.data.status==0){var id=response.data.id;console.log('--- success');_this.props.toDetailPage(cid,values.board_id,editTopic.id);}}).catch(function(error){console.log(error);});}else{var url='/messages.json';var _attachment_ids=undefined;if(_this.state.fileList){_attachment_ids=_this.state.fileList.map(function(item){return item.response.id;});}__WEBPACK_IMPORTED_MODULE_18_axios___default.a.post(url,Object.assign({},values,{course_id:cid,board_id:boardId,attachment_ids:_attachment_ids})).then(function(response){if(response.data){var id=response.data.id;if(id){console.log('--- success');}}}).catch(function(error){console.log(error);});}}else{$("html").animate({scrollTop:$('html').scrollTop()-100});}});};_this.handleChange=function(info){if(info.file.status==='uploading'||info.file.status==='done'||info.file.status==='removed'){var fileList=info.fileList;_this.setState({fileList:fileList});}};_this.onAttachmentRemove=function(file){if(!file.percent||file.percent==100){confirm({title:'确定要删除这个附件吗?',okText:'确定',cancelText:'取消',// content: 'Some descriptions',
onOk:function onOk(){_this.deleteAttachment(file);},onCancel:function onCancel(){console.log('Cancel');}});return false;}};_this.deleteAttachment=function(file){var url='/attachments/'+file.id+'.json';__WEBPACK_IMPORTED_MODULE_18_axios___default.a.delete(url,{}).then(function(response){if(response.data){var status=response.data.status;if(status==0){console.log('--- success');_this.setState(function(state){var index=state.fileList.indexOf(file);var newFileList=state.fileList.slice();newFileList.splice(index,1);return{fileList:newFileList};});}}}).catch(function(error){console.log(error);});};_this.mdRef=__WEBPACK_IMPORTED_MODULE_16_react___default.a.createRef();_this.state={fileList:[],boards:[]};return _this;}// 附件相关 START
_createClass(GraduateTopicPostWorksNew,[{key:'render',// 附件相关 ------------ END
value:function render(){var _this2=this;var _state=this.state,addGroup=_state.addGroup,fileList=_state.fileList;var getFieldDecorator=this.props.form.getFieldDecorator;var formItemLayout={labelCol:{xs:{span:24},// sm: { span: 8 },
sm:{span:24}},wrapperCol:{xs:{span:24},// sm: { span: 16 },
sm:{span:24}}};var tailFormItemLayout={wrapperCol:{xs:{span:24,offset:0},sm:{span:16,offset:8}}};var uploadProps={width:600,fileList:fileList,multiple:true,// https://github.com/ant-design/ant-design/issues/15505
// showUploadList={false}，然后外部拿到 fileList 数组自行渲染列表。
// showUploadList: false,
action:''+Object(__WEBPACK_IMPORTED_MODULE_19_educoder__["R" /* getUploadActionUrl */])(),onChange:this.handleChange,onRemove:this.onAttachmentRemove,beforeUpload:function beforeUpload(file){console.log('beforeUpload',file.name);var isLt150M=file.size/1024/1024<150;if(!isLt150M){_this2.props.showNotification('文件大小必须小于150MB!');}return isLt150M;}};return __WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',{className:'newMain '},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('style',null,'\n            .courseForm .ant-form {\n            }\n            \n          '),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',{className:'edu-class-container edu-position courseForm'},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',{style:{width:'100%',height:'70px'}},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('p',{className:'ml15 fl color-black mt30 summaryname'},'\u63D0\u4EA4\u4F5C\u54C1'),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('a',{onClick:function onClick(){return _this2.props.history.goBack();},className:'color-grey-6 fr font-16 ml30 mt18 mr20'},'\u8FD4\u56DE')),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a,Object.assign({},formItemLayout,{onSubmit:this.handleSubmit}),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',{className:'formBlock',style:{paddingBottom:'0px'}},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{label:'\u6807\u9898'},getFieldDecorator('subject',{rules:[{required:true,message:'请输入标题'},{max:20,message:'最大限制为20个字符'}]})(__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11_antd_lib_input___default.a,{placeholder:'\u8BF7\u8F93\u5165\u5E16\u5B50\u6807\u9898\uFF0C\u6700\u5927\u9650\u523620\u4E2A\u5B57\u7B26'})))),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('style',null,'\n                .courseMessageMD {\n                  width: 1140px;\n                }\n                \n                .uploadBtn.ant-btn {\n                  border: none;\n                  color: #4CACFF;\n                  box-shadow: none;\n                  background: transparent;\n                  padding: 0 6px;\n                }\n                .upload_1 .ant-upload-list {\n                  width: 350px;\n                }\n                \n              '),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',{className:'formBlock'},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{label:'\u5185\u5BB9',className:'mdInForm'},getFieldDecorator('content',{rules:[{required:true,message:'请输入帖子内容'},{max:10000,message:'最大限制为10000个字符'}]})(__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_17__tpm_challengesnew_TPMMDEditor__["a" /* default */],{ref:this.mdRef,placeholder:'请在此输入帖子详情，最大限制为10000个字符',mdID:'courseMessageMD',initValue:this.editTopic?this.editTopic.content:'',className:'courseMessageMD'}))),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_upload___default.a,Object.assign({},uploadProps,{className:'upload_1'}),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_button___default.a,{className:'uploadBtn'},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_icon___default.a,{type:'upload'}),' \u4E0A\u4F20\u9644\u4EF6'),'(\u5355\u4E2A\u6587\u4EF6150M\u4EE5\u5185)')),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('style',null,'\n                .courseForm .flexBlock.formBlock {\n                  align-items: flex-end;\n                  display: flex;\n                  flex-wrap: wrap;\n                }\n                .courseForm .flexBlock .tag {\n                  margin-left: 8px;\n                  margin-right: 6px;\n                  margin-bottom: 16px;\n                }\n                .flexBlock .ant-row.ant-form-item {\n                  margin-bottom: 6px;\n                }\n              '),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',{className:'formBlock flexBlock',style:{}},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{label:'\u5206\u7EC4\u8BBE\u7F6E',className:' ',style:{display:'inline-block',marginLeft:"14px"}},getFieldDecorator('min',{rules:[{required:true,message:'请输入每组最小人数'}]})(__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11_antd_lib_input___default.a,{placeholder:'\u8BF7\u586B\u5199\u6BCF\u7EC4\u6700\u5C0F\u4EBA\u6570'}))),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('span',{className:'tag'},'~'),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{label:'',className:'  ',style:{}},getFieldDecorator('max',{rules:[{// required: true, message: '请输入每组最大人数',
}]})(__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11_antd_lib_input___default.a,{placeholder:'\u8BF7\u586B\u5199\u6BCF\u7EC4\u6700\u5927\u4EBA\u6570'}))),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('span',{className:'tag color-grey9 '},'(\u5B66\u751F\u63D0\u4EA4\u4F5C\u54C1\u65F6\u9700\u8981\u5173\u8054\u540C\u7EC4\u6210\u5458\uFF0C\u7EC4\u5185\u6210\u5458\u4F5C\u54C1\u5171\u4EAB)'),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{label:'',className:'  ',style:{marginLeft:"14px"}},getFieldDecorator('c',{rules:[]})(__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_checkbox___default.a,null,'\u57FA\u4E8E\u9879\u76EE\u5B9E\u65BD'))),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('span',{className:'tag color-grey9 '},'(\u9009\u4E2D\uFF0C\u5219\u5FC5\u987B\u5728\u672C\u5E73\u53F0\u521B\u5EFA\u9879\u76EE\uFF0C\u9879\u76EE\u7BA1\u7406\u5458\u53EF\u4EE5\u63D0\u4EA4\u4F5C\u54C1\uFF1B\u4E0D\u9009\u4E2D\uFF0C\u65E0\u9700\u5728\u5E73\u53F0\u521B\u5EFA\u9879\u76EE\uFF0C\u4EFB\u610F\u5C0F\u7EC4\u6210\u5458\u5747\u53EF\u4EE5\u63D0\u4EA4\u4F5C\u54C1)')),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',{className:'formBlock'},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{label:'\u53C2\u8003\u7B54\u6848'},getFieldDecorator('answer',{rules:[{required:true,message:'请输入帖子内容'},{max:10000,message:'最大限制为10000个字符'}]})(__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_17__tpm_challengesnew_TPMMDEditor__["a" /* default */],{ref:this.mdRef,placeholder:'请在此输入参考答案，最大限制为5000个字符',mdID:'courseAnswerMD',initValue:this.editTopic?this.editTopic.content:'',className:'courseMessageMD'})))),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,null,__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('div',{className:'clearfix mt30 mb30'},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_button___default.a,{type:'primary',htmlType:'submit',className:'defalutSubmitbtn fl mr20'},'\u63D0\u4EA4'),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement('a',{className:'defalutCancelbtn fl'},'\u53D6\u6D88'))))));}}]);return GraduateTopicPostWorksNew;}(__WEBPACK_IMPORTED_MODULE_16_react__["Component"]);var WrappedGraduateTopicPostWorksNew=__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.create({name:'topicPostWorksNew'})(GraduateTopicPostWorksNew);// RouteHOC()
/* harmony default export */ __webpack_exports__["default"] = (WrappedGraduateTopicPostWorksNew);
