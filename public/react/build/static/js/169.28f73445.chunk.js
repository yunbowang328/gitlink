...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_moment__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_moment___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10_moment__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__css_index_css__ = __webpack_require__(2252);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__Branch_branch_css__ = __webpack_require__(2253);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__activity_css__ = __webpack_require__(3652);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__ActivityItem__ = __webpack_require__(4842);
...
var Activity=function(_Component){_inherits(Activity,_Component);function Activity(props){_classCallCheck(this,Activity);var _this=_possibleConstructorReturn(this,(Activity.__proto__||Object.getPrototypeOf(Activity)).call(this,props));_this.componentDidMount=function(){var _this$state=_this.state,time=_this$state.time,type=_this$state.type,status=_this$state.status,page=_this$state.page;_this.getInfo(time,type,status,page);};_this.getInfo=function(time,type,status,page){var projectsId=_this.props.match.params.projectsId;var url='/projects/'+projectsId+'/project_trends.json';__WEBPACK_IMPORTED_MODULE_15_axios___default.a.get(url,{params:{time:time,type:type,status:status,page:page}}).then(function(result){if(result){_this.setState({data:result.data,project_trends:result.data.project_trends});}}).catch(function(error){console.log(error);});};_this.changeTime=function(e){_this.setState({time:e.key});var _this$state2=_this.state,type=_this$state2.type,status=_this$state2.status,page=_this$state2.page;_this.getInfo(e.key,type,status,page);};_this.changeTrends=function(type,status){_this.setState({type:type,status:status});var _this$state3=_this.state,time=_this$state3.time,page=_this$state3.page;_this.getInfo(time,type,status,page);};_this.ChangePage=function(page){_this.setState({page:page});var _this$state4=_this.state,time=_this$state4.time,type=_this$state4.type,status=_this$state4.status;_this.getInfo(time,type,status,page);};_this.state={time:'30',type:undefined,state:undefined,page:1,data:undefined,project_trends:undefined};return _this;}// 切换周期
//筛选
// 分页
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__activity_css__ = __webpack_require__(3652);
