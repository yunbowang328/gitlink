...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_antd_lib_popconfirm_style_css__ = __webpack_require__(1411);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_antd_lib_popconfirm__ = __webpack_require__(1410);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_antd_lib_popconfirm_style_css__ = __webpack_require__(1411);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_antd_lib_popconfirm_style_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_antd_lib_popconfirm_style_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_antd_lib_popconfirm__ = __webpack_require__(1410);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_antd_lib_popconfirm___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_antd_lib_popconfirm__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_antd_lib_pagination_style_css__ = __webpack_require__(901);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_antd_lib_pagination_style_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10_antd_lib_pagination_style_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_antd_lib_pagination__ = __webpack_require__(903);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_antd_lib_pagination___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11_antd_lib_pagination__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__Nav__ = __webpack_require__(1480);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__Upload_Index__ = __webpack_require__(1757);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19_educoder__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__modules_courses_coursesPublic_NoneData__ = __webpack_require__(313);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__Upload_attachment__ = __webpack_require__(2254);
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var TextArea=__WEBPACK_IMPORTED_MODULE_13_antd_lib_input___default.a.TextArea;var Detail=function(_Component){_inherits(Detail,_Component);function Detail(props){_classCallCheck(this,Detail);var _this=_possibleConstructorReturn(this,(Detail.__proto__||Object.getPrototypeOf(Detail)).call(this,props));_this.componentDidMount=function(){_this.getDetail();};_this.getDetail=function(){var _this$props$match$par=_this.props.match.params,projectsId=_this$props$match$par.projectsId,orderId=_this$props$match$par.orderId;var url='/projects/'+projectsId+'/issues/'+orderId+'.json';__WEBPACK_IMPORTED_MODULE_16_axios___default.a.get(url).then(function(result){if(result){_this.setState({data:result.data});_this.getjournalslist();}}).catch(function(error){console.log(error);});};_this.handleok=function(){_this.setState({isShow:false});};_this.handleCancel=function(){_this.setState({isShow:false});};_this.imgshow=function(){_this.setState({isShow:true});};_this.addjournals=function(){_this.props.form.validateFieldsAndScroll(function(err,values){if(!err){var _this$state=_this.state,data=_this$state.data,page=_this$state.page,limit=_this$state.limit,fileList=_this$state.fileList;var url='/issues/'+data.id+'/journals.json';__WEBPACK_IMPORTED_MODULE_16_axios___default.a.post(url,Object.assign({},values,{issue_id:data.id,attachment_ids:fileList})).then(function(result){if(result){_this.props.form.setFieldsValue({content:""});_this.setState({showFiles:false});_this.getjournalslist(page,limit);_this.props.showNotification("评论成功！");// this.UploadFunc(undefined)
}}).catch(function(error){console.log(error);});}});};_this.getjournalslist=function(page,limit){var data=_this.state.data;var url='/issues/'+data.id+'/journals.json';var id=data.id;__WEBPACK_IMPORTED_MODULE_16_axios___default.a.get(url,{params:{id:id,page:page,limit:limit}}).then(function(result){if(result){_this.setState({journalsdata:result.data,search_count:result.data.journals_count,isSpin:false,fileList:undefined});}}).catch(function(error){console.log(error);});};_this.deletedetail=function(id){var _this$props$match$par2=_this.props.match.params,projectsId=_this$props$match$par2.projectsId,orderId=_this$props$match$par2.orderId;var url='/projects/'+projectsId+'/issues/'+orderId+'.json';__WEBPACK_IMPORTED_MODULE_16_axios___default.a.delete(url,{data:{project_id:projectsId,id:id}}).then(function(result){if(result){_this.props.history.push('/projects/'+projectsId+'/orders');}}).catch(function(error){console.log(error);});};_this.closedetail=function(id){var _this$props$match$par3=_this.props.match.params,projectsId=_this$props$match$par3.projectsId,orderId=_this$props$match$par3.orderId;var url='/projects/'+projectsId+'/issues/'+orderId+'/close_issue.json';__WEBPACK_IMPORTED_MODULE_16_axios___default.a.post(url,{project_id:projectsId,id:orderId,status_id:id}).then(function(result){if(result){_this.getDetail();}}).catch(function(error){console.log(error);});};_this.updatedetail=function(id){var _this$state2=_this.state,page=_this$state2.page,limit=_this$state2.limit;var orderId=_this.props.match.params.orderId;var url='/issues/'+orderId+'/journals/'+id+'.json';__WEBPACK_IMPORTED_MODULE_16_axios___default.a.put(url,{issue_id:orderId,id:id,content:_this.state.countvalue}).then(function(result){if(result){_this.setState({isedit:undefined});_this.getjournalslist(page,limit);}}).catch(function(error){console.log(error);});};_this.UploadFunc=function(fileList){_this.setState({fileList:fileList});};_this.deleteorder=function(id){var orderId=_this.props.match.params.orderId;var _this$state3=_this.state,page=_this$state3.page,limit=_this$state3.limit;var url='/issues/'+orderId+'/journals/'+id+'.json';__WEBPACK_IMPORTED_MODULE_16_axios___default.a.delete(url,{data:{issue_id:orderId,id:id}}).then(function(result){if(result){_this.getjournalslist(page,limit);}}).catch(function(error){console.log(error);});};_this.changmodelname=function(e){_this.setState({countvalue:e.target.value});};_this.editdetail=function(count,status){_this.setState({countvalue:count,isedit:status});};_this.renderJournalList=function(list){console.log(list);if(list&&list.length>0){return list.map(function(item,key){return __WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{key:key+1,className:'journal-list-item'},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',{className:'font-weight-bold mr3'},item.detail,'\uFF1A'),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',{className:'mr5 color-grey-9'},item.old_value&&item.old_value.length>0?"更新为":"新增"),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',null,item.value&&item.value.length>0?item.detail==="标签"?__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',{className:'issue-tag-show',style:{background:item.value[0].color}},item.value[0].name):item.value:"无"));});}else{return __WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',null,__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',null,'\u6CA1\u6709\u8BC4\u8BBA~'));}};_this.copydetail=function(){var _this$props$match$par4=_this.props.match.params,projectsId=_this$props$match$par4.projectsId,orderId=_this$props$match$par4.orderId;var url='/projects/'+projectsId+'/issues/'+orderId+'/copy.json';__WEBPACK_IMPORTED_MODULE_16_axios___default.a.post(url,{project_id:projectsId,id:orderId}).then(function(result){if(result){_this.props.history.push('/projects/'+projectsId+'/orders/'+result.data.issue_id+'/copyetail');}}).catch(function(error){console.log(error);});};_this.ChangePage=function(page){_this.setState({page:page,isSpin:true});var limit=_this.state.limit;_this.getjournalslist(page,limit);};_this.changeIsComplete=function(flag){_this.setState({showFiles:flag});};_this.state={data:undefined,isShow:false,imgsrc:'',journalsdata:undefined,//图片区域是否显示 none 隐藏 block 显示
display:'none',titledisplay:'none',countvalue:'',//是否需要编辑
isedit:undefined,fileList:undefined,limit:10,page:1,search_count:undefined,isSpin:false,showFiles:true};return _this;}//添加评论 
//获取评论信息
//删除工单信息
//关闭工单
//修改评论
...
// 翻页
// 判断是否重新上传文件
_createClass(Detail,[{key:'render',value:function render(){var _this2=this;var _props$match$params=this.props.match.params,projectsId=_props$match$params.projectsId,orderId=_props$match$params.orderId;var _state=this.state,data=_state.data,journalsdata=_state.journalsdata,page=_state.page,limit=_state.limit,search_count=_state.search_count,isSpin=_state.isSpin,isedit=_state.isedit,showFiles=_state.showFiles;var getFieldDecorator=this.props.form.getFieldDecorator;var current_user=this.props.current_user;var Paginations=__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_14_react___default.a.Fragment,null,search_count>limit?__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{className:'pt30 mb50 edu-txt-center btp1'},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11_antd_lib_pagination___default.a,{simple:true,defaultCurrent:page,total:search_count,pageSize:limit,onChange:this.ChangePage})):"");var renderList=function renderList(){if(journalsdata&&journalsdata.issue_journals&&journalsdata.issue_journals.length>0){return __WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{className:'tagList'},journalsdata.issue_journals.map(function(item,key){return __WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('li',{key:key},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{className:'df'},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_15_react_router_dom__["b" /* Link */],{to:''},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('img',{className:'user_img',src:Object(__WEBPACK_IMPORTED_MODULE_19_educoder__["M" /* getImageUrl */])('images/'+(item.user_picture&&item.user_picture)),alt:''})),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{className:'detail_context'},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{className:'topWrapper_detali'},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('p',{className:'ml6 detail_p lineH40'},item.user_name,__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',{className:'color-grey-9 ml3 mr3'},'\u8BC4\u8BBA\u4E8E'),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_tooltip___default.a,{title:item.format_time,placement:'bottom'},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',null,item.created_at))),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{className:'detail_right',style:{display:current_user&&isedit===undefined&&(current_user.admin||current_user.login===item.user_login)?"block":"none"}},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',{onClick:function onClick(){return _this2.editdetail(item.content,item.id);},className:'detail_edit_action'},'\u7F16\u8F91'),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_popconfirm___default.a,{placement:'bottom',title:'确定要删除当前评论吗?',okText:'\u662F',cancelText:'\u5426',onConfirm:function onConfirm(){return _this2.deleteorder(item.id);}},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',{className:'detail_edit_action'},'\u5220\u9664')))),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{className:'detail_ptitlecount'},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{style:{display:isedit&&isedit===item.id?"none":"block"}},item.content?__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',null,item.content):__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',null,_this2.renderJournalList(item.journal_details)),item&&item.attachments&&item.attachments.length>0?__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_21__Upload_attachment__["a" /* default */],{attachments:item.attachments,showNotification:_this2.props.showNotification,canDelete:current_user&&(current_user.admin||current_user.login===item.user_login)}):""),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{style:{display:isedit&&isedit===item.id?"block":"none"}},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(TextArea,{style:{height:"200px"},value:_this2.state.countvalue,onChange:_this2.changmodelname}),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('p',{className:'clearfix mt15'},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('a',{className:'topWrapper_btn fr',type:'submit',onClick:function onClick(){return _this2.updatedetail(item.id);}},'\u4FDD\u5B58'),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('a',{className:'a_btn cancel_btn fr',type:'submit',onClick:function onClick(){return _this2.editdetail(item.content,undefined);}},'\u53D6\u6D88')))),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{style:{display:_this2.state.display}},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{className:'div_line'})))),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{className:'order_line',style:{marginLeft:80}}));}));}};return __WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{className:'main'},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{className:'topWrapper'},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_17__Nav__["a" /* default */],Object.assign({},this.props,this.state)),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_15_react_router_dom__["b" /* Link */],{to:'/projects/'+projectsId+'/orders/new',className:'topWrapper_btn'},'\u521B\u5EFA\u5DE5\u5355')),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',null,__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{className:'detailContent'},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('p',null,data?__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',{className:'font-20'},'\u3010',data.issue_classify==="issue"?data.tracker:"合并请求",'\u3011'):"",__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',{className:'font-20'},' ',data&&data.subject)),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('p',{className:'mt10 color-grey-c'},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',{className:data&&data.issue_status==="关闭"?"closedetail":"opendetail"},data&&data.issue_status==="关闭"?"关闭中":"开启中",' '),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',{className:'ml10 lineH32'},'\u7531 ',data&&data.author_name,' \u4E8E ',data&&data.created_at,'\u521B\u5EFA',data&&data.journals_count&&data.journals_count>0?' \xB7 '+data.journals_count+' \u6761\u8BC4\u8BBA':""),data&&data.user_permission?__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',{className:'pull-right lineH32'},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('a',{className:'color-blue fr',onClick:this.copydetail},'\u590D\u5236'),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_popconfirm___default.a,{placement:'bottom',title:'您确定要删除吗',okText:'\u662F',cancelText:'\u5426',onConfirm:function onConfirm(){return _this2.deletedetail(orderId);}},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('a',{className:'color-blue fr',style:{marginLeft:20,marginRight:20}},'\u5220\u9664')),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_15_react_router_dom__["b" /* Link */],{to:'/projects/'+projectsId+'/orders/'+orderId+'/updatedetail',className:'color-blue fr'},'\u7F16\u8F91')):""),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{className:'df mt20'},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_15_react_router_dom__["b" /* Link */],{to:''},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('img',{className:'user_img',src:Object(__WEBPACK_IMPORTED_MODULE_19_educoder__["M" /* getImageUrl */])('images/'+(data&&data.author_picture)),alt:''})),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{className:'detail_context'},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{className:'detail_p'},data&&data.description),data&&data.attachments&&data.attachments.length>0?__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_21__Upload_attachment__["a" /* default */],{attachments:data.attachments,showNotification:this.props.showNotification}):""))),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{className:'f-wrap-between mt5',style:{alignItems:"flex-start"}},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{className:'item-list-right'},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_spin___default.a,{spinning:isSpin},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('ul',{className:'ul_width'},renderList())),Paginations,__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{className:'df'},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_15_react_router_dom__["b" /* Link */],{to:''},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('img',{className:'user_img',src:Object(__WEBPACK_IMPORTED_MODULE_19_educoder__["M" /* getImageUrl */])('images/'+(current_user&&current_user.image_url)),alt:''})),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{className:'new_context'},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_form___default.a.Item,null,getFieldDecorator('content',{rules:[{required:true,message:'请输入内容'}]})(__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(TextArea,{placeholder:'\u6DFB\u52A0\u8BC4\u8BBA...',style:{height:"200px"}}))),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_18__Upload_Index__["a" /* default */],{load:this.UploadFunc,isComplete:showFiles,changeIsComplete:this.changeIsComplete}),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('p',{className:'clearfix mt15'},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('a',{className:'topWrapper_btn fr',type:'submit',onClick:this.addjournals},'\u8BC4\u8BBA'),data&&data.user_permission?__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('a',{className:'Closeor_btn fr',type:'submit',onClick:function onClick(){return _this2.closedetail(data&&data.issue_status==="关闭"?2:5);}},data&&data.issue_status==="关闭"?"重新开启":"关闭"):"")))),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{className:'list-left DetailRight mt10'},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('p',null,__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',{className:'span_title'},'\u5206\u652F'),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',null,data&&data.branch_name?data.branch_name:"--")),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('p',null,__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',{className:'span_title'},'\u6807\u7B7E'),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',null,data&&data.issue_tags?__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',{className:'issue-tag-show',style:{background:data.issue_tags[0].color}},data.issue_tags[0].name):"--")),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('p',null,__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',{className:'span_title'},'\u91CC\u7A0B\u7891'),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',null,data&&data.version?data.version:"--")),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('p',null,__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',{className:'span_title'},'\u5F53\u524D\u72B6\u6001'),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',null,data&&data.issue_status?data.issue_status:"--")),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('p',null,__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',{className:'span_title'},'\u5206\u7C7B'),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',null,data&&data.tracker?data.tracker:"--")),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('p',null,__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',{className:'span_title'},'\u6307\u6D3E\u7ED9'),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',null,data&&data.assign_user_name?data.assign_user_name:"--")),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('p',null,__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',{className:'span_title'},'\u4F18\u5148\u7EA7'),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',null,data&&data.priority?data.priority:"--")),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('p',null,__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',{className:'span_title'},'\u5B8C\u6210\u5EA6'),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',null,data&&data.done_ratio?data.done_ratio:"--"))))),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_modal___default.a,{onCancel:this.handleCancel,visible:this.state.isShow,width:'400px',footer:[],bodyStyle:{textAlign:'center'}},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('img',{className:'list_img',src:'https://ss1.bdstatic.com/70cFuXSh_Q1YnxGkpoWK1HF6hhy/it/u=1608431072,669449145&fm=27&gp=0.jpg',alt:''})));}}]);return Detail;}(__WEBPACK_IMPORTED_MODULE_14_react__["Component"]);var WrappedDetailForm=__WEBPACK_IMPORTED_MODULE_3_antd_lib_form___default.a.create({name:'DetailOrderForm'})(Detail);/* harmony default export */ __webpack_exports__["default"] = (WrappedDetailForm);
