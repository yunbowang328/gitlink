...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__questionbanks_css__ = __webpack_require__(1838);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_educoder__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__groupjobbank_GroupPackage__ = __webpack_require__(2052);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__completetopicde_css__ = __webpack_require__(5043);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__common_components_attachment_AttachmentList__ = __webpack_require__(372);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__courses_coursesPublic_NoneData__ = __webpack_require__(336);
...
// load the styles
var content = __webpack_require__(5044);
if(typeof content === 'string') content = [[module.i, content, '']];
// Prepare cssTransformation
var transform;
...
// module
exports.push([module.i, ".yslquestionbank1{padding-top:30px!important;padding-right:30px!important;padding-left:30px!important;min-height:500px!important}.yslquesHeigth{width:100%!important}.yslquesmarkdowntext{font-size:16px;color:#707070}.yslquesmat26{margin-top:26px;padding-bottom:33px!important}.ysltextcolor9999{color:#999;font-size:14px}.ysltextcolor66{color:#666;font-size:14px}.ysltextcolor05{color:#05101a;font-size:14px}.ml47text{margin-left:17px;padding-bottom:37px}.ysltextcolor99999{color:#999;font-size:16px}.yslboomdivs{display:-ms-flexbox;display:flex;-ms-flex-pack:start;justify-content:flex-start}.yslboomdivs p{width:282px}.yslboomdivs p span{text-align:left}.yslboomdivsy{color:#999;font-size:14px}.yslboomdivsys{color:#666;font-size:14px}.mb29px{padding-top:14px!important;margin-bottom:29px!important}.pd30{margin-bottom:30px}", "", {"version":3,"sources":["/Users/hs/forgeplus-react/src/modules/courses/comtopicdetails/completetopicde.css"],"names":[],"mappings":"AAAA,kBACI,2BAA6B,AAC7B,6BAA+B,AAC/B,4BAA8B,AAC9B,0BAA6B,CAChC,AACD,eACI,oBAAuB,CAC1B,AACD,qBACI,eAAgB,AAChB,aAAe,CAElB,AACD,cACI,gBAAiB,AACjB,6BAAgC,CACnC,AACD,kBACI,WAAe,AACf,cAAgB,CACnB,AACD,gBACI,WAAe,AACf,cAAgB,CACnB,AACD,gBACI,cAAe,AACf,cAAgB,CACnB,AACD,UACI,iBAAkB,AAClB,mBAAqB,CACxB,AACD,mBACI,WAAe,AACf,cAAgB,CACnB,AACD,aAEI,oBAAqB,AAErB,aAAc,AACd,oBAAoB,AAChB,0BAA2B,CAClC,AACD,eACI,WAAa,CAChB,AACD,oBACC,eAAiB,CACjB,AACD,cACI,WAAe,AACf,cAAgB,CAEnB,AACD,eACI,WAAe,AACf,cAAgB,CACnB,AACD,QACI,2BAA6B,AAC7B,4BAA+B,CAClC,AACD,MACI,kBAAoB,CACvB","file":"completetopicde.css","sourcesContent":[".yslquestionbank1{\n    padding-top: 30px !important;\n    padding-right: 30px !important;\n    padding-left: 30px !important;\n    min-height: 500px !important;\n}\n.yslquesHeigth{\n    width: 100% !important;\n}\n.yslquesmarkdowntext{\n    font-size: 16px;\n    color: #707070;\n\n}\n.yslquesmat26{\n    margin-top: 26px;\n    padding-bottom: 33px !important;\n}\n.ysltextcolor9999{\n    color: #999999;\n    font-size: 14px;\n}\n.ysltextcolor66{\n    color: #666666;\n    font-size: 14px;\n}\n.ysltextcolor05{\n    color: #05101A;\n    font-size: 14px;\n}\n.ml47text{\n    margin-left: 17px;\n    padding-bottom: 37px;\n}\n.ysltextcolor99999{\n    color: #999999;\n    font-size: 16px;\n}\n.yslboomdivs{\n\n    display: -ms-flexbox;\n\n    display: flex;\n    -ms-flex-pack:start;\n        justify-content:flex-start;\n}\n.yslboomdivs p{\n    width: 282px;\n}\n.yslboomdivs p span  {\n text-align: left;\n}\n.yslboomdivsy{\n    color: #999999;\n    font-size: 14px;\n\n}\n.yslboomdivsys{\n    color: #666666;\n    font-size: 14px;\n}\n.mb29px{\n    padding-top: 14px !important;\n    margin-bottom: 29px !important;\n}\n.pd30{\n    margin-bottom: 30px;\n}"],"sourceRoot":""}]);
