...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_antd_lib_form_style_css__ = __webpack_require__(952);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_antd_lib_form__ = __webpack_require__(953);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_antd_lib_modal_style_css__ = __webpack_require__(27);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_antd_lib_modal__ = __webpack_require__(28);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_antd_lib_checkbox_style_css__ = __webpack_require__(307);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_antd_lib_checkbox__ = __webpack_require__(304);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_antd_lib_input_style_css__ = __webpack_require__(57);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_antd_lib_input__ = __webpack_require__(58);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__tpm_challengesnew_TPMMDEditor__ = __webpack_require__(319);
...
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var Search=__WEBPACK_IMPORTED_MODULE_15_antd_lib_input___default.a.Search;var CheckboxGroup=__WEBPACK_IMPORTED_MODULE_13_antd_lib_checkbox___default.a.Group;var GraduationTasksnewtype=true;var GraduationTasksSubmitnew=function(_Component){_inherits(GraduationTasksSubmitnew,_Component);function GraduationTasksSubmitnew(props){_classCallCheck(this,GraduationTasksSubmitnew);var _this=_possibleConstructorReturn(this,(GraduationTasksSubmitnew.__proto__||Object.getPrototypeOf(GraduationTasksSubmitnew)).call(this,props));_this.setedit=function(workId){var coursesId=_this.props.match.params.coursesId;window.location.href="/courses/"+coursesId+"/graduation_tasks/"+workId+"/appraise";};_this.handleSubmit=function(e){var _this$state=_this.state,fileList=_this$state.fileList,selectmemberslist=_this$state.selectmemberslist,workslist=_this$state.workslist;_this.Commoninterface(fileList,selectmemberslist,workslist);};_this.handleSelectChange=function(value){console.log(value);_this.props.form.setFieldsValue({note:"Hi, "+(value==='male'?'man':'lady')+"!"});};_this.goback=function(){// let courseId=this.props.match.params.coursesId;
// if(courseId===undefined){
// 	this.props.history.push("/courses");
// }else{
// 	this.props.history.push(this.props.current_user.first_category_url);
// }
_this.props.history.replace("/courses/"+_this.state.workslist.course_id+"/graduation_tasks/"+_this.state.workslist.graduation_id);};_this.changeTitle=function(e){_this.setState({title_num:20-parseInt(e.target.value.length),title_value:e.target.value});};_this.handleChange=function(info){if(info.file.status==='uploading'){var fileList=info.fileList;_this.setState({fileList:Object(__WEBPACK_IMPORTED_MODULE_19_educoder__["C" /* appendFileSizeToUploadFileAll */])(fileList)});}if(info.file.status==='done'||info.file.status==='removed'){var _fileList=info.fileList;_this.setState({fileList:Object(__WEBPACK_IMPORTED_MODULE_19_educoder__["C" /* appendFileSizeToUploadFileAll */])(_fileList)});}};_this.onAttachmentRemove=function(file){// confirm({
//   title: '确定要删除这个附件吗?',
//   okText: '确定',
//   cancelText: '取消',
...
// });
// return false;
if(!file.percent||file.percent==100){_this.setState({Modalstype:true,Modalstopval:'确定要删除这个附件吗?',ModalSave:function ModalSave(){return _this.deleteAttachment(file);},ModalCancel:_this.cancelAttachment});return false;}};_this.cancelAttachment=function(){_this.setState({Modalstype:false,Modalstopval:'',ModalSave:"",ModalCancel:""});};_this.deleteAttachment=function(file){if(!file.percent||file.percent==100){var id=file.response==undefined?file.id:file.response.id;var url="/attachments/"+id+".json";__WEBPACK_IMPORTED_MODULE_20_axios___default.a.delete(url,{}).then(function(response){if(response.data){// const { status } = response.data;
if(response.data.status===0){console.log('--- success');// this.setState({
// 	Modalstype: true,
// 	Modalstopval: response.data.message,
// 	ModalSave: this.cancelAttachment,
// 	Loadtype: true,
// })
_this.cancelAttachment();_this.setState(function(state){var index=state.fileList.indexOf(file);var newFileList=state.fileList.slice();newFileList.splice(index,1);return{fileList:newFileList};});}}}).catch(function(error){console.log(error);});}};_this.inputSearchValue=function(e){if(e.target.value===""){_this.setState({search:null});}else{_this.setState({search:e.target.value});}};_this.searchValue=function(){var search=_this.state.search;_this.searchList(search,1,20);};_this.searchList=function(search,page,limit,types){var id=_this.props.match.params.task_Id;var memberslist=_this.state.memberslist;var newmemberslist=memberslist;var url="/graduation_tasks/"+id+"/graduation_works/search_member_list.json";__WEBPACK_IMPORTED_MODULE_20_axios___default.a.post(url,{search:search,page:page,limit:15}).then(function(result){if(result){if(result.data.status!=403){if(types===1){if(result.data.members.length>0){result.data.members.map(function(item,key){newmemberslist.push(item);});}_this.setState({memberslist:newmemberslist,search:search,page:page,limit:limit});}else{_this.setState({memberslist:result.data.members,search:search,page:page,limit:limit});}}}}).catch(function(error){console.log(error);});};_this.contentViewScroll=function(e){//滑动到底判断
var memberslist=_this.state.memberslist;var newscrollTop=parseInt(e.currentTarget.scrollTop);var allclientHeight=e.currentTarget.clientHeight+newscrollTop;if(e.currentTarget.scrollHeight-allclientHeight===0||e.currentTarget.scrollHeight-allclientHeight===1||e.currentTarget.scrollHeight-allclientHeight===-1){if(memberslist.length===0){return;}else{var _this$state2=_this.state,search=_this$state2.search,page=_this$state2.page,limit=_this$state2.limit;var newpage=page+1;_this.searchList(search,newpage,limit,1);}}};_this.funtaskstatus=function(checkedValues){var _this$state3=_this.state,memberslist=_this$state3.memberslist,selectobjct=_this$state3.selectobjct,workslist=_this$state3.workslist;if(selectobjct.length>workslist.max_num){_this.setState({minvalue:workslist.max_num,setvalue:"大于",minmaxtype:true});return;}else{_this.setState({minmaxtype:false});}var newlist=memberslist;var newcheckedValues=checkedValues;var selects=[];selects.push(selectobjct);for(var i=0;i<newlist.length;i++){for(var z=0;z<newcheckedValues.length;z++){if(newlist[i].user_id===newcheckedValues[z]){selects.push(newlist[i]);}}}_this.setState({task_status:checkedValues,selectmemberslist:selects});};_this.delecttask_status=function(id){var _this$state4=_this.state,selectmemberslist=_this$state4.selectmemberslist,task_status=_this$state4.task_status;var newlist=task_status;var selects=selectmemberslist;for(var i=0;i<newlist.length;i++){if(newlist[i]===id){newlist.splice(i,1);}}for(var z=0;z<selects.length;z++){if(selects[z].user_id===id){selects.splice(z,1);}}_this.setState({task_status:newlist,selectmemberslist:selects});};_this.onSearchKeywordKeyUp=function(e){if(e.keyCode===13){}};_this.onSearckeyd=function(e){if(e.keyCode){var search=_this.state.search;_this.searchList(search,1,20);}};_this.onSearchKeywordKeyUps=function(e){if(e.keyCode===13){}};_this.onKeywordSearchKeyDown=function(e){if(e.keyCode==13){return false;}};_this.Commoninterface=function(fileList,selectmemberslist,workslist){// debugger
var userids=[];if(selectmemberslist!=undefined&&selectmemberslist.length>0){var _iteratorNormalCompletion=true;var _didIteratorError=false;var _iteratorError=undefined;try{for(var _iterator=selectmemberslist[Symbol.iterator](),_step;!(_iteratorNormalCompletion=(_step=_iterator.next()).done);_iteratorNormalCompletion=true){var list=_step.value;if(list.user_id!=undefined&&list.user_id!=null){userids.push(list.user_id);}}}catch(err){_didIteratorError=true;_iteratorError=err;}finally{try{if(!_iteratorNormalCompletion&&_iterator.return){_iterator.return();}}finally{if(_didIteratorError){throw _iteratorError;}}}}if(workslist.task_type===1){userids=undefined;}var listid=[];if(fileList!=undefined&&fileList.length>0){var _iteratorNormalCompletion2=true;var _didIteratorError2=false;var _iteratorError2=undefined;try{for(var _iterator2=fileList[Symbol.iterator](),_step2;!(_iteratorNormalCompletion2=(_step2=_iterator2.next()).done);_iteratorNormalCompletion2=true){var list=_step2.value;listid.push(list.response.id);}}catch(err){_didIteratorError2=true;_iteratorError2=err;}finally{try{if(!_iteratorNormalCompletion2&&_iterator2.return){_iterator2.return();}}finally{if(_didIteratorError2){throw _iteratorError2;}}}}// if( GraduationTasksnewtype===true){
_this.props.form.validateFields(function(err,values){// console.log(fileList);
if(values.description===undefined||values.description===""){_this.scrollToAnchor("valuestypes");// debugger
return;}if(workslist&&workslist.task_type===2){if(userids!=undefined){if(userids.length<workslist.min_num){_this.setState({minvalue:workslist.min_num,setvalue:"小于",minmaxtype:true});return;}else if(userids.length>workslist.max_num){_this.setState({minvalue:workslist.max_num,setvalue:"大于",minmaxtype:true});return;}}}_this.setState({spinnings:true});var id=_this.props.match.params.task_Id;// if(fileList.length === 0){
// 	this.setState({
// 		shixunsreplace:true,
// 	})
// 	return
// }
var url="/graduation_tasks/"+id+"/graduation_works.json";__WEBPACK_IMPORTED_MODULE_20_axios___default.a.post(url,{description:values.description,attachment_ids:listid,user_ids:userids}).then(function(response){_this.setState({spinnings:false});// /courses/2915/graduation_tasks/1301/appraise
// window.location.href
if(response){if(response.data){if(response.data.work_id){window.location.href="/courses/"+_this.props.match.params.coursesId+"/graduation_tasks/"+response.data.work_id+"/appraise";}}}// console.log(this.props);
...
// }
// }
}).catch(function(error){_this.setState({spinnings:false});console.log(error);});});// }
};_this.hidestartshixunsreplace=function(){// debugger
var _this$state5=_this.state,fileList=_this$state5.fileList,selectmemberslist=_this$state5.selectmemberslist,workslist=_this$state5.workslist;_this.Commoninterface(fileList,selectmemberslist,workslist);};_this.hidestartshixunsreplacetwo=function(){_this.setState({shixunsreplace:false,spinnings:false});};_this.scrollToAnchor=function(anchorName){if(anchorName){// 找到锚点
var anchorElement=document.getElementById(anchorName);// 如果对应id的锚点存在，就跳转到锚点
if(anchorElement){anchorElement.scrollIntoView({block:'start',behavior:'smooth'});}}};_this.state={coursename:"",coursesearch:"",title_num:20,title_value:"",fileList:[],contents:[{val:"",id:1}],type:true,workslist:undefined,search:"",memberslist:undefined,task_status:[],selectmemberslist:[],minvalue:"",setvalue:"",minmaxtype:false,selectobjct:undefined,Loadtype:false,spinnings:false,shixunsreplace:false,limit:20};return _this;}_createClass(GraduationTasksSubmitnew,[{key:"componentDidMount",value:function componentDidMount(){var _this2=this;var id=this.props.match.params.task_Id;// let categoryid=this.props.match.params.category_id;
var url="/graduation_tasks/"+id+"/graduation_works/new.json";__WEBPACK_IMPORTED_MODULE_20_axios___default.a.get(url).then(function(result){if(result.status===200){var list=[];var listobjct={group_name:result.data.group_name,student_id:result.data.user_student_id,user_id:result.data.user_id,user_name:result.data.user_name};list.push(listobjct);if(result.data.task_type===1){}else{_this2.searchList("",1,20);}_this2.setState({workslist:result.data,selectmemberslist:list,selectobjct:listobjct});}}).catch(function(error){console.log(error);});}// 输入title
// 附件相关 START
//公用数据
//确认
//取消
},{key:"render",value:function render(){var _this3=this;var getFieldDecorator=this.props.form.getFieldDecorator;var _state=this.state,search=_state.search,fileList=_state.fileList,workslist=_state.workslist,setvalue=_state.setvalue,minvalue=_state.minvalue,minmaxtype=_state.minmaxtype,Loadtype=_state.Loadtype,Modalstype=_state.Modalstype,Modalstopval=_state.Modalstopval,ModalCancel=_state.ModalCancel,ModalSave=_state.ModalSave,memberslist=_state.memberslist,task_status=_state.task_status,selectmemberslist=_state.selectmemberslist,shixunsreplace=_state.shixunsreplace;var courseId=this.props.match.params.coursesId;var category_id=this.props.match.params.category_id;var task_Id=this.props.match.params.task_Id;var uploadProps={width:600,fileList:fileList,multiple:true,// https://github.com/ant-design/ant-design/issues/15505
// showUploadList={false}，然后外部拿到 fileList 数组自行渲染列表。
// showUploadList: false,
action:""+Object(__WEBPACK_IMPORTED_MODULE_19_educoder__["R" /* getUploadActionUrl */])(),onChange:this.handleChange,onRemove:this.onAttachmentRemove,beforeUpload:function beforeUpload(file){// TODO 文件存在则提示并退出
var gotSameFile=false;_this3.state.fileList&&_this3.state.fileList.some(function(item){if(item.name&&item.name.startsWith(file.name)){gotSameFile=true;return true;}});if(gotSameFile){_this3.props.showNotification("该附件已被上传！");return false;}console.log('beforeUpload',file.name);var isLt150M=file.size/1024/1024<150;if(!isLt150M){_this3.props.showNotification('文件大小必须小于150MB!');}return isLt150M;}};// console.log(this.props)
document.title=workslist&&workslist.course_name;return __WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_16_react___default.a.Fragment,null,__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",null,__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_spin___default.a,{size:"large",spinning:this.state.spinnings},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_21__modals_Modals__["a" /* default */],{modalsType:Modalstype,modalsTopval:Modalstopval,modalCancel:ModalCancel,modalSave:ModalSave,loadtype:Loadtype}),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11_antd_lib_modal___default.a,{keyboard:false,title:"\u63D0\u793A",visible:shixunsreplace,closable:false,footer:null},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{className:"task-popup-content"},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("p",{className:"task-popup-text-center font-16 "},"\u8FD8\u672A\u4E0A\u4F20\u9644\u4EF6"),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("p",{className:"task-popup-text-center font-16 pb20"},"\u662F\u5426\u786E\u8BA4\u63D0\u4EA4\u4F5C\u54C1?")),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{className:"task-popup-submit clearfix"},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("a",{className:"task-btn task-btn-orange fr ",onClick:function onClick(){return _this3.hidestartshixunsreplace();}},"\u786E\u8BA4"),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("a",{className:"task-btn fr mr50",onClick:function onClick(){return _this3.hidestartshixunsreplacetwo();}},"\u53D6\u6D88"))),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{className:"newMain clearfix"},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{className:"educontent mb20"},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("p",{className:"clearfix mt10"},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_19_educoder__["A" /* WordsBtn */],{style:"grey",className:"fl"}," ",__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("a",{onClick:this.goback,className:"color-grey-6"},"\u6BD5\u8BBE\u4EFB\u52A1")),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("span",{className:"color-grey-9 fl ml3 mr3"},">"),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_19_educoder__["A" /* WordsBtn */],{style:"grey",className:"fl"}," ",__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_17_react_router_dom__["b" /* Link */],{to:"/courses/"+courseId+"/graduation_tasks/"+category_id+"/detail/"+task_Id+"/list",className:"color-grey-6"},"\u4EFB\u52A1\u8BE6\u60C5")),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("span",{className:"color-grey-9 fl ml3 mr3"},">"),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("span",null,this.props.current_user&&this.props.current_user.real_name," \u63D0\u4EA4\u4F5C\u54C1")),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{style:{width:'100%',height:'75px'}},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("p",{className:" fl color-black mt25 summaryname"},workslist&&workslist.task_name),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("a",{className:"color-grey-6 fr font-16 ml30 mt10 mr20",onClick:this.goback},"\u8FD4\u56DE")),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{className:"stud-class-set pd20 coursenavbox edu-back-white",id:"valuestypes"},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("style",null,"\n                .uploadBtn.ant-btn {\n                  border: none;\n                  color: #4CACFF;\n                  box-shadow: none;\n                  background: transparent;\n                  padding: 0 6px;\n                }\n                .ant-upload-list-item:hover .ant-upload-list-item-info{\n                  background-color:#fff;\n                }\n                .upload_1 .ant-upload-list {\n                  width: 350px;\n                }\n              "),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{label:"\u5185\u5BB9",className:"contentbox mdInForm"},getFieldDecorator('description',{rules:[{required:true,message:'请在此输入作品内容或附件的简要描述'},{max:5000,message:'最大限制为5000个字符'}]})(__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_18__tpm_challengesnew_TPMMDEditor__["a" /* default */],{ref:this.mdRef,placeholder:'请在此输入作品内容或附件的简要描述，最大限制5000个字符',maxLent:"5000",mdID:'courseMessageMD',initValue:this.editTopic?this.editTopic.content:'',className:"courseMessageMD"}))),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_upload___default.a,Object.assign({},uploadProps,{className:"upload_1"}),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_button___default.a,{className:"uploadBtn"},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_icon___default.a,{type:"upload"})," \u4E0A\u4F20\u9644\u4EF6"),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("span",{className:"color-grey-9"},"(\u5355\u4E2A\u6587\u4EF6150M\u4EE5\u5185)"))),workslist&&workslist.task_type===1?"":__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{className:"stud-class-set pd20 coursenavbox edu-back-white",style:{borderTop:'0.5px solid #ccc'}},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{label:"\u5C0F\u7EC4\u6210\u5458"},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",null,__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{className:"fl ml20"},"\u6210\u5458\u8981\u6C42\uFF1A",workslist&&workslist.min_num,"\uFF5E",workslist&&workslist.max_num,"\u4EBA"),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("input",{type:"text",style:{width:"0px",height:"0px",display:"none"},onKeyUp:function onKeyUp(e){return _this3.onSearchKeywordKeyUp(e);},onkeydown:function onkeydown(e){return _this3.onSearchKeywordKeyUps(e);}}),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(Search,{style:{width:"0px",height:"0px",display:"none"},onKeyUp:function onKeyUp(e){return _this3.onSearchKeywordKeyUp(e);},onkeydown:function onkeydown(e){return _this3.onSearchKeywordKeyUps(e);},onPressEnter:this.onKeywordSearchKeyDown,autoComplete:"off"}),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(Search,{className:"fl mt5 ml20",style:{width:"270px"},placeholder:"\u8BF7\u8F93\u5165\u59D3\u540D\u6216\u5B66\u53F7\u641C\u7D22",id:"subject_search_input",value:search,onInput:this.inputSearchValue,onSearch:this.searchValue,onPressEnter:this.onKeywordSearchKeyDown,onKeyUp:function onKeyUp(e){return _this3.onSearckeyd(e);},autoComplete:"off"}),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("input",{type:"text",style:{display:"none",height:0,width:0,border:"none"}}))),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("style",null,"\n               .fonthidden{\n                    overflow:hidden;\n                    text-overflow:ellipsis;\n                    white-space:nowrap\n                }\n                .width100{\n                    width: 100px;\n    \t\t\t\t\t\t\t\theight: 24px;\n                }\n                img.edu-nodata-img {\n\t\t\t\t\t\t\t\t\t\twidth: 200px;\n\t\t\t\t\t\t\t\t\t\tmargin: 50px 90px 20px;\n\t\t\t\t\t\t\t\t\t\tdisplay: block;\n\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t\t.autos{\n\t\t\t\t\t\t\t\t\t\t overflow: auto;\n\t\t\t\t\t\t\t\t}\n              "),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{className:"ml20",style:{width:"100%"}},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{className:"members fl autos",style:{paddingLeft:'9px'},onScroll:this.contentViewScroll},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(CheckboxGroup,{value:task_status,onChange:this.funtaskstatus,style:{paddingTop:'4px'}},memberslist===undefined?"":memberslist.length===0?__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{className:"square-list clearfix"},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{className:"edu-tab-con-box clearfix edu-txt-center"},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("img",{className:"edu-nodata-img mb20",src:Object(__WEBPACK_IMPORTED_MODULE_19_educoder__["M" /* getImageUrl */])("images/educoder/nodata.png")}),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("p",{className:"edu-nodata-p mb20"},"\u672A\u627E\u5230\u8BE5\u5B66\u751F"))):memberslist&&memberslist.map(function(item,key){return __WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{key:key,style:{width:'375px',height:'30px'}},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13_antd_lib_checkbox___default.a,{value:item.user_id,key:item.user_id,checked:task_status.map(function(item,key){return parseInt(task_status[key])===item.user_id?true:false;}),disabled:item.commit_status===true?true:false,className:"fl "}),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{className:"fl ml5 fonthidden width100",title:item.user_name},item.user_name),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{className:"fl ml5 fonthidden width100 color-grey-9",title:item.group_name},item.group_name),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{className:"fl ml5 color-grey-9 fonthidden width100",title:item.student_id},item.student_id),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{className:"fl ml20"},item.commit_status===true?__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("span",{className:"color-orange"},"\u5DF2\u63D0\u4EA4"):""));}))),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{className:"youjiangboxs"},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("i",{className:"iconfont icon-youjiang fl ml20 mr20"})),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("style",null,"\n               .fonthidden{\n                    overflow:hidden;\n                    text-overflow:ellipsis;\n                    white-space:nowrap\n                }\n              "),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{className:"members fl autos"},selectmemberslist&&selectmemberslist.map(function(item,key){if(item.group_name!=undefined){return __WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{key:key,style:{width:'375px',height:'30px',display:item.user_name===undefined?"none":""}},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{className:"fl ml5 fonthidden width100",title:item.user_name},item.user_name),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{className:"fl ml5 fonthidden width100 color-grey-9"},item.group_name),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{className:"fl ml5 color-grey-9 fonthidden width100"},item.student_id),key>0?__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{className:"fr ml20"},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("i",{className:"iconfont icon-shanchudiao fl  color-grey-9 ",style:{marginTop:'-4px'},onClick:function onClick(){return _this3.delecttask_status(item.user_id);}})):"");}})),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{className:"both"}),minmaxtype===true?__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("span",{className:"color-red mt20"},"\u4EBA\u6570\u4E0D\u80FD",setvalue+minvalue,"\u4E2A\u4EBA"):"")),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,null,__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("div",{className:"clearfix mt30 mb30"},__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_button___default.a,{type:"primary",onClick:this.handleSubmit,className:"defalutSubmitbtn fl mr20"},"\u63D0\u4EA4"),__WEBPACK_IMPORTED_MODULE_16_react___default.a.createElement("a",{onClick:this.goback,className:"defalutCancelbtn fl"},"\u53D6\u6D88"))))))));}}]);return GraduationTasksSubmitnew;}(__WEBPACK_IMPORTED_MODULE_16_react__["Component"]);var GraduationTasksSubmitnewApp=__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.create({name:'coursesNew'})(GraduationTasksSubmitnew);/* harmony default export */ __webpack_exports__["default"] = (GraduationTasksSubmitnewApp);
