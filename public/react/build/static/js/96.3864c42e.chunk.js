...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_antd_lib_divider_style_css__ = __webpack_require__(1324);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_antd_lib_divider__ = __webpack_require__(1325);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__Upload_Index__ = __webpack_require__(1739);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__Order_order_css__ = __webpack_require__(1402);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__Order_order_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_15__Order_order_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__version_css__ = __webpack_require__(3072);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__version_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_16__version_css__);
...
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var Option=__WEBPACK_IMPORTED_MODULE_11_antd_lib_select___default.a.Option;var TextArea=__WEBPACK_IMPORTED_MODULE_9_antd_lib_input___default.a.TextArea;var NewVersion=function(_Component){_inherits(NewVersion,_Component);function NewVersion(props){_classCallCheck(this,NewVersion);var _this=_possibleConstructorReturn(this,(NewVersion.__proto__||Object.getPrototypeOf(NewVersion)).call(this,props));_this.componentDidMount=function(){_this.getSelectList();};_this.getSelectList=function(){var _this$props$match$par=_this.props.match.params,projectsId=_this$props$match$par.projectsId,versionId=_this$props$match$par.versionId;var url='/projects/'+projectsId+'/version_releases/'+versionId+'/edit.json';__WEBPACK_IMPORTED_MODULE_17_axios___default.a.get(url).then(function(result){if(result){_this.setState({data:result.data,pull:result.data.target_commitish});}}).catch(function(error){console.log(error);});};_this.deleteversion=function(){var _this$props$match$par2=_this.props.match.params,projectsId=_this$props$match$par2.projectsId,versionId=_this$props$match$par2.versionId;var url='/projects/'+projectsId+'/version_releases/'+versionId+'.json';__WEBPACK_IMPORTED_MODULE_17_axios___default.a.delete(url,{data:{project_id:projectsId,id:versionId}}).then(function(result){if(result){_this.props.history.push('/projects/'+projectsId+'/version');}}).catch(function(error){console.log(error);});};_this.handleSubmit=function(){_this.props.form.validateFieldsAndScroll(function(err,values){if(!err){var _this$props$match$par3=_this.props.match.params,projectsId=_this$props$match$par3.projectsId,versionId=_this$props$match$par3.versionId;var _this$state=_this.state,pull=_this$state.pull,ischeck=_this$state.ischeck;var url='/projects/'+projectsId+'/version_releases/'+versionId+'.json';// if(values.issue_type==="普通"){
//   values.issue_type="1"
// }
__WEBPACK_IMPORTED_MODULE_17_axios___default.a.put(url,Object.assign({},values,{tag_name:_this.state.data&&_this.state.data.tag_name,draft:false,prerelease:ischeck,target_commitish:pull})).then(function(result){if(result){_this.props.history.push('/projects/'+projectsId+'/version');}}).catch(function(error){console.log(error);});}});};_this.RedieonChange=function(e){_this.setState({ischeck:e.target.checked});};_this.Preservation=function(){alert(_this.state.data.tag_name);};_this.renderMenu=function(array,id){return __WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_menu___default.a,null,array&&array.length>0&&array.map(function(item,key){return __WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_menu___default.a.Item,{key:item,onClick:function onClick(){return _this.getOption(item);}},item);}));};_this.getOption=function(name){_this.setState({pull:name});};_this.changmodelname=function(e){_this.setState({tag_name:e.target.value});};_this.state={branch_name:"",issue_tag_ids:"",fixed_version_id:"",issue_chosen:undefined,fileList:undefined,ischeck:undefined,pull:undefined,tag_name:'',data:undefined};return _this;}//delete
// 创建
_createClass(NewVersion,[{key:'render',value:function render(){var _this2=this;var getFieldDecorator=this.props.form.getFieldDecorator;var projectsId=this.props.match.params.projectsId;return __WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement('div',{className:'main'},__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_form___default.a,null,__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement('h1',{style:{marginLeft:15,marginTop:20}},'\u7F16\u8F91\u7248\u672C'),__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement('h5',{style:{marginLeft:15}},'\u7F16\u8F91\u8FD9\u4E2A\u7279\u5B9A\u7684\u6253\u5305\u597D\u7684\u9879\u76EE\u7248\u672C'),__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_divider___default.a,null),__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement('div',{style:{display:'flex',marginLeft:15}},this.state.data&&this.state.data.tag_name,'@',this.state.data&&this.state.data.target_commitish),__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement('div',{style:{display:'flex'}},__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement('div',{className:'versionmilepostleft'},__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement('h1',null,'\u6807\u9898'),__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement('div',null,__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_form___default.a.Item,null,getFieldDecorator('name',{rules:[{required:true,message:'请输入标题'}],initialValue:this.state.data&&this.state.data.name})(__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_input___default.a,{placeholder:'\u6807\u9898',maxLength:'32'})))),__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement('h1',null,'\u5185\u5BB9'),__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_form___default.a.Item,null,getFieldDecorator('body',{rules:[{required:true,message:'请输入描述内容'}],initialValue:this.state.data&&this.state.data.body})(__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement(TextArea,{placeholder:'\u6DFB\u52A0\u63CF\u8FF0\u5185\u5BB9...',style:{'min-height':"150px"}}))))),__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_divider___default.a,null),__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement('div',{style:{textAlign:"right"}},__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_checkbox___default.a,{onChange:this.RedieonChange},'\u6807\u8BB0\u4E3A\u9884\u884C\u7248',__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement('span',{className:'ml15 color-grey-9 font-13'},'(\u6B64\u7248\u672C\u4E0D\u9002\u5408\u751F\u4EA7\u4F7F\u7528)'))),__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement('div',{className:'clearfix mt15',style:{marginTop:5}},__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement('a',{className:'topWrapper_btn_delete fr',onClick:function onClick(){return _this2.deleteversion();},style:{marginLeft:15}},'\u5220\u9664\u53D1\u5E03'),__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement('a',{className:'topWrapper_btn fr',onClick:function onClick(){return _this2.handleSubmit();},style:{marginRight:15}},'\u53D1\u5E03\u7248\u672C'),__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13_react_router_dom__["b" /* Link */],{to:'/projects/'+projectsId+'/version',style:{marginRight:30},className:'topWrapper_btn fr'},'\u53D6\u6D88'))));}}]);return NewVersion;}(__WEBPACK_IMPORTED_MODULE_12_react__["Component"]);var WrappedNewVersionForm=__WEBPACK_IMPORTED_MODULE_3_antd_lib_form___default.a.create({name:'NewVersionForm'})(NewVersion);/* harmony default export */ __webpack_exports__["default"] = (WrappedNewVersionForm);
