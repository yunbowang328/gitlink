...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__courses_css_Courses_css__ = __webpack_require__(311);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__common_css__ = __webpack_require__(336);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__common_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9__common_css__);
...
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var PHONE='PHONE';var EMAIL='EMAIL';var PASSWORD='PASSWORD';function regPhoneAndEmail(value){if(value.indexOf("@")>-1){// 加密邮箱
var beforeStr=value.split("@")[0];var afterStr=value.split("@")[1];return beforeStr.substr(0,3)+"**"+beforeStr.substr(beforeStr.length-1,1)+"@"+afterStr;}else{// 加密手机号码
return value.substr(0,3)+"****"+value.substr(7,4);}}var AccountSecure=function(_Component){_inherits(AccountSecure,_Component);function AccountSecure(props){_classCallCheck(this,AccountSecure);var _this=_possibleConstructorReturn(this,(AccountSecure.__proto__||Object.getPrototypeOf(AccountSecure)).call(this,props));_this.remainTime=function(){_this.setState({seconds:60});_this.timer=setInterval(function(){var seconds=_this.state.seconds;var s=parseInt(seconds)-1;if(s>-1){_this.setState({seconds:s});}else{_this.setState({secondsFlag:false});clearInterval(_this.timer);}},1000);};_this.getCode=function(index){var url='/accounts/get_verification_code.json';var login='';var values=_this.props.form.getFieldsValue();if(index==3){//绑定手机号码
login=values.phone;var reg=/^1\d{10}$/;if(reg.test(login)==false){_this.props.showNotification('\u8BF7\u5148\u8F93\u5165\u6B63\u786E\u7684\u624B\u673A\u53F7\u7801');return;}}else if(index==4){// 绑定邮箱
login=values.email;var _reg=/^[a-zA-Z0-9]+([.\-_\\]*[a-zA-Z0-9])*@([a-z0-9]+[-a-z0-9]*[a-z0-9]+.){1,63}[a-z0-9]+$/;if(_reg.test(login)==false){_this.props.showNotification('\u8BF7\u5148\u8F93\u5165\u6B63\u786E\u7684\u90AE\u7BB1\u5730\u5740');return;}}var type=index;if(!login){_this.props.showNotification('\u8BF7\u5148\u8F93\u5165'+(index==3?"手机号码":"邮箱地址"));return;}var smscode=Object(__WEBPACK_IMPORTED_MODULE_7_educoder__["_6" /* setmiyah */])(login);__WEBPACK_IMPORTED_MODULE_10_axios___default.a.get(url,{params:{login:login,type:type,smscode:smscode}}).then(function(result){if(result){// 倒计时
if(result.data.status===1){_this.props.showNotification("验证码已发送，请注意查收");}else if(result.data.status===-2){_this.props.showNotification(result.data.message);}_this.setState({secondsFlag:true});_this.remainTime();}}).catch(function(error){console.log(error);});};_this.onPhoneSubmit=function(){_this.props.form.validateFieldsAndScroll(function(err,values){if(!err){var login=_this.props.current_user.login;var reg=/^1\d{10}$/;if(reg.test(values.phone)){var url='/users/accounts/'+login+'/phone_bind.json';__WEBPACK_IMPORTED_MODULE_10_axios___default.a.post(url,{phone:values.phone,code:values.phoneValidateCode}).then(function(result){if(result){_this.props.showNotification("手机号码绑定成功!");_this.setState({updating:''});_this.props.getBasicInfo();}}).catch(function(error){console.log(error);});}else{_this.props.showNotification("请输入有效的11位手机号码");}}});};_this.onEmailSubmit=function(){_this.props.form.validateFieldsAndScroll(function(err,values){if(!err){var login=_this.props.current_user.login;var reg=/^[a-zA-Z0-9]+([.\-_\\]*[a-zA-Z0-9])*@([a-z0-9]+[-a-z0-9]*[a-z0-9]+.){1,63}[a-z0-9]+$/;if(reg.test(values.email)){var url='/users/accounts/'+login+'/email_bind.json';__WEBPACK_IMPORTED_MODULE_10_axios___default.a.post(url,{email:values.email,code:values.emailValidateCode}).then(function(result){if(result){_this.props.showNotification("邮箱地址绑定成功!");_this.setState({updating:''});_this.props.getBasicInfo();}}).catch(function(error){console.log(error);});}else{_this.props.showNotification("请输入正确的邮箱地址");}}});};_this.onPasswordSubmit=function(){var basicInfo=_this.props.basicInfo;_this.props.form.validateFieldsAndScroll(function(err,values){if(!err){if(basicInfo&&basicInfo.has_password===true){if(values.p_old==values.p_new){_this.props.showNotification("新密码不能与旧密码相同！");return;}}if(values.p_again!=values.p_new){_this.props.showNotification("两次输入的新密码必须一致！");return;}var login=_this.props.current_user.login;var url='/users/accounts/'+login+'/password.json';var p_old=undefined;if(basicInfo&&basicInfo.has_password===true){p_old=values.p_old;}__WEBPACK_IMPORTED_MODULE_10_axios___default.a.put(url,{old_password:p_old,password:values.p_new}).then(function(result){if(result){_this.props.showNotification("密码更新成功!");_this.setState({updating:''});_this.props.getBasicInfo();}}).catch(function(error){console.log(error);});}});};_this.hideUpdating=function(){_this.setState({updating:""});};_this.comfirmNewPassword=function(rule,value,callback){var form=_this.props.form;if(value!=form.getFieldsValue().p_new){callback("两次输入的新密码必须一致！");}else{callback();}};_this.InputNewPassword=function(rule,value,callback){var form=_this.props.form;if(!value){callback("请输入8-16位字符的新密码，区分大小写！");}else if(value.length<8||value.length>16){callback("请输入8-16位字符的新密码，区分大小写！");}else{callback();}};_this.state={updating:'',secondsFlag:false,seconds:60};return _this;}// 获取验证码倒计时
// 获取验证码
// 绑定手机
// 绑定邮箱
//取消编辑
// 修改密码-判断规则
_createClass(AccountSecure,[{key:'render',value:function render(){var _this2=this;var basicInfo=this.props.basicInfo;var getFieldDecorator=this.props.form.getFieldDecorator;var _state=this.state,updating=_state.updating,seconds=_state.seconds,secondsFlag=_state.secondsFlag;console.log(basicInfo&&basicInfo.has_password);return __WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('div',null,__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('div',{className:'basicForm settingForm'},__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('style',null,'\n\n            .flexRow {\n              padding: 20px 0;\n            }\n              .flexRow .name {\n                margin-left: 12px;\n                color: #999999;\n\n                text-align: center;\n                flex: 0 0 100px;\n              }\n              .flexRow .description {\n                margin-left: 10px;\n                flex: 1;\n                color: #CDCDCD;\n              }\n                .description span {\n                  margin-right: 20px;\n                  color: #05101A;\n                }\n              .flexRow .status {\n                width: 100px;\n                color: #28AC7F;\n                text-align: right;\n              }\n            .flexTable .flexTable {\n              border-bottom: 1px solid #EBEBEB;\n            }\n            \n\n            .settingForm label{\n              color: #999999;\n              font-size: 14px !important ; \n              margin-left: 120px;\n            }\n            .settingForm input {\n              width: 340px;\n            }\n            .settingForm input.validateInput  {\n              width: 220px;\n            }\n            .settingForm .formItemInline button {\n              width: 110px;\n              margin-left: 10px;\n            }\n\n            .settingForm .ant-form-item-label {\n              width: 204px;\n            }\n            .formItemInline .ant-form-explain{\n              position:absolute;\n              bottom:-17px;\n              left:0px;\n              width:100%;\n            }\n          '),__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('div',{className:'title'},'\u5B89\u5168\u8BBE\u7F6E'),__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_form___default.a,null,__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('div',{className:'flexTable'},__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('div',{className:'flexTable'},__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('div',{className:'flexRow'},__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('div',{className:'name'},'\u624B\u673A'),__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('div',{className:'description'},basicInfo&&basicInfo.phone?__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('span',null,basicInfo.phone):__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('span',{style:{color:'#EA320E'}},'\u672A\u7ED1\u5B9A'),basicInfo.phone?'仅自己可见，可用手机号码登录EduCoder':'绑定手机号码，将获得500金币的奖励哟～，手机号码仅自己可见~'),updating!=PHONE&&__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('div',{className:'status'},__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_educoder__["A" /* WordsBtn */],{style:'blue',className:'borderBottom',onClick:function onClick(){return _this2.setState({updating:PHONE});}},basicInfo&&basicInfo.phone?"更换":"立即绑定"))),updating==PHONE&&__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_6_react___default.a.Fragment,null,__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_form___default.a.Item,{label:'\u4F60\u7684\u624B\u673A\u53F7',className:'formItemInline hideRequireTag mb20'},getFieldDecorator('phone',{rules:[{// initialValue: this.state.cityDefaultValue,
required:true,message:'\u8BF7\u8F93\u5165\u8981'+(basicInfo.phone?'更换':'绑定')+'\u7684\u624B\u673A\u53F7\u7801'}]})(__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_input___default.a,{placeholder:'\u8BF7\u8F93\u5165\u8981'+(basicInfo.phone?'更换':'绑定')+'\u7684\u624B\u673A\u53F7\u7801'}))),__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_form___default.a.Item,{label:'\u624B\u673A\u9A8C\u8BC1\u7801',className:'mb20 formItemInline hideRequireTag'},getFieldDecorator('phoneValidateCode',{rules:[{// initialValue: this.state.cityDefaultValue,
required:true,message:'请输入手机获取的验证码'}]})(__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_input___default.a,{placeholder:'\u8BF7\u8F93\u5165\u624B\u673A\u83B7\u53D6\u7684\u9A8C\u8BC1\u7801',className:'validateInput'})),__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_button___default.a,{type:'primary',disabled:secondsFlag,onClick:function onClick(){return _this2.getCode(3);}},!secondsFlag?"获取验证码":'\u91CD\u65B0\u53D1\u9001'+seconds+'s')),__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('div',{className:'mb20',style:{marginLeft:'204px'}},__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_button___default.a,{type:'primary',onClick:this.onPhoneSubmit},'\u786E\u5B9A'),__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_button___default.a,{type:'primary grayBtn',style:{marginLeft:'20px'},onClick:this.hideUpdating},'\u53D6\u6D88')))),__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('div',{className:'flexTable'},__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('div',{className:'flexRow'},__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('div',{className:'name'},'\u90AE\u7BB1'),__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('div',{className:'description'},basicInfo&&basicInfo.mail?__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('span',null,basicInfo.mail):__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('span',{style:{color:'#EA320E'}},'\u672A\u7ED1\u5B9A'),'\u90AE\u7BB1\u8D26\u53F7\u4EC5\u81EA\u5DF1\u53EF\u89C1\uFF0C\u53EF\u7528\u4E8E\u90AE\u7BB1\u8D26\u53F7\u767B\u5F55EduCoder'),updating!=EMAIL&&__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('div',{className:'status'},__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_educoder__["A" /* WordsBtn */],{style:'blue',className:'borderBottom',onClick:function onClick(){return _this2.setState({updating:EMAIL});}},basicInfo&&basicInfo.mail?"更换":"立即绑定"))),updating==EMAIL&&__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_6_react___default.a.Fragment,null,__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_form___default.a.Item,{label:'\u90AE\u7BB1\u5730\u5740',className:'formItemInline hideRequireTag mb20'},getFieldDecorator('email',{rules:[{// initialValue: this.state.cityDefaultValue,
required:true,message:basicInfo&&basicInfo.mail?'请输入要更换的新邮箱地址':'请输入邮箱地址'}]})(__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_input___default.a,{placeholder:''+(basicInfo&&basicInfo.mail?'请输入要更换的新邮箱地址':'请输入邮箱地址')}))),__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_form___default.a.Item,{label:'\u90AE\u7BB1\u9A8C\u8BC1\u7801',className:'mb20 formItemInline hideRequireTag'},getFieldDecorator('emailValidateCode',{rules:[{// initialValue: this.state.cityDefaultValue,
required:true,message:'请输入邮箱收到的验证码'}]})(__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_input___default.a,{placeholder:'\u8BF7\u8F93\u5165\u90AE\u7BB1\u6536\u5230\u7684\u9A8C\u8BC1\u7801',className:'validateInput'})),__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_button___default.a,{type:'primary',disabled:secondsFlag,onClick:function onClick(){return _this2.getCode(4);}},!secondsFlag?"获取验证码":'\u91CD\u65B0\u53D1\u9001'+seconds+'s')),__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('div',{className:'mb20',style:{marginLeft:'204px'}},__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_button___default.a,{type:'primary',onClick:this.onEmailSubmit},'\u786E\u5B9A'),__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_button___default.a,{type:'primary grayBtn',style:{marginLeft:'20px'},onClick:this.hideUpdating},'\u53D6\u6D88')))),__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('div',{className:'flexTable'},__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('div',{className:'flexRow'},__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('div',{className:'name'},'\u5BC6\u7801'),__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('div',{className:'description'},__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('span',null,'**********'),'\u7528\u4E8E\u4FDD\u62A4\u8D26\u6237\u4FE1\u606F\u548C\u767B\u5F55\u5B89\u5168'),updating!=PASSWORD&&__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('div',{className:'status'},__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_educoder__["A" /* WordsBtn */],{style:'blue',className:'borderBottom',onClick:function onClick(){return _this2.setState({updating:PASSWORD});}},'\u4FEE\u6539'))),updating==PASSWORD&&__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_6_react___default.a.Fragment,null,basicInfo&&basicInfo.has_password===true?__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_form___default.a.Item,{label:'\u65E7\u5BC6\u7801',className:'mb20 formItemInline hideRequireTag'},getFieldDecorator('p_old',{rules:[{// initialValue: this.state.cityDefaultValue,
required:true,message:'请设置8～16位密码，区分大小写'}]})(__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_input___default.a,{type:'password',placeholder:'\u8BF7\u8BBE\u7F6E8\uFF5E16\u4F4D\u5BC6\u7801\uFF0C\u533A\u5206\u5927\u5C0F\u5199',autoComplete:'new-password'}))):"",__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_form___default.a.Item,{label:'\u65B0\u5BC6\u7801',className:'mb20 formItemInline hideRequireTag'},getFieldDecorator('p_new',{rules:[{validator:this.InputNewPassword}]})(__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_input___default.a,{type:'password',placeholder:'\u8BF7\u8F93\u51658\uFF5E16\u4F4D\u7684\u65B0\u5BC6\u7801\uFF0C\u533A\u5206\u5927\u5C0F\u5199',autoComplete:'new-password'}))),__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_form___default.a.Item,{label:'\u518D\u6B21\u8F93\u5165',className:'mb20 formItemInline hideRequireTag'},getFieldDecorator('p_again',{rules:[{// initialValue: this.state.cityDefaultValue,
required:true,message:'请再次输入新密码'},{validator:this.comfirmNewPassword}]})(__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_input___default.a,{type:'password',placeholder:'\u8BF7\u518D\u6B21\u8F93\u5165\u65B0\u5BC6\u7801',autoComplete:'new-password'}))),__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('div',{className:'mb20',style:{marginLeft:'204px'}},__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_button___default.a,{type:'primary',onClick:this.onPasswordSubmit},'\u786E\u5B9A'),__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_button___default.a,{type:'primary grayBtn',style:{marginLeft:'20px'},onClick:this.hideUpdating},'\u53D6\u6D88'))))))),__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('div',{style:{color:'#989898',marginLeft:'20px'}},'* \u6211\u4EEC\u786E\u4FDD\u4F60\u6240\u63D0\u4F9B\u7684\u4FE1\u606F\u5747\u5904\u4E8E\u4E25\u683C\u4FDD\u5BC6\u72B6\u6001\uFF0C\u4E0D\u4F1A\u6CC4\u9732'));}}]);return AccountSecure;}(__WEBPACK_IMPORTED_MODULE_6_react__["Component"]);var WrappedAccountSecure=__WEBPACK_IMPORTED_MODULE_3_antd_lib_form___default.a.create({name:'AccountSecure'})(AccountSecure);/* harmony default export */ __webpack_exports__["default"] = (WrappedAccountSecure);
