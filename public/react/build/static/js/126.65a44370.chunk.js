...
// module
exports.push([module.i, ".branchDropdown{border:1px solid #eee;border-radius:4px;display:-ms-flexbox;display:flex;-ms-flex-pack:center;justify-content:center;height:35px;line-height:35px;min-width:150px;padding:0 15px}.branchDropdown .ant-dropdown-trigger{width:100%;text-align:center}.branchOptions{width:200px;padding:10px;-webkit-box-shadow:0 0 1px 1px hsla(0,0%,53%,.1);box-shadow:0 0 1px 1px hsla(0,0%,53%,.1);border-radius:3px;background:#fff;max-height:300px}.OptionsUl{max-height:200px;overflow-y:auto;margin-top:10px}.OptionsUl li{height:30px;cursor:pointer}.OptionsUl li a{display:block;padding:4px}.OptionsInput{height:32px;padding-left:4px;line-height:32px;width:100%}", "", {"version":3,"sources":["/Users/jasder/work/trustie3.0/forgeplus-react/src/forge/Branch/branch.css"],"names":[],"mappings":"AAAA,gBACE,sBAAsB,AACtB,kBAAmB,AACnB,oBAAqB,AACrB,aAAc,AACd,qBAAsB,AAClB,uBAAwB,AAC5B,YAAa,AACb,iBAAkB,AAClB,gBAAiB,AACjB,cAAiB,CAClB,AACD,sCACE,WAAY,AACZ,iBAAmB,CACpB,AACD,eACE,YAAa,AACb,aAAa,AACb,iDAA6D,AACrD,yCAAqD,AAC7D,kBAAmB,AACnB,gBAAiB,AACjB,gBAAkB,CACnB,AACD,WACE,iBAAkB,AAClB,gBAAiB,AACjB,eAAiB,CAClB,AACD,cACE,YAAa,AAEb,cAAgB,CACjB,AACD,gBACE,cAAe,AACf,WAAa,CAEd,AACD,cACE,YAAa,AACb,iBAAkB,AAClB,iBAAkB,AAClB,UAAY,CACb","file":"branch.css","sourcesContent":[".branchDropdown{\n  border:1px solid #eee;\n  border-radius: 4px;\n  display: -ms-flexbox;\n  display: flex;\n  -ms-flex-pack: center;\n      justify-content: center;\n  height: 35px;\n  line-height: 35px;\n  min-width: 150px;\n  padding:0px 15px;\n}\n.branchDropdown .ant-dropdown-trigger{\n  width: 100%;\n  text-align: center;\n}\n.branchOptions{\n  width: 200px;\n  padding:10px;\n  -webkit-box-shadow: 0px 0px 1px 1px rgba(134, 134, 134, 0.1);\n          box-shadow: 0px 0px 1px 1px rgba(134, 134, 134, 0.1);\n  border-radius: 3px;\n  background: #fff;\n  max-height: 300px;\n}\n.OptionsUl{\n  max-height: 200px;\n  overflow-y: auto;\n  margin-top: 10px;\n}\n.OptionsUl li{\n  height: 30px;\n  /*line-height: 22px;*/\n  cursor: pointer;\n}\n.OptionsUl li a{\n  display: block;\n  padding: 4px;\n  /*padding-left: 2px;*/\n}\n.OptionsInput{\n  height: 32px;\n  padding-left: 4px;\n  line-height: 32px;\n  width: 100%;\n}"],"sourceRoot":""}]);
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = truncateCommitId;
function truncateCommitId(str){if(str.length>11){return str.substring(0,10);}}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_antd_lib_dropdown_style_css__ = __webpack_require__(960);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_antd_lib_dropdown__ = __webpack_require__(956);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_antd_lib_icon_style_css__ = __webpack_require__(178);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__branch_css__ = __webpack_require__(2281);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__branch_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__branch_css__);
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var SelectBranch=function(_Component){_inherits(SelectBranch,_Component);function SelectBranch(props){_classCallCheck(this,SelectBranch);var _this=_possibleConstructorReturn(this,(SelectBranch.__proto__||Object.getPrototypeOf(SelectBranch)).call(this,props));_this.ChangeVisible=function(visible){_this.setState({visible:!visible});};_this.InputClick=function(e){_this.stopPropagations(e);};_this.stopPropagations=function(e){e.stopPropagation();};_this.changeValue=function(e){_this.setState({value:e.target.value});};_this.changeBranch=function(value){var changeBranch=_this.props.changeBranch;_this.setState({visible:false,value:undefined});changeBranch&&changeBranch(value);};_this.state={visible:false,value:undefined};return _this;}_createClass(SelectBranch,[{key:'componentDidMount',value:function componentDidMount(){var _this2=this;document.body.addEventListener('click',function(e){if(e.target&&(e.target.matches('#m-btn')||e.target.matches("#input-btn")||e.target.matches("#ul-btn"))){return;}_this2.setState({visible:false,value:undefined});});}// 输入搜索内容
// 选择分支
},{key:'render',value:function render(){var _this3=this;var _state=this.state,visible=_state.visible,value=_state.value;var _props=this.props,branchs=_props.branchs,branch=_props.branch;var branchsFilter=value?branchs&&branchs.length>0&&branchs.filter(function(item){return item.name.indexOf(value)>-1;}):branchs;var menu=__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'branchOptions',id:'m-btn',onClick:this.stopPropagations},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('input',{placeholder:'\u8BF7\u8F93\u5165\u5206\u652F\u540D\u79F0\u8FDB\u884C\u641C\u7D22',id:'input-btn',value:value,className:'OptionsInput',onChange:this.changeValue,onClick:this.InputClick}),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('ul',{className:'OptionsUl',id:'ul-btn'},branchsFilter&&branchsFilter.map(function(item,key){return __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('li',{key:key},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('a',{className:'task-hide',onClick:function onClick(){return _this3.changeBranch(item.name);}},item.name))// <Menu.Item key={item.index} onClick={(value)=>changeBranch(value)}>{item.name}</Menu.Item>
;})));return __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'branchDropdown f-wrap-alignCenter',onClick:function onClick(){return _this3.ChangeVisible(visible);}},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_dropdown___default.a,{overlay:menu,trigger:['click'],placement:'bottomLeft',visible:visible},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('span',null,__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('span',{className:'color-grey-9 mr3'},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('i',{className:'iconfont icon-fenzhi font-20 color-grey-6 mr3'}),'\u5206\u652F:'),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('a',{className:'ant-dropdown-link'},branch,' ',__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_icon___default.a,{type:'down'})))));}}]);return SelectBranch;}(__WEBPACK_IMPORTED_MODULE_4_react__["Component"]);/* harmony default export */ __webpack_exports__["a"] = (SelectBranch);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__common_util__ = __webpack_require__(3071);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__Branch_SelectBranch__ = __webpack_require__(3487);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__DetailTop__ = __webpack_require__(3069);
