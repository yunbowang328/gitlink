...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__list_css__ = __webpack_require__(2302);
...
var CodeMirror = createReactClass({
	...
	getCodeMirrorInstance: function getCodeMirrorInstance() {
		return this.props.codeMirrorInstance || __webpack_require__(1772);
	},
...
(function(mod) {
  if (true) // CommonJS
    mod(__webpack_require__(1772), __webpack_require__(2349), __webpack_require__(3569));
  else if (typeof define == "function" && define.amd) // AMD
