...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__css_index_css__ = __webpack_require__(2366);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__Branch_branch_css__ = __webpack_require__(2367);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__Branch_branch_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10__Branch_branch_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__activity_css__ = __webpack_require__(3785);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__activity_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11__activity_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__Nodata__ = __webpack_require__(1921);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__ActivityItem__ = __webpack_require__(5005);
...
var Activity=function(_Component){_inherits(Activity,_Component);function Activity(props){_classCallCheck(this,Activity);var _this=_possibleConstructorReturn(this,(Activity.__proto__||Object.getPrototypeOf(Activity)).call(this,props));_this.componentDidMount=function(){var _this$state=_this.state,time=_this$state.time,type=_this$state.type,status=_this$state.status,page=_this$state.page;_this.getInfo(time,type,status,page);};_this.getInfo=function(time,type,status,page){var projectsId=_this.props.match.params.projectsId;var url='/projects/'+projectsId+'/project_trends.json';__WEBPACK_IMPORTED_MODULE_14_axios___default.a.get(url,{params:{time:time,type:type,status:status,page:page}}).then(function(result){if(result){_this.setState({data:result.data,project_trends:result.data.project_trends});}}).catch(function(error){console.log(error);});};_this.changeTime=function(e){_this.setState({time:e.key});var _this$state2=_this.state,type=_this$state2.type,status=_this$state2.status,page=_this$state2.page;_this.getInfo(e.key,type,status,page);};_this.changeTrends=function(type,status){_this.setState({type:type,status:status});var _this$state3=_this.state,time=_this$state3.time,page=_this$state3.page;_this.getInfo(time,type,status,page);};_this.ChangePage=function(page){_this.setState({page:page});var _this$state4=_this.state,time=_this$state4.time,type=_this$state4.type,status=_this$state4.status;_this.getInfo(time,type,status,page);};_this.state={time:'30',type:undefined,state:undefined,page:1,data:undefined,project_trends:undefined};return _this;}// 切换周期
//筛选
// 分页
_createClass(Activity,[{key:'render',value:function render(){var _this2=this;var _state=this.state,time=_state.time,data=_state.data,page=_state.page,project_trends=_state.project_trends;var menu=__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_menu___default.a,null,ARRAY&&ARRAY.map(function(item,key){return __WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_menu___default.a.Item,{key:item.id,onClick:_this2.changeTime},item.name);}));var name=time&&ARRAY.filter(function(item){return item.id===parseInt(time);});// console.log(name);
var second_per=parseInt(data&&data.close_issues_count)/parseInt(data&&data.issues_count)*100+'%';var third_per=parseInt(data&&data.close_issues_count)/parseInt(data&&data.issues_count)*100+'%';var fourth_per=parseInt(data&&data.open_issues_count)/parseInt(data&&data.issues_count)*100+'%';return __WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('div',{className:'main'},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('div',{className:'normalBox'},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('div',{'class':'normalBox-title'},'\u6982\u89C8'),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('div',{className:'orderInfo'},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('div',null,__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('div',{className:'percentLine prPercent'},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('p',{className:'percent_purple',style:{width:'100%'}}),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('p',{className:'percent_green resetStyle',style:{width:''+second_per}})),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('span',null,data&&data.pr_all_count,'\u5408\u5E76\u8BF7\u6C42')),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('div',null,__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('div',{className:'percentLine'},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('p',{className:'percent_red',style:{width:''+third_per}}),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('p',{className:'percent_green',style:{width:''+fourth_per}})),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('span',null,data&&data.issues_count,'\u5DE5\u5355'))),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('ul',{className:'percentBox'},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('li',null,__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('span',{className:'purple'},data&&data.pr_count),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('span',{className:'change',onClick:function onClick(){return _this2.changeTrends("PullRequest","close");}},'\u5DF2\u5408\u5E76\u8BF7\u6C42')),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('li',null,__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('span',{className:'green'},data&&data.new_pr_count),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('span',{className:'change',onClick:function onClick(){return _this2.changeTrends("PullRequest","create");}},'\u65B0\u5408\u5E76\u8BF7\u6C42')),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('li',null,__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('span',{className:'red'},data&&data.close_issues_count),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('span',{className:'change',onClick:function onClick(){return _this2.changeTrends("Issue","close");}},'\u5DF2\u5173\u95ED\u5DE5\u5355')),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('li',null,__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('span',{className:'green'},data&&data.open_issues_count),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('span',{className:'change',onClick:function onClick(){return _this2.changeTrends("Issue","create");}},'\u521B\u5EFA\u7684\u5DE5\u5355')))),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('div',{className:'df trendsTop mt20'},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('div',{className:'branchDropdown f-wrap-alignCenter'},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_dropdown___default.a,{overlay:menu,trigger:['click'],placement:'bottomLeft'},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('a',{className:'ant-dropdown-link'},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('span',{className:'color-grey-9 mr3'},'\u5468\u671F:'),name&&name.length>0&&name[0].name,' ',__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_icon___default.a,{type:'down'}))))),project_trends&&project_trends.length>0?__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('div',{className:'activity_list'},project_trends&&project_trends.map(function(item,key){return __WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13__ActivityItem__["a" /* default */],Object.assign({item:item},_this2.props));})):__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_12__Nodata__["a" /* default */],{_html:'\u6682\u65F6\u8FD8\u6CA1\u6709\u76F8\u5173\u6570\u636E\u54E6!'}),data&&data.project_trends_size>0&&data.project_trends_size>LIMIT&&__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('div',{className:'pageDIV'},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_pagination___default.a,{showQuickJumper:true,defaultCurrent:page,total:data&&data.project_trends_size,pageSize:LIMIT,onChange:this.ChangePage})));}}]);return Activity;}(__WEBPACK_IMPORTED_MODULE_8_react__["Component"]);/* harmony default export */ __webpack_exports__["default"] = (Activity);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__activity_css__ = __webpack_require__(3785);
