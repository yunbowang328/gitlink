...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_antd_lib_upload_style_css__ = __webpack_require__(1076);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_antd_lib_upload__ = __webpack_require__(1077);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_antd_lib_icon_style_css__ = __webpack_require__(178);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_antd_lib_divider_style_css__ = __webpack_require__(1324);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_antd_lib_divider_style_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_antd_lib_divider_style_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_antd_lib_divider__ = __webpack_require__(1325);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_antd_lib_divider___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_antd_lib_divider__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_antd_lib_tooltip_style_css__ = __webpack_require__(172);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_antd_lib_tooltip_style_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_12_antd_lib_tooltip_style_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_antd_lib_tooltip__ = __webpack_require__(171);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_antd_lib_tooltip___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_13_antd_lib_tooltip__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_antd_lib_checkbox_style_css__ = __webpack_require__(307);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_antd_lib_checkbox__ = __webpack_require__(304);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16_antd_lib_select_style_css__ = __webpack_require__(306);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17_antd_lib_select__ = __webpack_require__(302);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18_antd_lib_modal_style_css__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18_antd_lib_modal_style_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_18_antd_lib_modal_style_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19_antd_lib_modal__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19_antd_lib_modal___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_19_antd_lib_modal__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__tpm_challengesnew_TPMMDEditor__ = __webpack_require__(319);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__board_css__ = __webpack_require__(3039);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__board_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_23__board_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__common_formCommon_css__ = __webpack_require__(1316);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__common_formCommon_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_24__common_formCommon_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__AddDirModal__ = __webpack_require__(4686);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__common_js__ = __webpack_require__(2234);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__common_CBreadcrumb__ = __webpack_require__(333);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28_educoder__ = __webpack_require__(5);
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var confirm=__WEBPACK_IMPORTED_MODULE_19_antd_lib_modal___default.a.confirm;var $=window.$;var Option=__WEBPACK_IMPORTED_MODULE_17_antd_lib_select___default.a.Option;var MAX_TITLE_LENGTH=60;// https://lanhuapp.com/web/#/item/project/board/detail?pid=a3bcd4b1-99ce-4e43-8ead-5b8b0a410807&project_id=a3bcd4b1-99ce-4e43-8ead-5b8b0a410807&image_id=71072679-b925-4824-aceb-4649535e3652
var BoardsNew=function(_Component){_inherits(BoardsNew,_Component);function BoardsNew(props){_classCallCheck(this,BoardsNew);var _this=_possibleConstructorReturn(this,(BoardsNew.__proto__||Object.getPrototypeOf(BoardsNew)).call(this,props));_this.addSuccess=function(){_this.fetchBoards();};_this.fetchBoards=function(){var isEdit=_this.isEdit;var boardId=_this.props.match.params.boardId;var boardsUrl='/courses/board_list.json?board_id='+boardId;__WEBPACK_IMPORTED_MODULE_22_axios___default.a.get(boardsUrl,{}).then(function(response){if(response.data.status==0){_this.setState({boards:response.data.data.boards||[],boardsdata:response.data.data,course_id:response.data.data.course_id});if(!isEdit){response.data.data.boards.forEach(function(board){if(board.id==boardId){_this.setState({board_name:board.name});}});// board_name
}}}).catch(function(error){console.log(error);});};_this.componentDidMount=function(){var topicId=_this.props.match.params.topicId;var isEdit=!!topicId;_this.isEdit=isEdit;var boardId=_this.props.match.params.boardId;_this.fetchBoards();if(isEdit){var url='/messages/'+topicId+'.json';__WEBPACK_IMPORTED_MODULE_22_axios___default.a.get(url,{}).then(function(response){if(response.data.status==0){var _response$data=response.data,id=_response$data.id,data=_response$data.data;if(data){_this.editTopic=data;_this.props.form.setFieldsValue({sticky:!!data.sticky,content:data.content,subject:data.subject,select_board_id:data.board_id// TODO 没返回给前端
});_this.mdRef.current.setValue(data.content);var _fileList=data.attachments.map(function(item){return{id:item.id,uid:item.id,name:Object(__WEBPACK_IMPORTED_MODULE_28_educoder__["B" /* appendFileSizeToUploadFile */])(item),url:item.url,status:'done'};});_this.setState({fileList:_fileList,board_name:data.board_name,title_num:parseInt(data.subject.length),isemail_notifys:response.data.data.email_notify});}}}).catch(function(error){console.log(error);});}else{var _boardId=_this.props.match.params.boardId;_this.props.form.setFieldsValue({select_board_id:parseInt(_boardId)});}};_this.handleSubmit=function(e){e.preventDefault();var cid=_this.state.course_id;var boardId=_this.props.match.params.boardId;_this.props.form.validateFieldsAndScroll(function(err,values){if(!err){console.log('Received values of form: ',values);if(_this.isEdit==true){var editTopic=_this.editTopic;var editUrl='/messages/'+editTopic.id+'.json';var attachment_ids=undefined;if(_this.state.fileList){attachment_ids=_this.state.fileList.map(function(item){return item.response?item.response.id:item.id;});}__WEBPACK_IMPORTED_MODULE_22_axios___default.a.put(editUrl,{subject:values.subject,select_board_id:values.select_board_id,content:values.content,sticky:values.sticky,email_notify:_this.state.isemail_notify,attachment_ids:attachment_ids}).then(function(response){if(response.data.status==0){var id=response.data.id;console.log('--- success');_this.props.toDetailPage(cid,values.select_board_id,editTopic.id);}}).catch(function(error){console.log(error);});}else{var url='/boards/'+boardId+'/messages.json';var _attachment_ids=undefined;if(_this.state.fileList){_attachment_ids=_this.state.fileList.map(function(item){return item.response.id;});}__WEBPACK_IMPORTED_MODULE_22_axios___default.a.post(url,Object.assign({},values,{email_notify:_this.state.isemail_notify,course_id:cid,attachment_ids:_attachment_ids})).then(function(response){if(response.data.data&&response.data.status==0){var id=response.data.data.id;if(id){console.log('--- success');_this.props.toDetailPage(cid,values.select_board_id,id);}}}).catch(function(error){console.log(error);});}}else{$("html").animate({scrollTop:$('html').scrollTop()-100});}});};_this.handleChange=function(info){if(info.file.status==='uploading'||info.file.status==='done'||info.file.status==='removed'){var fileList=info.fileList;_this.setState({fileList:Object(__WEBPACK_IMPORTED_MODULE_28_educoder__["C" /* appendFileSizeToUploadFileAll */])(fileList)});}};_this.onAttachmentRemove=function(file){if(!file.percent||file.percent==100){_this.props.confirm({// title: '确定要删除这个附件吗?',
...
var url='/attachments/'+(file.response?file.response.id:file.uid)+'.json';__WEBPACK_IMPORTED_MODULE_22_axios___default.a.delete(url,{}).then(function(response){if(response.data){var status=response.data.status;if(status==0){console.log('--- success');_this.setState(function(state){var index=state.fileList.indexOf(file);var newFileList=state.fileList.slice();newFileList.splice(index,1);return{fileList:newFileList};});}}}).catch(function(error){console.log(error);});};_this.changeTitle=function(e){console.log(e.target.value.length);_this.setState({title_num:parseInt(e.target.value.length)});};_this.goBack=function(){// this.props.history.goBack()
var courseId=_this.props.match.params.coursesId;var boardId=_this.props.match.params.boardId;_this.props.toListPage(courseId,boardId);};_this.setemailchange=function(e){_this.setState({isemail_notify:e.target.checked});};_this.mdRef=__WEBPACK_IMPORTED_MODULE_20_react___default.a.createRef();_this.state={fileList:[],boards:[],title_num:0,email_notify:false,isemail_notify:false,isemail_notifys:false};return _this;}// 附件相关 START
// 附件相关 ------------ END
_createClass(BoardsNew,[{key:'render',value:function render(){var _this2=this;var _state=this.state,addGroup=_state.addGroup,fileList=_state.fileList,course_id=_state.course_id,title_num=_state.title_num;var getFieldDecorator=this.props.form.getFieldDecorator;var current_user=this.props.current_user;var formItemLayout={labelCol:{xs:{span:24},// sm: { span: 8 },
sm:{span:24}},wrapperCol:{xs:{span:24},// sm: { span: 16 },
sm:{span:24}}};var uploadProps={width:600,fileList:fileList,multiple:true,// https://github.com/ant-design/ant-design/issues/15505
// showUploadList={false}，然后外部拿到 fileList 数组自行渲染列表。
// showUploadList: false,
action:''+Object(__WEBPACK_IMPORTED_MODULE_28_educoder__["R" /* getUploadActionUrl */])(),onChange:this.handleChange,onRemove:this.onAttachmentRemove,beforeUpload:function beforeUpload(file){console.log('beforeUpload',file.name);var isLt150M=file.size/1024/1024<150;if(!isLt150M){_this2.props.showNotification('文件大小必须小于150MB!');}return isLt150M;}};var isAdmin=this.props.isAdmin();var courseId=this.props.match.params.coursesId;var boardId=this.props.match.params.boardId;var isCourseEnd=this.props.isCourseEnd();document.title=this.props.coursedata&&this.props.coursedata.name;// console.log(this.state)
return __WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('div',{className:'newMain '},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_25__AddDirModal__["a" /* default */],Object.assign({},this.props,{title:'\u65B0\u5EFA\u76EE\u5F55',label:'\u76EE\u5F55\u540D\u79F0',ref:'addDirModal',addSuccess:this.addSuccess})),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('style',null,'\n            .courseForm .ant-form {\n            }\n            .courseForm .formBlock {\n              padding: 20px 30px 30px 30px;\n              border-bottom: 1px solid #EDEDED;\n              margin-bottom: 0px;\n              background: #fff;\n            }\n            .courseForm .noBorder {\n              border-bottom: none;\n            }\n            \n          '),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('div',{className:'edu-class-container edu-position courseForm'},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_27__common_CBreadcrumb__["a" /* default */],{items:[{to:current_user&&current_user.first_category_url,name:this.props.coursedata?this.props.coursedata.name:''},{to:'/courses/'+courseId+'/boards/'+boardId,name:this.state.board_name},{name:this.isEdit?'帖子编辑':'帖子新建'}]}),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('p',{className:'clearfix mt20 mb20'},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('span',{className:'fl font-24 color-grey-3'},this.isEdit?"编辑":"新建",'\u5E16\u5B50'),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('a',{href:'javascript:void(0)',className:'color-grey-6 fr font-16 mr2',onClick:this.goBack},'\u8FD4\u56DE')),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a,Object.assign({},formItemLayout,{onSubmit:this.handleSubmit}),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('div',{className:'formBlock',style:{paddingBottom:'0px',position:'relative'}},this.state.boardsdata&&this.state.boardsdata.email_notify===true?this.props.isAdminOrTeacher()===true?__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13_antd_lib_tooltip___default.a,{placement:'bottom',title:this.state.isemail_notifys===true?"邮件只能发送一次":""},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('span',{className:"setemail fr mr70 setemailposition"},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_15_antd_lib_checkbox___default.a,{onChange:this.setemailchange,checked:this.state.isemail_notifys===true?this.state.isemail_notifys:this.state.isemail_notify,disabled:this.state.isemail_notifys},'\u53D1\u9001\u90AE\u4EF6\u63D0\u9192'))):"":"",isAdmin&&__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_20_react___default.a.Fragment,null,getFieldDecorator('sticky',{valuePropName:'checked'})(isAdmin&&__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_15_antd_lib_checkbox___default.a,{style:{right:'22px',top:'17px',position:'absolute'}},'\u7F6E\u9876')),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('span',{style:{"padding-left":0,"padding-right":0}})),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('style',null,'\n                .yslboardsnewinputaddonAfter .ant-input{\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tborder-right: none !important;\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\theight: 40px !important;\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t}\n                \n                '),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{label:'\u6807\u9898',className:'topicTitle '},getFieldDecorator('subject',{rules:[{required:true,message:'请输入标题'},{max:MAX_TITLE_LENGTH,message:'\u6700\u5927\u9650\u5236\u4E3A'+MAX_TITLE_LENGTH+'\u4E2A\u5B57\u7B26'}]})(__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11_antd_lib_input___default.a,{placeholder:'\u8BF7\u8F93\u5165\u5E16\u5B50\u6807\u9898\uFF0C\u6700\u5927\u9650\u5236'+MAX_TITLE_LENGTH+'\u4E2A\u5B57\u7B26 ',className:'searchViewAfter yslboardsnewinputaddonAfter',maxLength:MAX_TITLE_LENGTH,onInput:this.changeTitle,addonAfter:title_num+'/'+MAX_TITLE_LENGTH}))),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{label:'',style:{display:'inline-block'}},getFieldDecorator('select_board_id',{// initialValue: '3779',
})(__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_17_antd_lib_select___default.a,{style:{width:230},dropdownRender:function dropdownRender(menu){return __WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('div',null,menu,isAdmin&&!isCourseEnd&&__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_20_react___default.a.Fragment,null,__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_divider___default.a,{style:{margin:'4px 0'}}),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('div',{style:{padding:'8px',cursor:'pointer'},onMouseDown:function onMouseDown(){return _this2.refs['addDirModal'].open();}},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_icon___default.a,{type:'plus'}),' \u65B0\u5EFA\u76EE\u5F55')));}},this.state.boards.map(function(item){return __WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(Option,{value:item.id},item.name);}))))),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('style',null,'\n                .courseMessageMD {\n                  width: 1140px;\n                }\n                \n                .uploadBtn.ant-btn {\n                  border: none;\n                  color: #4CACFF;\n                  box-shadow: none;\n                  background: transparent;\n                  padding: 0 6px;\n                }\n                .upload_1 .ant-upload-list {\n                  width: 350px;\n                }\n                \n              '),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('div',{className:'formBlock noBorder'},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{label:'\u5185\u5BB9',className:'mdInForm'},getFieldDecorator('content',{rules:[{required:true,message:'请输入帖子内容'},{max:10000,message:'最大限制为10000个字符'}]})(__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_21__tpm_challengesnew_TPMMDEditor__["a" /* default */],{ref:this.mdRef,placeholder:'请在此输入帖子详情，最大限制为10000个字符',mdID:'courseMessageMD',initValue:this.editTopic?this.editTopic.content:'',className:'courseMessageMD'}))),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_upload___default.a,Object.assign({},uploadProps,{className:'upload_1'}),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_button___default.a,{className:'uploadBtn'},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_icon___default.a,{type:'upload'}),' \u4E0A\u4F20\u9644\u4EF6'),'(\u5355\u4E2A\u6587\u4EF6150M\u4EE5\u5185)')),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,null,__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('div',{className:'clearfix mt30 mb30'},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_button___default.a,{type:'primary',htmlType:'submit',className:'defalutSubmitbtn fl mr20'},'\u63D0\u4EA4'),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('a',{className:'defalutCancelbtn fl',onClick:function onClick(){return _this2.isEdit?_this2.props.toDetailPage(Object.assign({},_this2.props.match.params,{'coursesId':course_id})):_this2.props.toListPage(Object.assign({},_this2.props.match.params,{'coursesId':course_id}));}},'\u53D6\u6D88'))))));}}]);return BoardsNew;}(__WEBPACK_IMPORTED_MODULE_20_react__["Component"]);var WrappedBoardsNew=__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.create({name:'boardsNew'})(BoardsNew);/* harmony default export */ __webpack_exports__["default"] = (Object(__WEBPACK_IMPORTED_MODULE_26__common_js__["a" /* RouteHOC */])()(WrappedBoardsNew));
...
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var AddDirModal=function(_Component){_inherits(AddDirModal,_Component);function AddDirModal(props){_classCallCheck(this,AddDirModal);var _this=_possibleConstructorReturn(this,(AddDirModal.__proto__||Object.getPrototypeOf(AddDirModal)).call(this,props));_this.onInput=function(e){_this.setState({inputValue:e.target.value});};_this.open=function(){_this.setState({visible:true,inputValue:''});};_this.onSave=function(){var coursesId=_this.props.match.params.coursesId;var url='/courses/'+coursesId+'/boards.json';var inputValue=_this.state.inputValue;if(!inputValue){_this.setState({errorMsg:'名称不能为空'});return;}if(inputValue.length>20){_this.setState({errorMsg:'名称不能超过20个字'});return;}_this.setState({errorMsg:''});__WEBPACK_IMPORTED_MODULE_7_axios___default.a.post(url,{name:inputValue}).then(function(response){if(response.data.status==0){_this.onCancel();_this.props.showNotification('添加成功');_this.props.addSuccess&&_this.props.addSuccess();}}).catch(function(error){console.log(error);});};_this.onCancel=function(){_this.setState({visible:false,inputValue:'',errorMsg:''});};_this.state={};return _this;}_createClass(AddDirModal,[{key:'render',value:function render(){var _state=this.state,inputValue=_state.inputValue,visible=_state.visible,errorMsg=_state.errorMsg;var title=this.props.title;return __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_modal___default.a,{keyboard:false,title:title,visible:visible,className:"Navmodal",closable:false,footer:null,destroyOnClose:true,centered:true},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'df'},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:"fl mt5"},this.props.label,'\uFF1A'),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_input___default.a,{placeholder:this.props.inputPlaceholder||'示例：讨论小组A',className:"input-flex-35 greyInput fl",maxLength:'60',value:inputValue,onInput:this.onInput})),errorMsg&&__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('span',{style:{color:'red',marginTop:'2px',display:'inline-block'}},errorMsg),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:"clearfix mt50 edu-txt-center"},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('a',{className:'task-btn mr30',onClick:this.onCancel},'\u53D6\u6D88'),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('a',{className:'task-btn task-btn-orange',onClick:this.onSave},'\u786E\u5B9A')));}}]);return AddDirModal;}(__WEBPACK_IMPORTED_MODULE_4_react__["Component"]);/* harmony default export */ __webpack_exports__["a"] = (AddDirModal);
