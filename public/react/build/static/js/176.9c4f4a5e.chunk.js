...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__common_titleSearch_TitleSearchSection__ = __webpack_require__(1390);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__modals_DownloadMessageysl__ = __webpack_require__(1330);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_educoder__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__coursesPublic_NoneData__ = __webpack_require__(313);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_lodash__ = __webpack_require__(1303);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__GraduateTopicItem__ = __webpack_require__(3054);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__ChooseGraduateTopicModal__ = __webpack_require__(3055);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__css_busyWork_css__ = __webpack_require__(1069);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__css_busyWork_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_19__css_busyWork_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__style_css__ = __webpack_require__(1665);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__style_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_20__style_css__);
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var Boards=function(_Component){_inherits(Boards,_Component);function Boards(props){_classCallCheck(this,Boards);var _this=_possibleConstructorReturn(this,(Boards.__proto__||Object.getPrototypeOf(Boards)).call(this,props));_this.fetchAll=function(searchValue,page,status){_this.setState({checkAllValue:false,isSpin:true});var pageSize=_this.state.pageSize;var cid=_this.props.match.params.coursesId;var url="/courses/"+cid+"/graduation_topics.json?limit="+pageSize;if(searchValue!=""){url+="&search="+searchValue;}if(page!=""){url+="&page="+page;}if(status!=""&&status!="all"){url+="&status="+status;}url=encodeURI(url);//IE11传参为乱码（search）
__WEBPACK_IMPORTED_MODULE_14_axios___default.a.get(url//   ,{
//   params:{
...
//   }
// }
).then(function(response){if(response.status==200&&response.status){_this.setState({data:response.data,topicList:response.data.graduation_topic,totalCount:response.data.graduation_topic_count,course_public:response.data.course_public,isSpin:false,page:page});}}).catch(function(error){this.setState({isSpin:false});});};_this.componentDidMount=function(){_this.setState({isSpin:true});var _this$state=_this.state,searchValue=_this$state.searchValue,page=_this$state.page,status=_this$state.status;_this.fetchAll(searchValue,page,status);};_this.onPressEnter=function(value){_this.setState({page:1,searchValue:value,checkBoxValues:[]});var status=_this.state.status;_this.fetchAll(value,1,status);};_this.onInputSearchChange=function(e){_this.setState({searchValue:e.target.value});};_this.onCheckAll=function(e){_this.setState({checkAllValue:e.target.checked});var values=_this.state.topicList.map(function(item){return item.id;});if(e.target.checked){var concated=_this.state.checkBoxValues.concat(values);var uniq=__WEBPACK_IMPORTED_MODULE_15_lodash___default.a.uniq(concated);_this.setState({checkBoxValues:uniq});}else{_this.setState({checkBoxValues:__WEBPACK_IMPORTED_MODULE_15_lodash___default.a.difference(_this.state.checkBoxValues,values)});}};_this.onItemClick=function(item){var checkBoxValues=_this.state.checkBoxValues.slice(0);var index=checkBoxValues.indexOf(item.id);if(index!=-1){__WEBPACK_IMPORTED_MODULE_15_lodash___default.a.remove(checkBoxValues,function(listItem){return listItem===item.id;});}else{checkBoxValues.push(item.id);}_this.onCheckBoxChange(checkBoxValues);};_this.onCheckBoxChange=function(checkedValues){_this.setState({checkBoxValues:checkedValues,checkAllValue:checkedValues.length==_this.state.topicList.length});};_this.onChangePage=function(pageNum){_this.setState({page:pageNum,checkBoxValues:[]});var _this$state2=_this.state,status=_this$state2.status,searchValue=_this$state2.searchValue;_this.fetchAll(searchValue,pageNum,status);console.log(_this.state.checkBoxValues);};_this.onChangeStatus=function(e){_this.setState({page:1,status:e.key,checkBoxValues:[],isSpin:true});var searchValue=_this.state.searchValue;_this.fetchAll(searchValue,1,e.key==="all"?"":e.key);};_this.chooseTopic=function(topicId,index,flag){_this.setState({modalsType:true,modalsTopval:flag==true?"是否确认取消选题？":"是否确认选题？",modalsBottomval:"",modalCancel:true,topicId:topicId,index:index,flag:flag});};_this.cancelOperateTopic=function(){_this.setState({modalsType:false,modalsTopval:"",modalsBottomval:"",modalCancel:false});};_this.sureOperateTopic=function(){var _this$state3=_this.state,topicId=_this$state3.topicId,index=_this$state3.index,flag=_this$state3.flag;var courseid=_this.props.match.params.coursesId;var url="/courses/"+courseid+"/graduation_topics/"+topicId+"/";if(flag){url+="student_cancel_topic.json";}else{url+="student_select_topic.json";}__WEBPACK_IMPORTED_MODULE_14_axios___default.a.post(url).then(function(result){if(result.data.status==0){_this.props.showNotification(""+result.data.message);var _this$state4=_this.state,searchValue=_this$state4.searchValue,page=_this$state4.page,status=_this$state4.status;_this.fetchAll(searchValue,page,status);_this.cancelOperateTopic();}}).catch(function(error){console.log(error);});};_this.onDelete=function(index){var checkBoxValues=_this.state.checkBoxValues;if(checkBoxValues.length>0){if(index<3){_this.setState({delType:true,delTopval:index==1?"是否确认删除?":"是否设为公开?",delLoadType:false,delOrPublic:index});}else{// 加入题库
var courseid=_this.props.match.params.coursesId;var url="/courses/"+courseid+"/graduation_topics/add_to_bank.json";__WEBPACK_IMPORTED_MODULE_14_axios___default.a.post(url,{topic_ids:checkBoxValues}).then(function(result){if(result){_this.props.showNotification("\u9898\u5E93\u66F4\u65B0\u6210\u529F");var _this$state5=_this.state,searchValue=_this$state5.searchValue,page=_this$state5.page,status=_this$state5.status;_this.fetchAll(searchValue,page,status);_this.setState({checkBoxValues:[],checkAllValue:false});}}).catch(function(error){console.log(error);});}}else{_this.setState({// delType:true,
// delTopval:"请先在列表中选择数据",
// delLoadType:true,
delOrPublic:index});_this.props.showNotification("请先在列表中选择数据");}};_this.cancelDelTopic=function(){_this.setState({delType:false,delTopval:"",delLoadType:false});};_this.sureDelTopic=function(){var _this$state6=_this.state,checkBoxValues=_this$state6.checkBoxValues,delOrPublic=_this$state6.delOrPublic;if(checkBoxValues.length>0){var courseid=_this.props.match.params.coursesId;var url="";// 删除
if(delOrPublic==1){url="/courses/"+courseid+"/graduation_topics/destroys.json";__WEBPACK_IMPORTED_MODULE_14_axios___default.a.delete(url,{data:{graduation_topic_ids:_this.state.checkBoxValues}}).then(function(result){if(result.data.status==0){_this.props.showNotification(""+result.data.message);_this.setState({delType:false,delTopval:"",checkBoxValues:[]});var _this$state7=_this.state,searchValue=_this$state7.searchValue,status=_this$state7.status;_this.fetchAll(searchValue,1,status);}}).catch(function(error){console.log(error);});}else if(delOrPublic==2){// 设为公开
url="/courses/"+courseid+"/graduation_topics/set_public.json";__WEBPACK_IMPORTED_MODULE_14_axios___default.a.post(url,{graduation_topic_ids:_this.state.checkBoxValues}).then(function(result){if(result.data.status==0){_this.props.showNotification(""+result.data.message);_this.setState({delType:false,delTopval:"",checkBoxValues:[]});var _this$state8=_this.state,searchValue=_this$state8.searchValue,status=_this$state8.status;_this.fetchAll(searchValue,1,status);}}).catch(function(error){console.log(error);});}}else{_this.setState({delType:false,delTopval:"",delLoadType:false});}};_this.onBoardsNew=function(){var courseId=_this.props.match.params.coursesId;_this.props.history.push("/courses/"+courseId+"/graduation_topics/new");};_this.Downloadcal=function(){_this.setState({DownloadType:false,DownloadMessageval:undefined});};_this.useBankSuccess=function(checkBoxValues,object_ids){//debugger
var _this$state9=_this.state,searchValue=_this$state9.searchValue,page=_this$state9.page,status=_this$state9.status;_this.fetchAll(searchValue,page,status);};_this.state={searchValue:'',checkAllValue:false,checkBoxValues:[],data:[],topicList:undefined,course_public:1,page:1,totalCount:undefined,status:"all",pageSize:15,modalsType:"",modalsTopval:"",modalsBottomval:"",topicId:undefined,index:undefined,flag:true,delType:false,delTopval:"",delLoadType:false,delOrPublic:1,isSpin:true,DownloadType:false,DownloadMessageval:undefined};return _this;}//搜索
// 全选or反选
// 分页
// 筛选
// 选题or取消选题
// 删除
// 新建
_createClass(Boards,[{key:"confirmysl",/// 确认是否下载
value:function confirmysl(url){var _this2=this;__WEBPACK_IMPORTED_MODULE_14_axios___default.a.get(url+'&export=true').then(function(response){if(response.data.status&&response.data.status===-1){}else if(response.data.status&&response.data.status===-2){if(response.data.message==="100"){// 已超出文件导出的上限数量（100 ），建议：
_this2.setState({DownloadType:true,DownloadMessageval:100});}else{//因附件资料超过500M
_this2.setState({DownloadType:true,DownloadMessageval:500});}}else{_this2.props.showNotification("\u6B63\u5728\u4E0B\u8F7D\u4E2D");window.open(Object(__WEBPACK_IMPORTED_MODULE_11_educoder__["P" /* getRandomcode */])("/api"+url),'_blank');}}).catch(function(error){console.log(error);});}// 题库选用成功后刷新页面
},{key:"render",value:function render(){var _this3=this;var _state=this.state,searchValue=_state.searchValue,topicList=_state.topicList,data=_state.data,course_public=_state.course_public,checkBoxValues=_state.checkBoxValues,checkAllValue=_state.checkAllValue,page=_state.page,totalCount=_state.totalCount,pageSize=_state.pageSize,modalsType=_state.modalsType,modalsTopval=_state.modalsTopval,modalsBottomval=_state.modalsBottomval,delType=_state.delType,delTopval=_state.delTopval,delLoadType=_state.delLoadType;// let {course_identity}=this.props.coursedata
var isAdmin=this.props.isAdmin();return __WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_8_react___default.a.Fragment,null,__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_17__ChooseGraduateTopicModal__["a" /* default */],{ref:"chooseGraduateTopicModal"}),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_10__modals_DownloadMessageysl__["a" /* default */],Object.assign({},this.props,{value:this.state.DownloadMessageval,modalCancel:this.Downloadcal,modalsType:this.state.DownloadType})),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9__common_titleSearch_TitleSearchSection__["a" /* default */],{title:"\u6BD5\u8BBE\u9009\u9898",searchValue:searchValue,onInputSearchChange:this.onInputSearchChange,allowClearonChange:this.onInputSearchChange,firstRowRight:isAdmin?__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_8_react___default.a.Fragment,null,__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("a",{className:"fl color-blue mr30 font-16",onClick:function onClick(url){return _this3.confirmysl("/courses/"+_this3.props.match.params.coursesId+"/graduation_topics/export.xlsx");}},"\u5BFC\u51FA"),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11_educoder__["A" /* WordsBtn */],{style:"blue",className:"font-16",onClick:function onClick(){return _this3.onBoardsNew();}},"\u65B0\u5EFA")):"",secondRowLeft:__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("div",{className:"fl mt6 task_menu_ul"},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_menu___default.a,{mode:"horizontal",defaultSelectedKeys:"all",onClick:this.onChangeStatus},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_menu___default.a.Item,{key:"all"},"\u5168\u90E8"),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_menu___default.a.Item,{key:"0"},"\u5F85\u9009\u4E2D"),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_menu___default.a.Item,{key:"1"},"\u5F85\u786E\u8BA4"),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_menu___default.a.Item,{key:"2"},"\u5DF2\u786E\u8BA4"))),onPressEnter:this.onPressEnter,searchPlaceholder:"请输入名称进行搜索",showSearchInput:topicList&&topicList.length>=pageSize}),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_spin___default.a,{size:"large",spinning:this.state.isSpin},topicList&&topicList.length>0?__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("div",null,// 超级管理员、教师、助教
isAdmin?__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("div",{className:"clearfix mt20 edu-back-white padding20-30"},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_checkbox___default.a,{className:"fl",onChange:this.onCheckAll,checked:checkAllValue},"\u5DF2\u9009 ",checkBoxValues.length," \u4E2A    \uFF08\u4E0D\u652F\u6301\u8DE8\u9875\u52FE\u9009\uFF09"),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("div",{className:"studentList_operation_ul"},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("li",{className:"li_line"},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("a",{href:"javascript:void(0)",className:"color-grey-9",onClick:function onClick(){return _this3.onDelete(1);}},"\u5220\u9664")),course_public&&course_public==1?__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("li",{className:"li_line"},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("a",{href:"javascript:void(0)",className:"color-grey-9",onClick:function onClick(){return _this3.onDelete(2);}},"\u8BBE\u4E3A\u516C\u5F00")):"")):"",__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13__modals_Modals__["a" /* default */],{modalsType:delType,modalsTopval:delTopval,modalsBottomval:"",modalCancel:this.cancelDelTopic,modalSave:this.sureDelTopic,loadtype:delLoadType}),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("div",{className:"clearfix stu_table mt20"},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_checkbox___default.a.Group,{style:{width:'100%'},onChange:this.onCheckBoxChange,value:checkBoxValues},topicList.map(function(item,index){return __WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("div",null,__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_16__GraduateTopicItem__["a" /* default */],Object.assign({},_this3.props,{discussMessage:item,data:data,checkBox:__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_checkbox___default.a,{value:item.id,key:item.id,onClick:function onClick(){return _this3.onItemClick(item);},className:"mr15"}),onItemClick:_this3.onItemClick,index:index,chooseTopic:_this3.chooseTopic})));}))),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13__modals_Modals__["a" /* default */],{modalsType:modalsType,modalsTopval:modalsTopval,modalsBottomval:modalsBottomval,modalCancel:this.cancelOperateTopic,modalSave:this.sureOperateTopic})):topicList&&topicList.length===0?__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_12__coursesPublic_NoneData__["a" /* default */],null):__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("div",{className:"clearfix stu_table mt20"})),totalCount&&totalCount>pageSize?__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("div",{className:"padding30 edu-txt-center clearfix"},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_pagination___default.a,{defaultCurrent:page,current:page,pageSize:pageSize,showQuickJumper:true,onChange:this.onChangePage,total:totalCount})):__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("div",null),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("div",null));}}]);return Boards;}(__WEBPACK_IMPORTED_MODULE_8_react__["Component"]);/* harmony default export */ __webpack_exports__["default"] = (Boards);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__coursesPublic_CoursesListType__ = __webpack_require__(1113);
...
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var map={0:"待选中",1:"待确认",2:"已确认"};var GraduateTopicItem=function(_Component){_inherits(GraduateTopicItem,_Component);function GraduateTopicItem(props){_classCallCheck(this,GraduateTopicItem);var _this=_possibleConstructorReturn(this,(GraduateTopicItem.__proto__||Object.getPrototypeOf(GraduateTopicItem)).call(this,props));_this.editTopic=function(topicId){var courseId=_this.props.match.params.coursesId;_this.props.history.push('/courses/'+courseId+'/graduation_topics/'+topicId+'/edit');};_this.toDetailPage=function(topicId){if(_this.props.checkIfLogin()===false){_this.props.showLoginDialog();return;}// if(this.props.checkIfProfileCompleted()===false){
// 	this.setState({
...
// 	return
// }
var courseId=_this.props.match.params.coursesId;_this.props.history.push('/courses/'+courseId+'/graduation_topics/'+topicId+'/detail');};return _this;}_createClass(GraduateTopicItem,[{key:'render',value:function render(){var _this2=this;var _props=this.props,checkBox=_props.checkBox,discussMessage=_props.discussMessage,index=_props.index,chooseTopic=_props.chooseTopic,data=_props.data,courseId=_props.courseId;var isAdmin=this.props.isAdmin();var isStudent=this.props.isStudent();var isNotMember=this.props.isNotMember();if(!discussMessage||!discussMessage.author){return'';}return __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('div',null,__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('style',null,'\n         .boardsList:hover {\n              box-shadow: 0px 2px 6px rgba(51,51,51,0.09);\n              opacity: 1;\n              border-radius: 2px;\n          }\n          .graduateTopicList .ant-checkbox-wrapper {\n              margin-top: -44px;\n          }\n            '),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('div',{className:'graduateTopicList boardsList mb20',style:{cursor:isAdmin?"pointer":"default"},onClick:function onClick(){return window.$('.topicItem'+index+' input').click();}},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('style',null,'\n            \n            .graduateTopicList .ant-checkbox-input {s\n              margin-right: 15px;\n            }\n            .ant-checkbox-group > div .boardsList {\n\n                  padding: 17px 30px 20px!important;\n              }\n          '),isAdmin?__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('span',{className:'topicItem'+index+' fl',style:{"height":"64px"}},checkBox):"",__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('div',{className:'clearfix ds pr flex1'},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('style',null,'\n            .maxwidth580{\n                max-width: 580px;\n                overflow:hidden;\n                text-overflow:ellipsis;\n                white-space:nowrap\n            }\n            a:hover{\n                 color: #4cacff;\n             }\n          '),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('h6',null,isNotMember?discussMessage.private_icon===true?__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('span',{className:'fl mt3 font-16 font-bd color-dark maxwidth580 pointer',title:discussMessage.private_icon===true?"私有属性，非课堂成员不能访问":discussMessage.name},discussMessage.name):__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('a',{className:'fl mt3 font-16 font-bd color-dark maxwidth580 pointer',title:discussMessage.name},discussMessage.name):"",isStudent?__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('a',{onClick:function onClick(){return _this2.toDetailPage(''+discussMessage.id);},className:'fl mt3 font-16 font-bd color-dark maxwidth580',title:discussMessage.name},discussMessage.name):"",isAdmin?__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('a',{onClick:function onClick(){return _this2.toDetailPage(''+discussMessage.id);},className:'fl mt3 font-16 font-bd color-dark maxwidth580',title:discussMessage.name},discussMessage.name):"",discussMessage.private_icon===true?__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_tooltip___default.a,{title:"私有属性，非课堂成员不能访问",placement:'bottom'},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('i',{className:'iconfont icon-guansuo color-grey-c ml10 font-16 fl mt4'})):"",__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__coursesPublic_CoursesListType__["a" /* default */],{typelist:[map[''+discussMessage.status]],typesylename:""})),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('div',{className:'cl'}),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('p',{className:'color-grey mt20 clearfix'},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('span',{className:'fl mr40 mt1'},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_tooltip___default.a,{title:'\u6307\u5BFC\u8001\u5E08',placement:'bottom'},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('span',{className:'color-grey3'},discussMessage.author))),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('span',{className:'fl mr20 color-grey-9 mt1'},discussMessage.selected_count,' \u5DF2\u9009'),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('span',{className:'fl color-grey-9 mt1'},discussMessage.confirmation_count,' \u5DF2\u786E\u8BA4'),__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('span',{className:'fr'},isStudent?__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4_educoder__["A" /* WordsBtn */],{style:'blue',onClick:function onClick(){return _this2.toDetailPage(''+discussMessage.id);},className:'font-16 mr20'},'\u67E5\u770B\u8BE6\u60C5'):"",isAdmin?__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4_educoder__["A" /* WordsBtn */],{style:'blue',onClick:function onClick(){return _this2.toDetailPage(''+discussMessage.id);},className:'font-16 mr20'},'\u67E5\u770B\u8BE6\u60C5'):"",isAdmin&&__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4_educoder__["A" /* WordsBtn */],{onClick:function onClick(){return _this2.editTopic(''+discussMessage.id);},style:'blue',className:'font-16  '},'\u7F16\u8F91'),isStudent&&data.user_selected==true&&discussMessage.user_topic_status==0&&__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4_educoder__["A" /* WordsBtn */],{onClick:function onClick(){return chooseTopic(''+discussMessage.id,index,true);},style:'blue',className:'font-16 mr20'},'\u53D6\u6D88\u9009\u9898'),isStudent&&data.user_selected==false&&(discussMessage.user_topic_status==null||discussMessage.user_topic_status==2)&&__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4_educoder__["A" /* WordsBtn */],{onClick:function onClick(){return chooseTopic(''+discussMessage.id,index,false);},style:'blue',className:'font-16 mr20'},'\u9009\u9898'))))));}}]);return GraduateTopicItem;}(__WEBPACK_IMPORTED_MODULE_2_react__["Component"]);/* harmony default export */ __webpack_exports__["a"] = (GraduateTopicItem);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__common_ModalWrapper__ = __webpack_require__(320);
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var Search=__WEBPACK_IMPORTED_MODULE_3_antd_lib_input___default.a.Search;// 题库选用弹框  https://www.trustie.net/issues/19980
var ChooseGraduateTopicModal=function(_Component){_inherits(ChooseGraduateTopicModal,_Component);function ChooseGraduateTopicModal(props){_classCallCheck(this,ChooseGraduateTopicModal);var _this=_possibleConstructorReturn(this,(ChooseGraduateTopicModal.__proto__||Object.getPrototypeOf(ChooseGraduateTopicModal)).call(this,props));_this.setVisible=function(visible){_this.refs.modalWrapper.setVisible(visible);};_this.changeNav=function(index){_this.setState({nav_my:index});};_this.onOk=function(){_this.refs.modalWrapper.setVisible(false);};_this.state={};return _this;}//切换tab
_createClass(ChooseGraduateTopicModal,[{key:"render",value:function render(){var _this2=this;var _state=this.state,flag=_state.flag,nav_my=_state.nav_my;var workType=this.props.workType;return __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5__common_ModalWrapper__["a" /* default */],{ref:"modalWrapper",onOk:this.onOk,title:"题库选用"},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4_react___default.a.Fragment,null,__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("style",null,"\n              .courseModalNav li{\n                float: left;\n                margin-right: 20px;\n              }\n              .courseModalNav li:last-child{\n                margin-right: 0px;\n              }\n              .courseModalNav li.active a{\n                color: #fff!important;\n                background-color: #4CACFF;\n              }\n              .courseModalNav li a{\n                display: block;\n                padding:0px 10px;\n                height: 28px;\n                line-height: 28px;\n                background-color: #F5F5F5;\n                border-radius: 36px;\n                color: #666666!important;\n              }\n            "),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("div",{className:"clearfix mb30"},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("ul",{className:"fl mt2 courseModalNav"},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("li",{className:nav_my===1?"active":"",onClick:function onClick(){return _this2.changeNav(1);}},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("a",null,"\u6211\u7684\u9898\u5E93")),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("li",{className:nav_my===1?"":"active",onClick:function onClick(){return _this2.changeNav(2);}},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("a",null,"\u516C\u5171\u9898\u5E93"))),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(Search,{placeholder:"\u8F93\u5165\u9002\u7528\u9009\u9898\u540D\u79F0\u5173\u952E\u5B57\u641C\u7D22",className:"searchView fr",style:{"width":"268px","height":"30px"}})),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("p",{className:"color-grey-6 mb25 edu-txt-center"},"\u9009\u7528\u5BF9\u8C61\uFF1A\u4F60\u5728\u8BFE\u5802","毕设选题","\u5217\u8868\u4E2D\u5DF2",__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("span",{className:"color-orange-tip"},"\u201C\u52A0\u5165\u9898\u5E93\u201D"),"\u7684\u9009\u9898"),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("div",null,__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("div",{className:"edu-back-skyblue padding20",style:{"height":"300px"}},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("p",{className:"clearfix mb7"},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_checkbox___default.a,{className:"fl"}),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("span",{className:"fl with45"},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("label",{className:"task-hide fl",style:{"maxWidth":"208px;"}},"\u6BD5\u4E1A\u8BBE\u8BA12018\u5F00\u9898\u62A5\u544A\u9898\u62A5")),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("span",{className:nav_my===1?"fl with50 color-grey-6 task-hide pl5":"fl with30 color-grey-6 task-hide pl5"},"\u6570\u636E\u5E93\u539F\u7406\u6570\u636E\u5E93\u539F\u7406"),nav_my===2&&__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("span",{className:"fl with16 color-grey-6 task-hide pl10"},"\u80E1\u838E\u838E\u80E1\u838E\u838E"))))));}}]);return ChooseGraduateTopicModal;}(__WEBPACK_IMPORTED_MODULE_4_react__["Component"]);/* harmony default export */ __webpack_exports__["a"] = (ChooseGraduateTopicModal);
