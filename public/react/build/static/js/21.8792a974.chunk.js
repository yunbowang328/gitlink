...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_antd_lib_tabs_style_css__ = __webpack_require__(1470);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_antd_lib_tabs__ = __webpack_require__(1471);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__CheckInputysl__ = __webpack_require__(1931);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__ReadPassword__ = __webpack_require__(3305);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__commontwo_css__ = __webpack_require__(2063);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__courses_css_members_css__ = __webpack_require__(334);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__courses_css_members_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__courses_css_members_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__courses_common_formCommon_css__ = __webpack_require__(1440);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__courses_common_formCommon_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__courses_common_formCommon_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__courses_css_Courses_css__ = __webpack_require__(331);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__courses_css_Courses_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__courses_css_Courses_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_images_login_beijintulogontwo_png__ = __webpack_require__(2448);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_images_login_beijintulogontwo_png___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__src_images_login_beijintulogontwo_png__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_images_login_educodernet_png__ = __webpack_require__(3303);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_images_login_educodernet_png___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__src_images_login_educodernet_png__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__user_LoginRegisterComponent__ = __webpack_require__(2449);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__user_FindPasswordComponent__ = __webpack_require__(3304);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__images_login_passopen_png__ = __webpack_require__(2420);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__images_login_passopen_png___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10__images_login_passopen_png__);
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}//educoder登入页面
var sectionStyle={"height":"100%","width":"100%","min-width":"1000px"// makesure here is String确保这里是一个字符串，以下是es6写法
};var imgback={" background-size":"cover","background-repeat":"no-repeat",backgroundImage:'url('+__WEBPACK_IMPORTED_MODULE_6__src_images_login_beijintulogontwo_png___default.a+')'};var imgmian={width:"100%",background:'url('+__WEBPACK_IMPORTED_MODULE_6__src_images_login_beijintulogontwo_png___default.a+')',position:"relative"};var newContainer={background:'url('+__WEBPACK_IMPORTED_MODULE_6__src_images_login_beijintulogontwo_png___default.a+')',backgroundPosition:"center",backgroundRepeat:"no-repeat",backgroundAttachment:"fixed",backgroundSize:"100% 100%",height:" 100%",width:" 100%",position:"absolute",top:"0px",bottom:"0px",minHeight:"100%",paddingTop:"40px"};var EducoderLogin=function(_Component){_inherits(EducoderLogin,_Component);function EducoderLogin(props){_classCallCheck(this,EducoderLogin);var _this=_possibleConstructorReturn(this,(EducoderLogin.__proto__||Object.getPrototypeOf(EducoderLogin)).call(this,props));_this.Setlogins=function(i){console.log("96ye");console.log(i);_this.setState({logini:i});};_this.gohome=function(){window.location.href="/";};_this.Setshowbool=function(e,name,pass){if(e===1){_this.setState({showbool:1});}else if(e===3){_this.setState({showbool:3});}};if(props.match.url==="/changepassword"){_this.state={showbool:3,logini:3,namezh:"",passmm:"",loginstatus:true};}else{if(props.match.url==="/login"){_this.state={showbool:1,loginstatus:true,logini:1,namezh:"",passmm:""};}else if(props.match.url==="/register"){// showbool: 1,
_this.state={showbool:1,loginstatus:false,logini:2,namezh:"",passmm:""};}else{_this.state={showbool:1,logini:1,namezh:"",passmm:"",loginstatus:true};}}return _this;}_createClass(EducoderLogin,[{key:'componentDidMount',value:function componentDidMount(){// console.log("EducoderLogin");
// console.log(this.props);
}},{key:'render',value:function render(){var _this2=this;var _state=this.state,showbool=_state.showbool,loginstatus=_state.loginstatus,logini=_state.logini;// console.log("EducoderLogingetHelmetapi");
// console.log(this.props);
// console.log(this.props.mygetHelmetapi);
return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{style:newContainer,className:' clearfix'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',null,__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{style:{"display":"flex","justify-content":"center","align-items":"center","width":"100%"}},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{style:{cursor:"pointer"}},this.props.mygetHelmetapi===null?"":this.props.mygetHelmetapi===undefined||this.props.mygetHelmetapi.login_logo_url===null||this.props.mygetHelmetapi.login_logo_url===undefined?__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('img',{style:{cursor:"pointer"},onClick:function onClick(){return _this2.gohome();},src:__WEBPACK_IMPORTED_MODULE_7__src_images_login_educodernet_png___default.a}):__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('img',{style:{cursor:"pointer"},onClick:function onClick(){return _this2.gohome();},src:Object(__WEBPACK_IMPORTED_MODULE_2_educoder__["M" /* getImageUrl */])(this.props.mygetHelmetapi.login_logo_url)}))),showbool===1?__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{style:{display:"flex",justifyContent:"center",width:"100%",marginTop:"25px"}},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',null,__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_8__user_LoginRegisterComponent__["a" /* default */],Object.assign({},this.props,this.state,{Setshowbool:function Setshowbool(e){return _this2.Setshowbool(e);}})))):__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{style:{display:"flex",justifyContent:"center",width:"100%",marginTop:"25px"}},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',null,__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9__user_FindPasswordComponent__["a" /* default */],Object.assign({},this.props,this.state,{Setshowbool:function Setshowbool(e){return _this2.Setshowbool(e);}})))),this.props.mygetHelmetapi===null?__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{style:{display:"flex",justifyContent:"center",width:"100%"}},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'font-14 color-grey-9 ',style:{marginTop:"20px"}},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('span',{className:'font-18'},'\xA9'),'\xA0',__WEBPACK_IMPORTED_MODULE_1_moment___default()().year(),'\xA0\u56FD\u9632\u79D1\u6280\u5927\u5B66',__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('span',{className:'ml15 mr15'},'\u6E58ICP\u590717009477\u53F7'),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('a',{href:'https://team.trustie.net',style:{"color":"#888"},target:'_blank'},'Trustie'),'\xA0\xA0\xA0&\xA0\xA0\xA0IntelliDE inside.')):this.props.mygetHelmetapi===undefined||this.props.mygetHelmetapi.main_site===null||this.props.mygetHelmetapi.main_site===undefined?__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{style:{display:"flex",justifyContent:"center",width:"100%"}},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'font-14 color-grey-9 ',style:{marginTop:"20px"}},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('span',{className:'font-18'},'\xA9'),'\xA0',__WEBPACK_IMPORTED_MODULE_1_moment___default()().year(),'\xA0\u6E58ICP\u590717009477\u53F7',__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('span',{className:'ml15 mr15'},'\u6E58ICP\u590717009477\u53F7'),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('a',{href:'https://team.trustie.net',style:{"color":"#888"},target:'_blank'},'Trustie'),'\xA0\xA0\xA0&\xA0\xA0\xA0IntelliDE inside.')):this.props.mygetHelmetapi.main_site===true?__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{style:{display:"flex",justifyContent:"center",width:"100%"}},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'font-14 color-grey-9 ',style:{marginTop:"20px"}},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('span',{className:'font-18'},'\xA9'),'\xA0',__WEBPACK_IMPORTED_MODULE_1_moment___default()().year(),'\xA0\u6E58ICP\u590717009477\u53F7',__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('span',{className:'ml15 mr15'},'\u6E58ICP\u590717009477\u53F7'),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('a',{href:'https://team.trustie.net',style:{"color":"#888"},target:'_blank'},'Trustie'),'\xA0\xA0\xA0&\xA0\xA0\xA0IntelliDE inside.')):""));}}]);return EducoderLogin;}(__WEBPACK_IMPORTED_MODULE_0_react__["Component"]);/* harmony default export */ __webpack_exports__["default"] = (EducoderLogin);// showbool === 2 ?
//   <div style={{
//       display: "flex",
