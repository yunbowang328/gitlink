...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__branch_css__ = __webpack_require__(2281);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__branch_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__branch_css__);
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var $=window.$;var SelectBranch=function(_Component){_inherits(SelectBranch,_Component);function SelectBranch(props){_classCallCheck(this,SelectBranch);var _this=_possibleConstructorReturn(this,(SelectBranch.__proto__||Object.getPrototypeOf(SelectBranch)).call(this,props));_this.ChangeVisible=function(visible){_this.setState({visible:!visible});};_this.InputClick=function(e){_this.stopPropagations(e);};_this.stopPropagations=function(e){e.stopPropagation();};_this.changeValue=function(e){_this.setState({value:e.target.value});};_this.changeBranchs=function(e,value){e.stopPropagation();_this.setState({visible:false,value:value});var changeBranch=_this.props.changeBranch;changeBranch&&changeBranch(value);};_this.state={visible:false,value:undefined};return _this;}_createClass(SelectBranch,[{key:'componentDidMount',value:function componentDidMount(){var _this2=this;document.body.addEventListener('click',function(e){if(e.target&&(e.target.matches('#m-btn')||e.target.matches("#input-btn")||e.target.matches("#ul-btn"))){return;}if($(e.target)[0].className==="task-hide ulALink")return;_this2.setState({visible:false,value:undefined});});}// 输入搜索内容
// 选择分支
},{key:'render',value:function render(){var _this3=this;var _state=this.state,visible=_state.visible,value=_state.value;var _props=this.props,branchs=_props.branchs,branch=_props.branch;var branchsFilter=value?branchs&&branchs.length>0&&branchs.filter(function(item){return item.name.indexOf(value)>-1;}):branchs;var menu=__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('div',{className:'branchOptions',id:'m-btn',onClick:this.stopPropagations},__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_input___default.a,{placeholder:'\u8BF7\u8F93\u5165\u5206\u652F\u540D\u79F0\u8FDB\u884C\u641C\u7D22',autocomplete:'off',id:'input-btn',value:value,className:'OptionsInput',onChange:this.changeValue,onClick:this.InputClick}),__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('ul',{className:'OptionsUl',id:'ul-btn'},branchsFilter&&branchsFilter.map(function(item,key){return __WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('li',{key:key},__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('a',{className:'task-hide ulALink',onClick:function onClick(e){return _this3.changeBranchs(e,''+item.name);}},item.name));})));return __WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('div',{className:'branchDropdown f-wrap-alignCenter',onClick:function onClick(){return _this3.ChangeVisible(visible);}},__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_dropdown___default.a,{overlay:menu,trigger:['click'],placement:'bottomLeft',visible:visible},__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('span',null,__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('span',{className:'color-grey-9 mr3'},__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('i',{className:'iconfont icon-fenzhi font-20 color-grey-6 mr3'}),'\u5206\u652F:'),__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('a',{className:'ant-dropdown-link'},branch,' ',__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_icon___default.a,{type:'down'})))));}}]);return SelectBranch;}(__WEBPACK_IMPORTED_MODULE_6_react__["Component"]);/* harmony default export */ __webpack_exports__["a"] = (SelectBranch);
