...
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var TextArea=__WEBPACK_IMPORTED_MODULE_7_antd_lib_input___default.a.TextArea;var Option=__WEBPACK_IMPORTED_MODULE_5_antd_lib_select___default.a.Option;var Setting=function(_Component){_inherits(Setting,_Component);function Setting(props){_classCallCheck(this,Setting);var _this=_possibleConstructorReturn(this,(Setting.__proto__||Object.getPrototypeOf(Setting)).call(this,props));_this.componentDidMount=function(){_this.getCategory();_this.getLanguage();_this.getInfo();};_this.getLanguage=function(){var url='/project_languages.json';__WEBPACK_IMPORTED_MODULE_9_axios___default.a.get(url).then(function(result){if(result){var LanguageList=_this.setOptionsList(result.data.project_languages);_this.setState({LanguageList:LanguageList});}}).catch(function(error){});};_this.getInfo=function(){var projectsId=_this.props.match.params.projectsId;var url='/repositories/'+projectsId+'/edit.json';__WEBPACK_IMPORTED_MODULE_9_axios___default.a.get(url).then(function(result){if(result){_this.props.form.setFieldsValue(Object.assign({},result.data));_this.setState({private_check:result.data.private});}}).catch(function(error){console.log(error);});};_this.getCategory=function(){var url='/project_categories.json';__WEBPACK_IMPORTED_MODULE_9_axios___default.a.get(url).then(function(result){if(result){var CategoryList=_this.setOptionsList(result.data.project_categories);_this.setState({CategoryList:CategoryList});}}).catch(function(error){});};_this.setOptionsList=function(data){var list=undefined;if(data&&data.length>0){list=data.map(function(item,key){return __WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(Option,{key:item.id,value:item.id},item.name);});}return list;};_this.resetSetting=function(){_this.props.form.validateFields(function(err,values){if(!err){var project_id=_this.props.project_id;var private_check=_this.state.private_check;var url='/projects/'+project_id+'.json';__WEBPACK_IMPORTED_MODULE_9_axios___default.a.put(url,Object.assign({name:values.project_name,description:values.project_description,private:private_check},values)).then(function(result){if(result){_this.props.showNotification('\u4ED3\u5E93\u4FE1\u606F\u4FEE\u6539\u6210\u529F\uFF01');var getDetail=_this.props.getDetail;getDetail&&getDetail();}}).catch(function(error){console.log(error);});}});};_this.deleteProject=function(){_this.props.confirm({content:"删除后无法恢复，是否确认删除本仓库？",onOk:function onOk(){var project_id=_this.props.project_id;var url='/projects/'+project_id+'.json';__WEBPACK_IMPORTED_MODULE_9_axios___default.a.delete(url).then(function(result){_this.props.showNotification("仓库删除成功！");_this.props.history.push("/projects");}).catch(function(error){console.log(error);});}});};_this.changePrivate=function(e){console.log(e);_this.setState({private_check:e.target.checked});};_this.state={CategoryList:undefined,LanguageList:undefined,private_check:undefined};return _this;}// 更新仓库设置
// 删除本仓库
_createClass(Setting,[{key:'render',value:function render(){var getFieldDecorator=this.props.form.getFieldDecorator;var _state=this.state,CategoryList=_state.CategoryList,LanguageList=_state.LanguageList,private_check=_state.private_check;return __WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('div',null,__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('div',{className:'normalBox'},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('div',{className:'normalBox-title font-16'},'\u57FA\u672C\u8BBE\u7F6E'),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_form___default.a,{className:'baseForm'},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_form___default.a.Item,{label:'\u9879\u76EE\u540D\u79F0'},getFieldDecorator('project_name',{rules:[{required:true,message:'请输入项目名称'}]})(__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_input___default.a,{placeholder:'\u8BF7\u8F93\u5165\u9879\u76EE\u540D\u79F0'}))),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('div',{className:'df',style:{alignItems:"center"}},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('span',{className:'mr20 mb15 font-16'},'\u53EF\u89C1\u6027'),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_form___default.a.Item,{label:''},getFieldDecorator('private',{rules:[]})(__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_checkbox___default.a,{checked:private_check,onChange:this.changePrivate},'\u5C06\u4ED3\u5E93\u8BBE\u4E3A\u79C1\u6709')))),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_form___default.a.Item,{label:'\u4ED3\u5E93\u63CF\u8FF0'},getFieldDecorator('project_description',{rules:[]})(__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(TextArea,{placeholder:'\u8BF7\u8F93\u5165\u4ED3\u5E93\u63CF\u8FF0',style:{height:"80px"}}))),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_form___default.a.Item,{label:'\u9879\u76EE\u7C7B\u522B'},getFieldDecorator('project_category_id',{rules:[{required:true,message:'请选择大类别'}]})(__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_select___default.a,null,CategoryList))),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_form___default.a.Item,{label:'\u9879\u76EE\u8BED\u8A00'},getFieldDecorator('project_language_id',{rules:[{required:true,message:'请选择项目语言'}]})(__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_select___default.a,null,LanguageList))),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('p',{className:'clearfix'},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('a',{className:'submitBtn',onClick:this.resetSetting},'\u66F4\u65B0\u4ED3\u5E93\u8BBE\u7F6E')))),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('div',{className:'dangerousBox'},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('div',{className:'dangerousTitle'},'\u5371\u9669\u64CD\u4F5C\u533A'),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('div',{className:'flex-a-center padding15-10'},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('div',null,__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('p',{className:'font-bd font-16'},'\u5220\u9664\u672C\u4ED3\u5E93'),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('p',{className:'mt10'},'\u5220\u9664\u4ED3\u5E93\u662F\u6C38\u4E45\u6027\u7684, \u65E0\u6CD5\u64A4\u6D88\uFF0C\u4E14\u5220\u9664\u540E\uFF0C\u4E0E\u4ED3\u5E93\u5173\u8054\u7684\u9879\u76EE/\u4EFB\u52A1/\u5408\u5E76\u8BF7\u6C42/\u7248\u672C\u53D1\u5E03\u7B49\uFF0C\u5747\u4F1A\u88AB\u5220\u9664')),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('a',{onClick:this.deleteProject,className:'red_deleteBtn'},'\u5220\u9664\u672C\u4ED3\u5E93'))));}}]);return Setting;}(__WEBPACK_IMPORTED_MODULE_8_react__["Component"]);var WrappedSettingIndexForm=__WEBPACK_IMPORTED_MODULE_3_antd_lib_form___default.a.create({name:'settingForm'})(Setting);/* harmony default export */ __webpack_exports__["default"] = (WrappedSettingIndexForm);
