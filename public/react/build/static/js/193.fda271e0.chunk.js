...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_react_codemirror__ = __webpack_require__(3489);
...
var debounce = __webpack_require__(3490);
var isEqual = __webpack_require__(3491);
var createReactClass = __webpack_require__(978);
...
var CodeMirror = createReactClass({
	...
	getCodeMirrorInstance: function getCodeMirrorInstance() {
		return this.props.codeMirrorInstance || __webpack_require__(1666);
	},
...
(function(mod) {
  if (true) // CommonJS
    mod(__webpack_require__(1666), __webpack_require__(2240), __webpack_require__(3493));
  else if (typeof define == "function" && define.amd) // AMD
