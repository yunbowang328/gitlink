...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_antd_lib_auto_complete_style_css__ = __webpack_require__(1393);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_antd_lib_auto_complete_style_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10_antd_lib_auto_complete_style_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_antd_lib_auto_complete__ = __webpack_require__(1394);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_antd_lib_auto_complete___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11_antd_lib_auto_complete__);
...
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var Option=__WEBPACK_IMPORTED_MODULE_11_antd_lib_auto_complete___default.a.Option;var MENU_LIST=[{id:"Manager",name:'管理员'},{id:"Developer",name:'可写权限'},{id:"Reporter",name:'可读权限'}];var LIMIT=15;var Collaborator=function(_Component){_inherits(Collaborator,_Component);function Collaborator(props){_classCallCheck(this,Collaborator);var _this=_possibleConstructorReturn(this,(Collaborator.__proto__||Object.getPrototypeOf(Collaborator)).call(this,props));_this.componentDidMount=function(){if(_this.props.project_id){var page=_this.state.page;_this.getMember(_this.props.project_id,page);}};_this.componentDidUpdate=function(prevState){if(_this.props.project_id&&_this.props.project_id!==prevState.project_id){var page=_this.state.page;_this.getMember(_this.props.project_id,page);}};_this.getMember=function(project_id,page){var url='/projects/'+project_id+'/members.json';__WEBPACK_IMPORTED_MODULE_14_axios___default.a.get(url,{params:{page:page,limit:LIMIT}}).then(function(result){if(result){_this.setState({listData:result.data.members,isSpin:false,total_count:result.data.total_count});}}).catch(function(error){console.log(error);});};_this.changeInputUser=function(e){_this.getUserList(e);};_this.selectInputUser=function(e,option){_this.setState({user_id:e});_this.getUserList(option.props.children);};_this.getUserList=function(e){var url='/users/list.json';__WEBPACK_IMPORTED_MODULE_14_axios___default.a.get(url,{params:{search:e}}).then(function(result){if(result){_this.setState({userDataSource:result.data.users});}}).catch(function(error){console.log(error);});};_this.addCollaborator=function(){var project_id=_this.props.project_id;var user_id=_this.state.user_id;var url='/projects/'+project_id+'/members.json';__WEBPACK_IMPORTED_MODULE_14_axios___default.a.post(url,{user_id:user_id}).then(function(result){if(result){_this.setState({isSpin:true});_this.getMember(project_id);}}).catch(function(error){console.log(error);});};_this.changeOperaiton=function(e,id){var _this$props=_this.props,project_id=_this$props.project_id,page=_this$props.page;_this.setState({isSpin:true});var url='/projects/'+project_id+'/members/change_role.json';__WEBPACK_IMPORTED_MODULE_14_axios___default.a.put(url,{user_id:id,role:e.key}).then(function(result){if(result){_this.setState({isSpin:true});_this.props.showNotification('权限修改成功!');_this.getMember(project_id,page);}}).catch(function(error){console.log(error);});};_this.deleteUser=function(id){var page=_this.state.page;_this.props.confirm({content:"确认将此成员从项目中移除？",onOk:function onOk(){var project_id=_this.props.project_id;var url='/projects/'+project_id+'/members/remove.json';__WEBPACK_IMPORTED_MODULE_14_axios___default.a.delete(url,{data:{user_id:id}}).then(function(result){if(result){_this.setState({isSpin:true});_this.props.showNotification("成员删除成功！");_this.getMember(project_id,page);}}).catch(function(error){console.log(error);});}});};_this.changePage=function(page){_this.setState({page:page});var project_id=_this.props.project_id;_this.getMember(project_id,page);};_this.state={listData:undefined,user:undefined,user_id:undefined,userDataSource:undefined,page:1,total_count:undefined,isSpin:true};return _this;}// 获取项目协作者
// 输入用户
// 选择用户
// 增加协作者
// 修改权限
// 删除协作者
_createClass(Collaborator,[{key:'render',value:function render(){var _this2=this;var _state=this.state,userDataSource=_state.userDataSource,listData=_state.listData,isSpin=_state.isSpin,page=_state.page,total_count=_state.total_count;// 获取当前项目的拥有者
var author=this.props.author;var menu=function menu(id){return __WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_menu___default.a,null,MENU_LIST.map(function(item,key){return __WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_menu___default.a.Item,{key:item.id,value:item.id,onClick:function onClick(e){return _this2.changeOperaiton(e,id);}},item.name);}));};var source=userDataSource&&userDataSource.map(function(item,key){return __WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement(Option,{key:key,value:''+item.user_id},item.username);});return __WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement('div',null,__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement('div',{className:'normalBox'},__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement('div',{className:'normalBox-title font-16'},'\u534F\u4F5C\u8005'),__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement('div',{className:'addPanel'},__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11_antd_lib_auto_complete___default.a,{dataSource:source,style:{width:200},onChange:this.changeInputUser,onSelect:this.selectInputUser,placeholder:'\u641C\u7D22\u7528\u6237'}),__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement('a',{className:'small_submitBtn ml20',onClick:this.addCollaborator},'\u589E\u52A0\u534F\u4F5C\u8005')),__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_spin___default.a,{spinning:isSpin},__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement('div',{className:'collaboratorList'},listData&&listData.map(function(item,key){var operation=MENU_LIST.filter(function(i){return i.id===item.role;});return __WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement('div',{className:'collaboratorItem'},__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement('span',null,__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13_react_router_dom__["b" /* Link */],{to:'',className:'color-blue'},item.name)),__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement('span',null,author&&author.login===item.login?__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement('label',null,operation&&operation[0].name):__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_dropdown___default.a,{overlay:menu(''+item.id),placement:"bottomCenter"},__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement('span',null,operation&&operation[0].name,__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_icon___default.a,{type:'down'})))),__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement('span',{style:{justifyContent:"center"}},author&&author.login!==item.login&&__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement('a',{className:'red_btn',onClick:function onClick(){return _this2.deleteUser(item.id);}},'\u5220\u9664')));})))),total_count&&total_count>LIMIT?__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement('div',{className:'edu-txt-center mt20 mb20'},__WEBPACK_IMPORTED_MODULE_12_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_pagination___default.a,{showQuickJumper:true,pageSize:LIMIT,current:page,total:total_count,onChange:this.changePage})):"");}}]);return Collaborator;}(__WEBPACK_IMPORTED_MODULE_12_react__["Component"]);/* harmony default export */ __webpack_exports__["default"] = (Collaborator);
