...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_antd_lib_select_style_css__ = __webpack_require__(306);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_antd_lib_select__ = __webpack_require__(302);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__tpm_challengesnew_TPMMDEditor__ = __webpack_require__(319);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__common_formCommon_css__ = __webpack_require__(1316);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__style_css__ = __webpack_require__(1665);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21_react_router_dom__ = __webpack_require__(51);
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}// import City from './City'
// import './board.css'
// import { RouteHOC } from './common.js'
var confirm=__WEBPACK_IMPORTED_MODULE_13_antd_lib_modal___default.a.confirm;var $=window.$;var Option=__WEBPACK_IMPORTED_MODULE_11_antd_lib_select___default.a.Option;var NAME_COUNT=60;// 新建毕设选题
...
var GraduateTopicNew=function(_Component){_inherits(GraduateTopicNew,_Component);function GraduateTopicNew(props){_classCallCheck(this,GraduateTopicNew);var _this=_possibleConstructorReturn(this,(GraduateTopicNew.__proto__||Object.getPrototypeOf(GraduateTopicNew)).call(this,props));_this.getTeacherList=function(){var cid=_this.props.match.params.coursesId;var url='/courses/'+cid+'/graduation_topics/new.json';__WEBPACK_IMPORTED_MODULE_16_axios___default.a.get(url).then(function(result){if(result.status==200){_this.setState({teacherList:result.data.teacher_list,left_banner_id:result.data.left_banner_id,course_name:result.data.course_name,left_banner_name:result.data.left_banner_name,topic_property_first:result.data.topic_property_first,topic_property_second:result.data.topic_property_second,topic_repeat:result.data.topic_repeat,topic_source:result.data.topic_source,topic_type:result.data.topic_type});console.log("sdfds");console.log(_this.props.current_user&&_this.props.current_user.user_id);_this.props.form.setFieldsValue({tea_id:_this.props.current_user&&_this.props.current_user.user_id});}}).catch(function(error){console.log(error);});};_this.componentDidMount=function(){//新建or编辑
var topicId=_this.props.match.params.topicId;if(topicId==undefined){_this.getTeacherList();}else{_this.getEditInfo();}};_this.getEditInfo=function(){var cid=_this.props.match.params.coursesId;var topicId=_this.props.match.params.topicId;var url='/courses/'+cid+'/graduation_topics/'+topicId+'/edit.json';__WEBPACK_IMPORTED_MODULE_16_axios___default.a.get(url).then(function(result){if(result){_this.setState({left_banner_id:result.data.left_banner_id,course_name:result.data.course_name,left_banner_name:result.data.left_banner_name,teacherList:result.data.teacher_list,topic_property_first:result.data.topic_property_first,topic_property_second:result.data.topic_property_second,topic_repeat:result.data.topic_repeat,topic_source:result.data.topic_source,topic_type:result.data.topic_type,attachments:result.data.attachments,addonAfter:parseInt(result.data.selected_data.name.length)});_this.props.form.setFieldsValue({tea_id:result.data.selected_data.tea_id,name:result.data.selected_data.name,city:[result.data.selected_data.province,result.data.selected_data.city],topic_type:result.data.selected_data.topic_type||undefined,topic_source:result.data.selected_data.topic_source||undefined,topic_property_first:result.data.selected_data.topic_property_first||undefined,topic_property_second:result.data.selected_data.topic_property_second||undefined,source_unit:result.data.selected_data.source_unit,topic_repeat:result.data.selected_data.topic_repeat||undefined});_this.mdRef.current.setValue(result.data.selected_data.description);var _fileList=result.data.attachments.map(function(item){return{id:item.id,uid:item.id,name:item.title,url:item.url,status:'done'};});_this.setState({fileList:_fileList,cityDefaultValue:[result.data.selected_data.province,result.data.selected_data.city]});}}).catch(function(error){console.log(error);});};_this.handleSubmit=function(e){e.preventDefault();var cid=_this.props.match.params.coursesId;var topicId=_this.props.match.params.topicId;// console.log(this.props);
_this.props.form.validateFieldsAndScroll(function(err,values){if(!err){console.log('Received values of form: ',values);if(topicId!=undefined){var editTopic=_this.editTopic;var editUrl='/courses/'+cid+'/graduation_topics/'+topicId+'.json';var attachment_ids=undefined;if(_this.state.fileList){attachment_ids=_this.state.fileList.map(function(item){return item.response?item.response.id:item.id;});}__WEBPACK_IMPORTED_MODULE_16_axios___default.a.put(editUrl,{graduation_topic:Object.assign({},values,{province:values.city==undefined?"":values.city[0],city:values.city==undefined?"":values.city[1]}),attachment_ids:attachment_ids}).then(function(response){if(response.status==200){var id=response.data.id;if(id){_this.props.showNotification('保存成功！');_this.props.history.push('/courses/'+cid+'/graduation_topics/'+_this.state.left_banner_id);}}}).catch(function(error){console.log(error);});}else{var url='/courses/'+cid+'/graduation_topics.json';var _attachment_ids=undefined;if(_this.state.fileList){_attachment_ids=_this.state.fileList.map(function(item){return item.response.id;});}__WEBPACK_IMPORTED_MODULE_16_axios___default.a.post(url,{graduation_topic:Object.assign({},values,{province:values.city==undefined?"":values.city[0],city:values.city==undefined?"":values.city[1]}),attachment_ids:_attachment_ids}).then(function(response){if(response.data){var id=response.data.id;if(id){_this.props.showNotification('提交成功！');_this.props.history.push('/courses/'+cid+'/graduation_topics/'+_this.state.left_banner_id);}}}).catch(function(error){console.log(error);});}}else{$("html").animate({scrollTop:$('html').scrollTop()-100});}});};_this.ChangeCity=function(value,selectedOptions){console.log(selectedOptions);};_this.handleChange=function(info){if(info.file.status==='uploading'||info.file.status==='done'||info.file.status==='removed'){var fileList=info.fileList;_this.setState({fileList:fileList});}};_this.onAttachmentRemove=function(file){if(!file.percent||file.percent==100){_this.props.confirm({content:'确定要删除这个附件吗?',okText:'确定',cancelText:'取消',// content: 'Some descriptions',
onOk:function onOk(){_this.deleteAttachment(file);},onCancel:function onCancel(){console.log('Cancel');}});return false;}};_this.deleteAttachment=function(file){console.log(file);var id=file.response==undefined?file.id:file.response.id;var url='/attachments/'+id+'.json';__WEBPACK_IMPORTED_MODULE_16_axios___default.a.delete(url,{}).then(function(response){if(response.data){var status=response.data.status;if(status==0){console.log('--- success');_this.setState(function(state){var index=state.fileList.indexOf(file);var newFileList=state.fileList.slice();newFileList.splice(index,1);return{fileList:newFileList};});}}}).catch(function(error){console.log(error);});};_this.changeTopicName=function(e){// let num= 60 - parseInt(e.target.value.length);
_this.setState({addonAfter:e.target.value.length});};_this.mdRef=__WEBPACK_IMPORTED_MODULE_14_react___default.a.createRef();_this.state={fileList:[],boards:[],teacherList:[],topic_property_first:[],topic_property_second:[],topic_repeat:[],topic_source:[],topic_type:[],attachments:undefined,addonAfter:0,left_banner_id:undefined,course_name:undefined};return _this;}// 获取老师列表
//编辑，信息显示
// 选择省市
// 附件相关 START
// 附件相关 ------------ END
_createClass(GraduateTopicNew,[{key:'render',value:function render(){var _this2=this;var _state=this.state,fileList=_state.fileList,teacherList=_state.teacherList,topic_property_first=_state.topic_property_first,topic_property_second=_state.topic_property_second,topic_repeat=_state.topic_repeat,topic_source=_state.topic_source,topic_type=_state.topic_type,addonAfter=_state.addonAfter,left_banner_id=_state.left_banner_id,course_name=_state.course_name,left_banner_name=_state.left_banner_name;var current_user=this.props.current_user;var getFieldDecorator=this.props.form.getFieldDecorator;var _props$match$params=this.props.match.params,topicId=_props$match$params.topicId,coursesId=_props$match$params.coursesId;// console.log(this.props);
...
action:''+Object(__WEBPACK_IMPORTED_MODULE_17_educoder__["R" /* getUploadActionUrl */])(),onChange:this.handleChange,onRemove:this.onAttachmentRemove,beforeUpload:function beforeUpload(file){console.log('beforeUpload',file.name);var isLt150M=file.size/1024/1024<150;if(!isLt150M){_this2.props.showNotification('文件大小必须小于150MB!');}return isLt150M;}};// console.log("dfsf");
// console.log(this.props);
document.title=course_name===undefined?"":course_name;return __WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{className:'newMain '},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('style',null,'\n          .courseForm .ant-form-item-label{\n            margin-left:unset!important\n          }\n          '),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{className:'edu-class-container edu-position courseForm'},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('p',{className:'clearfix mb20 mt10'},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_17_educoder__["A" /* WordsBtn */],{style:'grey',className:'fl',to:current_user&&current_user.first_category_url},course_name),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',{className:'color-grey-9 fl ml3 mr3'},'>'),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_17_educoder__["A" /* WordsBtn */],{style:'grey',className:'fl',to:'/courses/'+coursesId+'/graduation_topics/'+left_banner_id},left_banner_name),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',{className:'color-grey-9 fl ml3 mr3'},'>'),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',null,topicId==undefined?"新建":"编辑")),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{className:'clearfix mb20 lineh-25'},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('p',{className:'fl color-black summaryname'},topicId==undefined?"新建":"编辑",'\u6BD5\u8BBE\u9009\u9898'),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_21_react_router_dom__["b" /* Link */],{to:'/courses/'+coursesId+'/graduation_topics/'+left_banner_id,className:'color-grey-6 fr font-16'},'\u8FD4\u56DE')),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a,Object.assign({},formItemLayout,{onSubmit:this.handleSubmit}),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{className:'createPage'},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{label:'\u6307\u5BFC\u8001\u5E08'},getFieldDecorator('tea_id',{rules:[{required:true,message:'请选择指导老师'}]})(__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11_antd_lib_select___default.a,{style:{"width":"20%"},placeholder:'\u8BF7\u9009\u62E9\u6307\u5BFC\u8001\u5E08'},teacherList&&teacherList.map(function(item,key){return __WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(Option,{value:item.id,id:key},item.name);})))),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('style',null,'\n                .exercicenewinputysl .ant-input{\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tborder-right: none !important;\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\theight: 40px !important;\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t}\n                \n                '),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{label:'\u9009\u9898\u540D\u79F0',className:'mt15'},getFieldDecorator('name',{rules:[{required:true,message:'请输入选题名称'},{max:60,message:'最大限制为60个字符'}]})(__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_input___default.a,{placeholder:'\u8BF7\u8F93\u5165\u5E16\u5B50\u9009\u9898\u540D\u79F0\uFF0C\u6700\u5927\u9650\u523660\u4E2A\u5B57\u7B26',maxLength:'60',onInput:this.changeTopicName,autoComplete:'off',addonAfter:String(addonAfter)+'/'+NAME_COUNT,className:'searchViewAfter exercicenewinputysl'})))),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('style',null,'\n                .courseMessageMD {\n                  width: 1140px;\n                }\n                \n                .uploadBtn.ant-btn {\n                  border: none;\n                  color: #4CACFF;\n                  box-shadow: none;\n                  background: transparent;\n                  padding: 0 6px;\n                }\n                .upload_1 .ant-upload-list {\n                  width: 350px;\n                  margin-bottom:10px;\n                }\n                .ant-upload-list-item{\n                  margin-top:0px!important;\n                }\n\n                .ant-form-item-children{\n                  position:unset\n                }\n                .rememberTip{\n                  position:absolute;\n                  right:0px;\n                  bottom:-10px;\n                }\n                .chooseDes .ant-form-explain{\n                  position:absolute;\n                  bottom:-10px;\n                  left:0px;\n                }\n                .setUploadStyle .uploadBtn{\n                  height:20px;\n                  line-height:20px;\n                }\n                .setUploadStyle .ant-form-item-control{\n                  margin-top:15px!important;\n                  line-height:22px!important;\n                }\n                .setUploadStyle .ant-upload-list{\n                  margin-top:5px;\n                }\n                \n              '),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{className:'createPage'},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{label:'\u9009\u9898\u7B80\u4ECB',style:{"borderBottom":'none'},className:'chooseDes pr'},getFieldDecorator('description',{rules:[{required:true,message:'请输入选题简介'},{max:5000,message:'最大限制为5000个字符'}]})(__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_15__tpm_challengesnew_TPMMDEditor__["a" /* default */],{ref:this.mdRef,placeholder:'请简要说明选题内容，最大限制5000个字符',mdID:'courseMessageMD',initValue:this.editTopic?this.editTopic.content:'',className:'courseMessageMD'}))),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{className:'setUploadStyle'},getFieldDecorator('file',{rules:[{required:false}]})(__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_upload___default.a,Object.assign({},uploadProps,{className:'upload_1 '}),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_button___default.a,{className:'uploadBtn'},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_icon___default.a,{type:'upload'}),' \u4E0A\u4F20\u9644\u4EF6'),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('span',{className:'color-grey-c'},'(\u5355\u4E2A\u6587\u4EF6150M\u4EE5\u5185)')))),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{className:'clearfix'},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{className:'fl mr20 with20',style:{"marginRight":"20px"}},getFieldDecorator('topic_type',{rules:[{required:false,message:''}]})(__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11_antd_lib_select___default.a,{placeholder:'\u8BF7\u9009\u62E9\u9009\u9898\u7C7B\u578B'},topic_type&&topic_type.map(function(item,key){return __WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(Option,{value:item.id,key:key},item.name);})))),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{className:'fl mr20 with20',style:{"marginRight":"20px"}},getFieldDecorator('topic_source',{rules:[{required:false,message:''}]})(__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11_antd_lib_select___default.a,{placeholder:'\u8BF7\u8F93\u5165\u9009\u9898\u6765\u6E90'},topic_source&&topic_source.map(function(item,key){return __WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(Option,{value:item.id,key:key},item.name);})))),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{className:'fl mr20 with20',style:{"marginRight":"20px"}},getFieldDecorator('topic_property_first',{rules:[{required:false,message:''}]})(__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11_antd_lib_select___default.a,{placeholder:'\u8BF7\u8F93\u5165\u9009\u9898\u6027\u8D281'},topic_property_first&&topic_property_first.map(function(item,key){return __WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(Option,{value:item.id,key:key},item.name);})))),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{className:'fl mr20 with20',style:{"marginRight":"20px"}},getFieldDecorator('topic_property_second',{rules:[{required:false,message:''}]})(__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11_antd_lib_select___default.a,{placeholder:'\u8BF7\u8F93\u5165\u9009\u9898\u6027\u8D282'},topic_property_second&&topic_property_second.map(function(item,key){return __WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(Option,{value:item.id,key:key},item.name);})))))),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('style',null,'\n                .courseForm .flexBlock.formBlock {\n                  align-items: flex-end;\n                  display: flex;\n                  flex-wrap: wrap;\n                }\n                .courseForm .flexBlock .tag {\n                  margin-left: 8px;\n                  margin-right: 6px;\n                  margin-bottom: 16px;\n                }\n                .flexBlock .ant-row.ant-form-item {\n                  margin-bottom: 6px;\n                }\n                .ant-cascader-menu{\n                  min-width:125px!important;\n                }\n              '),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{className:'createPage',style:{"borderBottom":"none"}},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{label:'\u9009\u9898\u6765\u6E90\u5355\u4F4D',className:'with22'},getFieldDecorator('source_unit',{rules:[{required:false,message:''}]})(__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_input___default.a,{placeholder:'\u8BF7\u586B\u5199\u6765\u6E90\u5355\u4F4D',autoComplete:'off',className:'searchView'}))),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{label:'\u9009\u62E9\u91CD\u590D\u60C5\u51B5',className:'mt15 with22'},getFieldDecorator('topic_repeat',{rules:[{required:false,message:''}]})(__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11_antd_lib_select___default.a,{placeholder:'\u8BF7\u9009\u62E9\u9009\u9898\u91CD\u590D\u60C5\u51B5'},topic_repeat&&topic_repeat.map(function(item,key){return __WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(Option,{value:item.id,key:key},item.name);})))),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{label:'\u8C03\u7814\u6216\u5B9E\u4E60\u5730\u70B9',className:'mt15 with22 setAreaStyle'},getFieldDecorator('city',{rules:[{initialValue:this.state.cityDefaultValue,type:'array',required:false,message:''}]})(__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_17_educoder__["e" /* City */],null)))),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,null,__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{className:'clearfix mt30 mb30'},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_button___default.a,{type:'primary',htmlType:'submit',className:'defalutSubmitbtn fl mr20'},topicId==undefined?"提交":"保存"),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('a',{className:'defalutCancelbtn fl',onClick:function onClick(){return _this2.props.history.goBack();}},'\u53D6\u6D88'))))));}}]);return GraduateTopicNew;}(__WEBPACK_IMPORTED_MODULE_14_react__["Component"]);var WrappedGraduateTopicNew=__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.create({name:'topicPostWorksNew'})(GraduateTopicNew);// RouteHOC()
/* harmony default export */ __webpack_exports__["default"] = (WrappedGraduateTopicNew);
