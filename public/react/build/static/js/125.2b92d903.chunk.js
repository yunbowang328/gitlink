...
// module
exports.push([module.i, ".branchDropdown{border:1px solid #eee;border-radius:4px;display:-ms-flexbox;display:flex;-ms-flex-pack:center;justify-content:center;height:35px;line-height:35px;width:150px}.branchDropdown .ant-dropdown-trigger{width:100%;text-align:center}.branchOptions{width:200px;padding:10px;-webkit-box-shadow:0 0 1px 1px hsla(0,0%,53%,.1);box-shadow:0 0 1px 1px hsla(0,0%,53%,.1);border-radius:3px;background:#fff;max-height:200px}.OptionsUl{max-height:200px;overflow-y:auto;margin-top:10px}.OptionsUl li{height:30px;cursor:pointer}.OptionsUl li a{display:block;padding:4px}.OptionsInput{height:32px;padding-left:4px;line-height:32px;width:100%}", "", {"version":3,"sources":["/Users/hs/forgeplus-react/src/forge/Branch/branch.css"],"names":[],"mappings":"AAAA,gBACE,sBAAsB,AACtB,kBAAmB,AACnB,oBAAqB,AACrB,aAAc,AACd,qBAAsB,AAClB,uBAAwB,AAC5B,YAAa,AACb,iBAAkB,AAClB,WAAa,CACd,AACD,sCACE,WAAY,AACZ,iBAAmB,CACpB,AACD,eACE,YAAa,AACb,aAAa,AACb,iDAA6D,AACrD,yCAAqD,AAC7D,kBAAmB,AACnB,gBAAiB,AACjB,gBAAkB,CACnB,AACD,WACE,iBAAkB,AAClB,gBAAiB,AACjB,eAAiB,CAClB,AACD,cACE,YAAa,AAEb,cAAgB,CACjB,AACD,gBACE,cAAe,AACf,WAAa,CAEd,AACD,cACE,YAAa,AACb,iBAAkB,AAClB,iBAAkB,AAClB,UAAY,CACb","file":"branch.css","sourcesContent":[".branchDropdown{\n  border:1px solid #eee;\n  border-radius: 4px;\n  display: -ms-flexbox;\n  display: flex;\n  -ms-flex-pack: center;\n      justify-content: center;\n  height: 35px;\n  line-height: 35px;\n  width: 150px;\n}\n.branchDropdown .ant-dropdown-trigger{\n  width: 100%;\n  text-align: center;\n}\n.branchOptions{\n  width: 200px;\n  padding:10px;\n  -webkit-box-shadow: 0px 0px 1px 1px rgba(134, 134, 134, 0.1);\n          box-shadow: 0px 0px 1px 1px rgba(134, 134, 134, 0.1);\n  border-radius: 3px;\n  background: #fff;\n  max-height: 200px;\n}\n.OptionsUl{\n  max-height: 200px;\n  overflow-y: auto;\n  margin-top: 10px;\n}\n.OptionsUl li{\n  height: 30px;\n  /*line-height: 22px;*/\n  cursor: pointer;\n}\n.OptionsUl li a{\n  display: block;\n  padding: 4px;\n  /*padding-left: 2px;*/\n}\n.OptionsInput{\n  height: 32px;\n  padding-left: 4px;\n  line-height: 32px;\n  width: 100%;\n}"],"sourceRoot":""}]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_antd_lib_dropdown_style_css__ = __webpack_require__(1016);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_antd_lib_dropdown__ = __webpack_require__(987);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_antd_lib_icon_style_css__ = __webpack_require__(183);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_antd_lib_icon__ = __webpack_require__(27);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__branch_css__ = __webpack_require__(2367);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__common_util__ = __webpack_require__(3223);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__Branch_SelectBranch__ = __webpack_require__(3565);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__DetailTop__ = __webpack_require__(3221);
