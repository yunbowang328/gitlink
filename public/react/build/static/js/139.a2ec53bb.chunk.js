...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__css_index_css__ = __webpack_require__(2568);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__css_index_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_16__css_index_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__new_css__ = __webpack_require__(4877);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__new_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_17__new_css__);
...
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var Option=__WEBPACK_IMPORTED_MODULE_13_antd_lib_select___default.a.Option;var Index=function(_Component){_inherits(Index,_Component);function Index(props){_classCallCheck(this,Index);var _this=_possibleConstructorReturn(this,(Index.__proto__||Object.getPrototypeOf(Index)).call(this,props));_this.getUserInfo=function(){var url='/users/me.json';__WEBPACK_IMPORTED_MODULE_18_axios___default.a.get(url).then(function(result){if(result&&result.data.login){_this.setState({current_user:result.data});_this.getDetail();}}).catch(function(error){console.log(error);});};_this.componentDidMount=function(){// this.getUserInfo();
// 获取项目类别
_this.getCategory();// 获取项目语言
_this.getLanguage();// 获取Gitignore
_this.getGitignore();// 获取开源许可证
_this.getLicenses();};_this.getCategory=function(){var url='/project_categories.json';__WEBPACK_IMPORTED_MODULE_18_axios___default.a.get(url).then(function(result){if(result){var CategoryList=_this.setOptionsList(result.data.project_categories);_this.setState({CategoryList:CategoryList});}}).catch(function(error){});};_this.getLanguage=function(){var url='/project_languages.json';__WEBPACK_IMPORTED_MODULE_18_axios___default.a.get(url).then(function(result){if(result){var LanguageList=_this.setOptionsList(result.data.project_languages);_this.setState({LanguageList:LanguageList});}}).catch(function(error){});};_this.getGitignore=function(){var url='/ignores.json';__WEBPACK_IMPORTED_MODULE_18_axios___default.a.get(url).then(function(result){if(result){var GitignoreList=_this.setOptionsList(result.data.ignores);_this.setState({GitignoreList:GitignoreList});}}).catch(function(error){});};_this.getLicenses=function(){var url='/licenses.json';__WEBPACK_IMPORTED_MODULE_18_axios___default.a.get(url).then(function(result){if(result){var LicensesList=_this.setOptionsList(result.data.licenses);_this.setState({LicensesList:LicensesList});}}).catch(function(error){});};_this.setOptionsList=function(data){var list=undefined;if(data&&data.length>0){list=data.map(function(item,key){return __WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(Option,{key:item.id},item.name);});}return list;};_this.subMitFrom=function(){_this.setState({isSpin:true});_this.props.form.validateFieldsAndScroll(function(err,values){if(!err){var current_user=_this.props.current_user;var projectsType=_this.props.match.params.projectsType;var url=projectsType==="deposit"?"/projects.json":"/projects/migrate.json";__WEBPACK_IMPORTED_MODULE_18_axios___default.a.post(url,Object.assign({},values,{user_id:current_user.user_id})).then(function(result){if(result){if(result.data.id){_this.setState({isSpin:false});_this.props.showNotification((projectsType==="deposit"?"托管":"镜像")+'\u9879\u76EE\u521B\u5EFA\u6210\u529F!');_this.props.history.push('/projects/'+result.data.id+'/coders');}}}).catch(function(error){_this.setState({isSpin:false});console.log(error);});}else{_this.setState({isSpin:false});}});};_this.state={// authorValue:"0",
preType:"0",// subType:"0",
languageValue:"0",gitignoreType:"0",LicensesType:"0",CategoryList:undefined,LanguageList:undefined,GitignoreList:undefined,LicensesList:undefined,isSpin:false};return _this;}_createClass(Index,[{key:'render',value:function render(){var getFieldDecorator=this.props.form.getFieldDecorator;// 项目类型：deposit-托管项目，mirror-镜像项目
var projectsType=this.props.match.params.projectsType;var _state=this.state,preType=_state.preType,languageValue=_state.languageValue,gitignoreType=_state.gitignoreType,LicensesType=_state.LicensesType,CategoryList=_state.CategoryList,LanguageList=_state.LanguageList,GitignoreList=_state.GitignoreList,LicensesList=_state.LicensesList,isSpin=_state.isSpin;console.log("current_user",this.props);return __WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{className:'main back-white'},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{className:'newPanel'},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{className:'newPanel_title'},'\u521B\u5EFA',projectsType==="deposit"?"托管":"镜像",'\u9879\u76EE'),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_spin___default.a,{spinning:isSpin},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a,null,__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{className:'newPanel_content'},projectsType!="deposit"&&__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_14_react___default.a.Fragment,null,__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{label:'\u955C\u50CF\u7248\u672C\u5E93\u5730\u5740',style:{marginBottom:"0px"}},getFieldDecorator('clone_addr',{rules:[{required:true,message:'请填写镜像版本库地址'}]})(__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11_antd_lib_input___default.a,{placeholder:'\u8F93\u5165\u9700\u8981\u540C\u6B65\u5230\u672C\u9879\u76EE\u7684\u955C\u50CF\u7248\u672C\u5E93\u5730\u5740'}))),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('p',{className:'formTip'},'\u793A\u4F8B\uFF1Ahttps://github.com/facebook/reack.git')),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{label:'\u9879\u76EE\u540D\u79F0'},getFieldDecorator('name',{rules:[{required:true,message:'请填写项目名称'}]})(__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11_antd_lib_input___default.a,{placeholder:'\u4F8B\u5982\uFF1A\u56E2\u961F\u534F\u4F5C\u65B9\u6CD5\u4E0E\u7814\u7A76'}))),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{label:'\u9879\u76EE\u7B80\u4ECB'},getFieldDecorator('description',{rules:[{required:true,message:'请填写项目简介'}]})(__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11_antd_lib_input___default.a.TextArea,{autoSize:{minRows:2,maxRows:6}}))),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{label:'\u4ED3\u5E93\u540D\u79F0',style:{marginBottom:"0px"}},getFieldDecorator('repository_name',{rules:[{required:true,message:'请填写仓库名称'}]})(__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11_antd_lib_input___default.a,{placeholder:'\u8BF7\u8F93\u5165\u4ED3\u5E93\u540D\u79F0'}))),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('p',{className:'formTip'},'\u597D\u7684\u5B58\u50A8\u5E93\u540D\u79F0\u4F7F\u7528\u7B80\u5355\u3001\u6DF1\u523B\u548C\u72EC\u7279\u7684\u5173\u952E\u5B57'),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{label:'\u9879\u76EE\u7C7B\u522B'},getFieldDecorator('project_category_id',{rules:[{required:true,message:'请选择大类别'}]})(__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13_antd_lib_select___default.a,{value:preType},CategoryList))),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{label:'\u9879\u76EE\u8BED\u8A00'},getFieldDecorator('project_language_id',{rules:[{required:true,message:'请选择项目语言'}]})(__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13_antd_lib_select___default.a,{value:languageValue},LanguageList)))),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_divider___default.a,null),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('div',{className:'newPanel_content'},projectsType==="deposit"&&__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_14_react___default.a.Fragment,null,__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{label:'.gitignore'},getFieldDecorator('ignore_id')(__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13_antd_lib_select___default.a,{value:gitignoreType,className:'inline_Tag'},GitignoreList))),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{label:'\u5F00\u6E90\u8BB8\u53EF\u8BC1'},getFieldDecorator('license_id')(__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13_antd_lib_select___default.a,{value:LicensesType,className:'inline_Tag'},LicensesList)))),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{label:'\u53EF\u89C1\u6027',style:{marginBottom:"0px"}},getFieldDecorator('private')(__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_checkbox___default.a,{value:'limit'},'\u5C06\u9879\u76EE\u8BBE\u4E3A\u79C1\u6709'))),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement('p',{className:'formTip'},'\u53EA\u6709\u4F01\u4E1A\u6240\u6709\u4EBA\u6216\u62E5\u6709\u6743\u9650\u7684\u4F01\u4E1A\u6210\u5458\u624D\u80FD\u770B\u5230'),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.Item,{className:'formTip'},__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_button___default.a,{type:'primary',onClick:this.subMitFrom,className:'mr20'},'\u521B\u5EFA\u9879\u76EE'),__WEBPACK_IMPORTED_MODULE_14_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_15_react_router_dom__["b" /* Link */],{to:'/projects',className:'btn_32'},'\u53D6\u6D88')))))));}}]);return Index;}(__WEBPACK_IMPORTED_MODULE_14_react__["Component"]);var WrappedIndexForm=__WEBPACK_IMPORTED_MODULE_9_antd_lib_form___default.a.create({name:'NewWorkForm'})(Index);/* harmony default export */ __webpack_exports__["default"] = (WrappedIndexForm);
