...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_antd_lib_popconfirm_style_css__ = __webpack_require__(1536);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_antd_lib_popconfirm__ = __webpack_require__(1535);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__Order_Nav__ = __webpack_require__(1670);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__Upload_Index__ = __webpack_require__(1867);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_educoder__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__modules_courses_coursesPublic_NoneData__ = __webpack_require__(334);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__Upload_attachment__ = __webpack_require__(2375);
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var TextArea=__WEBPACK_IMPORTED_MODULE_7_antd_lib_input___default.a.TextArea;var Option=__WEBPACK_IMPORTED_MODULE_5_antd_lib_select___default.a.Option;var UpdateMerge=function(_Component){_inherits(UpdateMerge,_Component);function UpdateMerge(props){_classCallCheck(this,UpdateMerge);var _this=_possibleConstructorReturn(this,(UpdateMerge.__proto__||Object.getPrototypeOf(UpdateMerge)).call(this,props));_this.componentDidMount=function(){_this.InitData();_this.getDetail();//this.getSelectList();
};_this.InitData=function(){// this.props.form.setFieldsValue({
//   ...this.state
// });
};_this.getDetail=function(){var _this$props$match$par=_this.props.match.params,projectsId=_this$props$match$par.projectsId,mergeId=_this$props$match$par.mergeId;var url='/projects/'+projectsId+'/pull_requests/'+mergeId+'/edit.json';__WEBPACK_IMPORTED_MODULE_10_axios___default.a.get(url).then(function(result){if(result){_this.setState({data:result.data,subject:result.data.issue.subject,issue_chosen:result.data.issue.issue_chosen,branches:result.data.issue.branches,tracker_id:result.data.issue.tracker_id,issue_type:result.data.issue.issue_type,status_id:result.data.issue.status_id,priority_id:result.data.issue.priority_id,done_ratio:result.data.issue.done_ratio,textcount:result.data.issue.description,branch_name:result.data.issue.branch_name,get_attachments:result.data.issue.attachments,fileList:undefined,issue_tag_ids:result.data.issue.issue_tags&&result.data.issue.issue_tags[0].id,fixed_version_id:result.data.issue.fixed_version_id,assigned_to_id:result.data.issue.assigned_to_id});// this.getjournalslist();
}}).catch(function(error){console.log(error);});};_this.handleok=function(){_this.setState({isShow:false});};_this.handleCancel=function(){_this.setState({isShow:false});};_this.imgshow=function(){_this.setState({isShow:true});};_this.changmodelname=function(e){_this.setState({subject:e.target.value});};_this.changmodelcount=function(e){_this.setState({textcount:e.target.value});};_this.renderSelect=function(list){if(list&&list.length>0){return list.map(function(item,key){return __WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(Option,{key:key+1,value:item.id},item.name);});}};_this.UploadFunc=function(fileList){_this.setState({fileList:fileList});};_this.handleSubmit=function(){var fileList=_this.state.fileList;_this.props.form.validateFieldsAndScroll(function(err,values){if(!err){var _this$props$match$par2=_this.props.match.params,projectsId=_this$props$match$par2.projectsId,mergeId=_this$props$match$par2.mergeId;var _this$state=_this.state,subject=_this$state.subject,data=_this$state.data;var url='/projects/'+projectsId+'/pull_requests/'+mergeId+'.json';if(values.issue_tag_ids===''){values.issue_tag_ids=[];}else{}if(values.assigned_to_id===0){values.assigned_to_id="";}__WEBPACK_IMPORTED_MODULE_10_axios___default.a.put(url,Object.assign({project_id:projectsId,id:data.issue.id,attachment_ids:fileList},values)).then(function(result){if(result){_this.props.history.push('/projects/'+projectsId+'/merge');}}).catch(function(error){console.log(error);});}});};_this.state={data:undefined,isShow:false,imgsrc:'',journalsdata:undefined,//图片区域是否显示 none 隐藏 block 显示
display:'none',titledisplay:'none',subject:'',branch_name:"",issue_tag_ids:"",fixed_version_id:"",tracker_id:0,issue_type:0,status_id:0,assigned_to_id:"",priority_id:0,done_ratio:0,textcount:"",fileList:undefined,get_attachments:undefined};return _this;}// 获取上传后的文件id数组
_createClass(UpdateMerge,[{key:'render',value:function render(){var _props$match$params=this.props.match.params,projectsId=_props$match$params.projectsId,mergeId=_props$match$params.mergeId;var getFieldDecorator=this.props.form.getFieldDecorator;var current_user=this.props.current_user;var _state=this.state,issue_tag_ids=_state.issue_tag_ids,fixed_version_id=_state.fixed_version_id,branch_name=_state.branch_name,status_id=_state.status_id,tracker_id=_state.tracker_id,issue_type=_state.issue_type,assigned_to_id=_state.assigned_to_id,priority_id=_state.priority_id,done_ratio=_state.done_ratio,issue_chosen=_state.issue_chosen,branches=_state.branches,subject=_state.subject,textcount=_state.textcount,get_attachments=_state.get_attachments;return __WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('div',{className:'main'},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('div',{className:'topWrapper'},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11__Order_Nav__["a" /* default */],Object.assign({},this.props,this.state))),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('div',null,__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_form___default.a,null,__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('div',{className:'f-wrap-between mt20',style:{alignItems:"flex-start"}},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('div',{className:'list-right df'},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_react_router_dom__["b" /* Link */],{to:''},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('img',{'class':'user_img',src:Object(__WEBPACK_IMPORTED_MODULE_13_educoder__["M" /* getImageUrl */])('images/'+(current_user&&current_user.image_url)),alt:''})),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('div',{className:'new_context'},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_form___default.a.Item,null,getFieldDecorator('title',{rules:[{required:true,message:'请填写工单标题'}],initialValue:subject})(__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_input___default.a,{placeholder:'\u6807\u9898',onChange:this.changmodelname}))),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_form___default.a.Item,null,getFieldDecorator('body',{rules:[],initialValue:textcount})(__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(TextArea,{placeholder:'\u8BF7\u8F93\u5165\u5DE5\u5355\u7684\u63CF\u8FF0...',style:{height:"300px"},onChange:this.changmodelcount}))),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_12__Upload_Index__["a" /* default */],{load:this.UploadFunc,showNotification:this.props.showNotification,isComplete:true}),get_attachments?__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_15__Upload_attachment__["a" /* default */],{attachments:get_attachments,showNotification:this.props.showNotification,canDelete:true}):"",__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('p',{className:'clearfix mt15 text-right'},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('a',{className:'topWrapper_btn fr',type:'submit',style:{marginLeft:5},onClick:this.handleSubmit},'\u4FDD\u5B58'),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_react_router_dom__["b" /* Link */],{to:'/projects/'+projectsId+'/merge/'+mergeId+'/Messagecount',className:'a_btn cancel_btn fr'},'\u53D6\u6D88')))),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('div',{className:'list-left',style:{paddingRight:"0px",paddingLeft:"15px",paddingTop:"10px"}},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('div',{className:'list-l-panel'},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_form___default.a.Item,{label:'\u6807\u7B7E'},getFieldDecorator('issue_tag_ids',{initialValue:issue_tag_ids?[issue_tag_ids]:'',rules:[]})(__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_select___default.a,null,__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(Option,{value:''},'\u672A\u9009\u62E9\u6807\u7B7E'),this.renderSelect(issue_chosen&&issue_chosen.issue_tag)))),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_form___default.a.Item,{label:'\u91CC\u7A0B\u7891'},getFieldDecorator('fixed_version_id',{initialValue:fixed_version_id?fixed_version_id:"",rules:[]})(__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_select___default.a,null,__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(Option,{value:''},'\u672A\u9009\u62E9\u91CC\u7A0B\u7891'),this.renderSelect(issue_chosen&&issue_chosen.issue_version)))),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_form___default.a.Item,{label:'\u6307\u6D3E\u6210\u5458'},getFieldDecorator('assigned_to_id',{initialValue:assigned_to_id?assigned_to_id:""})(__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_select___default.a,null,__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(Option,{value:''},'\u672A\u6307\u6D3E\u6210\u5458'),this.renderSelect(issue_chosen&&issue_chosen.assign_user))))))))),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_modal___default.a,{onCancel:this.handleCancel,visible:this.state.isShow,width:'400px',footer:[],bodyStyle:{textAlign:'center'}},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement('img',{'class':'list_img',src:'https://ss1.bdstatic.com/70cFuXSh_Q1YnxGkpoWK1HF6hhy/it/u=1608431072,669449145&fm=27&gp=0.jpg',alt:''})));}}]);return UpdateMerge;}(__WEBPACK_IMPORTED_MODULE_8_react__["Component"]);var UpdateMergeForm=__WEBPACK_IMPORTED_MODULE_3_antd_lib_form___default.a.create({name:'UpdateMergeForm'})(UpdateMerge);/* harmony default export */ __webpack_exports__["default"] = (UpdateMergeForm);
