...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__usersInfo_css__ = __webpack_require__(1599);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__usersInfo_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10__usersInfo_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_moment__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_moment___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11_moment__);
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var categorylist=[{name:"全部",value:undefined},{name:"前端开发",value:"front"},{name:"后端开发",value:"backend"},{name:"移动开发",value:"mobile"},{name:"数据库",value:"database"},{name:"云计算和大数据",value:"cloud_compute_and_big_data"},{name:"人工智能",value:"ai"},{name:"运维与测试",value:"devops_and_test"},{name:"其他",value:"other"}];//
function setcategorylist(val){var vals="";categorylist.some(function(item,key){if(item.name===val){vals=item.value;return true;}});return vals;}var InfosPackage=function(_Component){_inherits(InfosPackage,_Component);function InfosPackage(props){_classCallCheck(this,InfosPackage);var _this=_possibleConstructorReturn(this,(InfosPackage.__proto__||Object.getPrototypeOf(InfosPackage)).call(this,props));_this.componentDidMount=function(){_this.setState({isSpin:true});var _this$state=_this.state,category=_this$state.category,status=_this$state.status,page=_this$state.page;_this.getCourses(category,status,page);};_this.getCourses=function(category,status,page){var url='/users/'+_this.props.match.params.username+'/project_packages.json';__WEBPACK_IMPORTED_MODULE_7_axios___default.a.get(url,{params:{category:category,status:status,page:page,sort_by:"published_at",sort_direction:'desc',per_page:20}}).then(function(result){if(result){_this.setState({totalCount:result.data.count,data:result.data,isSpin:false});}}).catch(function(error){console.log(error);});};_this.changeCategory=function(cate){_this.setState({category:cate,page:1,isSpin:true});var status=_this.state.status;_this.getCourses(cate,status,1);};_this.changeStatus=function(status){_this.setState({status:status,page:1,isSpin:true});var category=_this.state.category;_this.getCourses(category,status,1);};_this.changePage=function(page){_this.setState({page:page,isSpin:true});var _this$state2=_this.state,category=_this$state2.category,status=_this$state2.status;_this.getCourses(category,status,page);};_this.turnToCourses=function(url,flag){if(flag){_this.props.history.push(url);}};_this.delectprojectModal=function(id){_this.setState({Modalstype:true,Modalstopval:'是否确认删除?',ModalSave:function ModalSave(){return _this.delectproject(id);},ModalCancel:_this.cancelProject});};_this.cancelProject=function(){_this.setState({Modalstype:false});};_this.delectproject=function(id){var _this$state3=_this.state,category=_this$state3.category,status=_this$state3.status;debugger;var url='/project_packages/'+id+'.json';__WEBPACK_IMPORTED_MODULE_7_axios___default.a.delete(url).then(function(response){if(response.data.status==0){_this.getCourses(category,status,1);}}).catch(function(error){console.log(error);});_this.cancelProject();};_this.state={category:undefined,status:undefined,page:1,per_page:20,sort_direction:'desc',totalCount:undefined,data:undefined,isSpin:false};return _this;}//切换种类
//切换状态
//切换页数
// 进入课堂
_createClass(InfosPackage,[{key:'render',value:function render(){var _this2=this;var _state=this.state,category=_state.category,status=_state.status,page=_state.page,data=_state.data,totalCount=_state.totalCount,isSpin=_state.isSpin;var is_current=this.props.is_current;// console.log(data)
return __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'educontent mb50'},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_8__modals_Modals__["a" /* default */],{modalsType:this.state.Modalstype,modalsTopval:this.state.Modalstopval,modalCancel:this.state.ModalCancel,modalSave:this.state.ModalSave}),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_spin___default.a,{size:'large',spinning:isSpin},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('style',null,'\n             .whitepanelyslli {\n                width: 32px !important;\n             height: 48px !important;\n              line-height: 46px !important;\n             }\n              .whitepanelyslliss {\n                width: 32px !important;\n                  height: 48px !important;\n              line-height: 46px !important;\n             }\n            \n              .whitepanelysllis {\n             width: 66px !important;\n              height: 48px !important;\n              line-height: 46px !important;\n              margin-left: 40px !important;\n              }\n              .white-panel li.active {\n                  border-radius: 24px;\n                  border: none !important;\n                  color: #4CACFF;\n              }\n              \n            \n              \n              '),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'white-panel edu-back-white pt20 pb20 clearfix '},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('li',{className:category?" font-16 whitepanelyslli":"active font-16 whitepanelyslli"},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('a',{href:'javascript:void(0)',onClick:function onClick(){return _this2.changeCategory();},className:'font-16 w32'},'\u5168\u90E8')),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('li',{className:category=="manage"?"active font-16 whitepanelysllis":"font-16 whitepanelysllis"},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('a',{href:'javascript:void(0)',onClick:function onClick(){return _this2.changeCategory("manage");},className:'font-16 w66'},is_current?"我":"TA",'\u7BA1\u7406\u7684')),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('li',{className:category=="study"?"active font-16 whitepanelysllis":"font-16 whitepanelysllis"},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('a',{href:'javascript:void(0)',onClick:function onClick(){return _this2.changeCategory("study");},className:'font-16 w66'},is_current?"我":"TA",'\u5B66\u4E60\u7684'))),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('style',null,'  .secondNavs li {\n                color: #676767;\n                /* margin: 0px 20px; */\n                float: left;\n             }\n             .secondNavs li a:hover{\n             color: #4CACFF\n             }\n             .secondNavs li.active a{\n             color: #4CACFF\n             }\n             '),category=="manage"?__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'edu-back-white padding10-30 clearfix secondNavs bor-top-greyE'},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('li',{className:status?"whitepanelyslliss":"active whitepanelyslliss"},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('a',{onClick:function onClick(){return _this2.changeStatus();},className:'w32'},'\u5168\u90E8')),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('li',{className:status=="unpublished "?"active whitepanelysllisyt":"whitepanelysllisyt"},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('a',{onClick:function onClick(){return _this2.changeStatus("unpublished");},className:'w60'},'\u672A\u53D1\u5E03')),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('li',{className:status=="bidding"?"active whitepanelysllisyt":"whitepanelysllisyt"},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('a',{onClick:function onClick(){return _this2.changeStatus("bidding");},className:'w60'},'\u7ADE\u6807\u4E2D')),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('li',{className:status=="finished"?"active whitepanelysllisyt":"whitepanelysllisyt"},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('a',{onClick:function onClick(){return _this2.changeStatus("finished");},className:'w60'},'\u5DF2\u5B8C\u6210'))):category=="bidden"?__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'edu-back-white padding10-30 clearfix secondNavs bor-top-greyE'},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('li',{className:status?"whitepanelyslliss":"active whitepanelyslliss"},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('a',{onClick:function onClick(){return _this2.changeStatus();},className:'w32'},'\u5168\u90E8')),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('li',{className:status=="bidding_lost"?"active whitepanelysllisyt":"whitepanelysllisyt"},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('a',{onClick:function onClick(){return _this2.changeStatus("bidding_lost");},className:'w60'},'\u672A\u4E2D\u6807')),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('li',{className:status=="bidding_won"?"active whitepanelysllisyt":"whitepanelysllisyt"},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('a',{onClick:function onClick(){return _this2.changeStatus("bidding_won");},className:'w60'},'\u5DF2\u4E2D\u6807'))):"",__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('p',{className:'pl25 pr25 clearfix font-12 mb20 mt20'},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('span',{className:'fl color-grey-9'},'\u5171',totalCount,'\u4E2A'),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('span',{className:'fr color-grey-9'},'\u53D1\u5E03\u65F6\u95F4')),data===undefined?__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9__courses_coursesPublic_NoneData__["a" /* default */],null):data.project_packages.length===0?__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9__courses_coursesPublic_NoneData__["a" /* default */],null):data.project_packages.map(function(item,key){return __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'educontent project-packages-list',key:key},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'project-package-item with-operator project-package-11'},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'item-image'},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('img',{alt:'\u56FE\u7247',src:'/images/educoder/project_packages/'+setcategorylist(item.category_name)+'.png'})),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'item-body'},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'item-head'},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'item-head-title',title:item.title},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('a',{href:'/crowdsourcing/'+item.id},item.title)),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'item-head-tags'},item.bidden_status==="pending"?__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('span',{className:'pending'},'\u7ADE\u6807\u4E2D'):"",item.bidden_status==="bidding_won"?__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('span',{className:'bidding_won'},'\u5DF2\u4E2D\u6807'):"",item.bidden_status==="bidding_lost"?__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('span',{className:'bidding_lost'},'\u672A\u4E2D\u6807'):""),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'item-head-blank'}),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'item-head-price mtf15'},item.min_price===null?"":__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('span',null,'\uFFE5',item.min_price),item.max_price===null||item.min_price===null?"":__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('span',null,'~'),item.max_price===null?"":__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('span',null,'\uFFE5',item.max_price),item.min_price===null&&item.max_price===null?__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('span',null,'\u53EF\u8BAE\u4EF7'):"")),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'item-category'},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'item-category-item'},item.category_name)),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'item-other'},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'item-group item-other-visit'},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('span',{className:'item-group-icon mr10'},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('i',{className:'fa fa-eye'})),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('span',{className:'item-group-text'},item.visit_count,'\u4EBA\u6D4F\u89C8')),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'item-group item-other-deadline'},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('span',{className:'item-group-icon mr10'},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('i',{className:'fa fa-clock-o'})),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('span',{className:'item-group-text'},__WEBPACK_IMPORTED_MODULE_11_moment___default()(item.deadline_at).format("YYYY-MM-DD HH:mm"),'\u7ADE\u6807\u622A\u6B62')),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'item-group item-other-bidding pagemancenter'},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('span',{className:'item-group-icon mr10'},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('i',{className:'fa fa-user'})),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('span',{className:'item-group-text'},item.bidding_users_count,'\u4EBA\u7ADE\u6807')),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'item-group item-other-publish-at'},item.published_at===null?__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('span',{className:'item-group-text'},'\u66F4\u65B0\u4E8E\uFF1A',__WEBPACK_IMPORTED_MODULE_11_moment___default()(item.updated_at).format("YYYY-MM-DD HH:mm"),' '):__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('span',{className:' item-group-text'},'\u53D1\u5E03\u4E8E\uFF1A',__WEBPACK_IMPORTED_MODULE_11_moment___default()(item.published_at).format("YYYY-MM-DD HH:mm"),' ')))),category=="manage"?item.operation.can_edit===true&&item.operation.can_delete===true?__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'item-operator none'},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('a',{href:'/crowdsourcing/'+item.id+'/edit',title:'\u7F16\u8F91'},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('i',{className:'fa fa-pencil'})),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('a',{className:'delete-project-package-btn',onClick:function onClick(){return _this2.delectprojectModal(item.id);},'data-id':'10',title:'\u5220\u9664'},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('i',{className:'fa fa-trash-o'}))):"":"",category=="manage"?item.operation.can_edit===true&&item.operation.can_delete===false?__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'item-operator none'},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('a',{href:'/crowdsourcing/'+item.id+'/edit',title:'\u7F16\u8F91'},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('i',{className:'fa fa-pencil'}))):"":""));}),totalCount>20&&__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('div',{className:'mt30 mb50 edu-txt-center'},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_pagination___default.a,{showQuickJumper:true,total:totalCount,onChange:this.changePage,pageSize:20,current:page}))));}}]);return InfosPackage;}(__WEBPACK_IMPORTED_MODULE_4_react__["Component"]);/* harmony default export */ __webpack_exports__["default"] = (InfosPackage);
