...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_antd_lib_form_style_css__ = __webpack_require__(952);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_antd_lib_form__ = __webpack_require__(953);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16_antd_lib_notification_style_css__ = __webpack_require__(39);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17_antd_lib_notification__ = __webpack_require__(40);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18_antd_lib_select_style_css__ = __webpack_require__(306);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19_antd_lib_select__ = __webpack_require__(302);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__TPMIndexHOC__ = __webpack_require__(321);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__css_Newshixuns_css__ = __webpack_require__(1592);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__css_Newshixuns_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_24__css_Newshixuns_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__challengesnew_TPMMDEditor__ = __webpack_require__(319);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__modals_Bottomsubmit__ = __webpack_require__(1657);
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _defineProperty(obj,key,value){if(key in obj){Object.defineProperty(obj,key,{value:value,enumerable:true,configurable:true,writable:true});}else{obj[key]=value;}return obj;}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var Option=__WEBPACK_IMPORTED_MODULE_19_antd_lib_select___default.a.Option;var Newshixuns=function(_Component){_inherits(Newshixuns,_Component);function Newshixuns(props){_classCallCheck(this,Newshixuns);var _this=_possibleConstructorReturn(this,(Newshixuns.__proto__||Object.getPrototypeOf(Newshixuns)).call(this,props));_this.shixunNameInput=function(e){_this.setState({shixunName:e.target.value});_this.props.form.setFieldsValue({name:e.target.value});};_this.RadiovalueonChange=function(e){_this.setState({Radiovalue:e.target.value});_this.props.form.setFieldsValue({is_jupyter:e.target.value});};_this.handleSubmit=function(e){_this.setState({loading:true});var mdContnet=_this.contentMdRef.current.getValue().trim();_this.props.form.validateFieldsAndScroll(function(err,values){debugger;if(!err){console.log('Received values of form: ',values);var Url='/shixuns.json';__WEBPACK_IMPORTED_MODULE_23_axios___default.a.post(Url,{description:mdContnet,main_type:values.main_type,sub_type:values.sub_type,shixun:{name:values.name,trainee:values.select,is_jupyter:values.is_jupyter==="2"?true:false}}).then(function(response){if(response.status===200){window.location.href="/shixuns/"+response.data.shixun_identifier+"/challenges";// window.open("/shixuns/"+response.data.shixun_identifier+"/challenges");
}else{_this.setState({loading:false});}}).catch(function(error){_this.setState({loading:false});});}else{_this.setState({loading:false});}});};_this.Selectthestudent=function(value){_this.props.form.setFieldsValue({select:value});};_this.main_type=function(value,e){_this.props.form.setFieldsValue({main_type:value});_this.setState({mainvalues:e.props.name});};_this.sub_type=function(value,e){_this.props.form.setFieldsValue({sub_type:value});var newlist="";e.map(function(item,key){if(item.props.name!=""){newlist=newlist+(''+item.props.name);}});_this.setState({subvalues:newlist});};_this.post_apply=function(){_this.setState({postapplyvisible:true});};_this.sendhideModaly=function(){_this.setState({postapplyvisible:false});if(_this.state.file!==undefined){// this.deleteAttachment(this.state.file);
_this.setState({file:undefined,deleteisnot:true,language:"",runtime:"",run_method:"",fileList:[]});}else{_this.setState({file:undefined,deleteisnot:true,language:"",runtime:"",run_method:"",fileList:[]});}};_this.sendsure_apply=function(){var _this$state=_this.state,language=_this$state.language,runtime=_this$state.runtime,run_method=_this$state.run_method;if(!language||language===""){// this.props.showNotification(`请填写该镜像是基于什么语言`);
_this.setState({languagewritetype:true});return;}if(!runtime||runtime===""){// this.props.showNotification(`请填写该镜像是基于什么语言系统环境`);
_this.setState({systemenvironmenttype:true});return;}if(!run_method||run_method===""){// this.props.showNotification(`请填写该镜像中测试代码运行方式`);
_this.setState({testcoderunmodetype:true});return;}var attachment_ids=undefined;if(_this.state.fileList){attachment_ids=_this.state.fileList.map(function(item){return item.response?item.response.id:item.id;});}if(attachment_ids===undefined||attachment_ids.length===0){_this.setState({attachmentidstype:true});return;}var data={language:language,runtime:runtime,run_method:run_method,attachment_id:attachment_ids[0]};var url='/shixuns/apply_shixun_mirror.json';__WEBPACK_IMPORTED_MODULE_23_axios___default.a.post(url,data).then(function(response){try{if(response.data){if(_this.state.file!==undefined){_this.setState({file:undefined,deleteisnot:true,language:"",runtime:"",run_method:"",fileList:[]});}else{_this.setState({file:undefined,deleteisnot:true,language:"",runtime:"",run_method:"",fileList:[]});}__WEBPACK_IMPORTED_MODULE_17_antd_lib_notification___default.a.open({message:'提示',description:'新建申请已提交，请等待管理员审核。'});_this.sendhideModaly();}}catch(e){}});};_this.setlanguage=function(e){_this.setState({language:e.target.value});if(e.target.value){_this.setState({languagewritetype:false});}};_this.setruntime=function(e){_this.setState({runtime:e.target.value});if(e.target.value){_this.setState({systemenvironmenttype:false});}};_this.setrun_method=function(e){_this.setState({run_method:e.target.value});if(e.target.value){_this.setState({testcoderunmodetype:false});}};_this.handleChange=function(info){if(info.file.status==='uploading'||info.file.status==='done'||info.file.status==='removed'){var fileList=_this.state.fileList;if(info.file.status==='uploading'||info.file.status==='done'||info.file.status==='removed'){console.log("handleChange1");// if(fileList.length===0){
var fileLists=info.fileList;_this.setState({// fileList:appendFileSizeToUploadFileAll(fileList),
fileList:fileLists,deleteisnot:false});// }
}}};_this.onAttachmentRemove=function(file){if(!file.percent||file.percent==100){__WEBPACK_IMPORTED_MODULE_15_antd_lib_modal___default.a.confirm({title:'确定要删除这个附件吗?',okText:'确定',cancelText:'取消',// content: 'Some descriptions',
onOk:function onOk(){console.log("665");_this.deleteAttachment(file);},onCancel:function onCancel(){console.log('Cancel');}});return false;}};_this.deleteAttachment=function(file){console.log(file);var id=file.response==undefined?file.id:file.response.id;var url='/attachments/'+id+'.json';__WEBPACK_IMPORTED_MODULE_23_axios___default.a.delete(url,{}).then(function(response){if(response.data){var status=response.data.status;if(status==0){// console.log('--- success')
_this.setState(function(state){var index=state.fileList.indexOf(file);var newFileList=state.fileList.slice();newFileList.splice(index,1);return{fileList:newFileList,deleteisnot:true};});}}}).catch(function(error){console.log(error);});};_this.contentMdRef=__WEBPACK_IMPORTED_MODULE_20_react___default.a.createRef();_this.state={shixunName:undefined,NAME_COUNT:60,is_jupyter:"1",newshixunlist:undefined,language:undefined,runtime:undefined,run_method:undefined,postapplyvisible:undefined,fileList:[],Radiovalue:"1"};return _this;}_createClass(Newshixuns,[{key:'componentDidMount',value:function componentDidMount(){var _this2=this;this.props.form.setFieldsValue({is_jupyter:'1'});var newshixunUrl='/shixuns/new.json';__WEBPACK_IMPORTED_MODULE_23_axios___default.a.get(newshixunUrl).then(function(response){if(response.status===200){if(response.data.message===undefined){_this2.setState({newshixunlist:response.data});// this.contentMdRef.current.setValue(!response.data.sample[0][1] ? "" : response.data.sample[0][1]);
}}}).catch(function(error){console.log(error);});var departmentsUrl='/shixuns/departments.json';__WEBPACK_IMPORTED_MODULE_23_axios___default.a.get(departmentsUrl).then(function(response){if(response.status===200){if(response.data.message===undefined){_this2.setState({departmentslist:response.data.shools_name});}}}).catch(function(error){console.log(error);});}// 附件相关 START
},{key:'render',value:function render(){var _this3=this;var getFieldDecorator=this.props.form.getFieldDecorator;var _state=this.state,newshixunlist=_state.newshixunlist,fileList=_state.fileList,postapplytitle=_state.postapplytitle,postapplyvisible=_state.postapplyvisible;var uploadProps={width:600,fileList:fileList,multiple:true,action:''+Object(__WEBPACK_IMPORTED_MODULE_22_educoder__["R" /* getUploadActionUrl */])(),onChange:this.handleChange,onRemove:this.onAttachmentRemove,beforeUpload:function beforeUpload(file,fileList){if(_this3.state.fileList.length>=1){return false;}var isLt150M=file.size/1024/1024<50;if(!isLt150M){__WEBPACK_IMPORTED_MODULE_17_antd_lib_notification___default.a.open({message:'提示',description:'文件大小必须小于50MB'});}if(_this3.state.file!==undefined){_this3.setState({file:file});}else{_this3.setState({file:file});}return isLt150M;}};return __WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('div',{className:'newMain clearfix'},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('style',null,'\n            .ant-form-item{\n             margin-bottom:5px;\n            }\n            '),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('div',{className:'educontent mt20 mb60 clearfix'},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('div',{className:'new_shixun'},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('div',{className:'mb10 edu-back-white pd40px'},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('div',{className:'padding10-20 bor-bottom-greyE color-grey-3 clearfix'},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('span',{className:'fl font-18 lineh-35'},'\u65B0\u5EFA\u5B9E\u8BAD\u9879\u76EE'),this.props.user&&this.props.user.main_site===true?__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('a',{className:'fr font-16 mt3 color-blue',href:'/forums/2943',target:'_blank'},'\u5B9E\u8BAD\u5236\u4F5C\u6307\u5357'):""),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('div',{className:'padding10-20  color-grey-3 clearfix'},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11_antd_lib_form___default.a,null,__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11_antd_lib_form___default.a.Item,{label:'\u5B9E\u8BAD\u7C7B\u578B'},getFieldDecorator('is_jupyter')(__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13_antd_lib_radio___default.a.Group,{onChange:this.RadiovalueonChange,value:this.state.Radiovalue},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13_antd_lib_radio___default.a,{value:'1'},'\u666E\u901A\u5B9E\u8BAD'),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13_antd_lib_radio___default.a,{value:'2'},'Jupyter\u5B9E\u8BAD')))),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11_antd_lib_form___default.a.Item,{label:'\u540D\u79F0',className:'mt15'},getFieldDecorator('name',{rules:[{required:true,message:'请输入名称'},{max:60,message:'请输入名称，最大限制60个字符'},{whitespace:true,message:'请勿输入空格'}]})(__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_input___default.a,_defineProperty({placeholder:'\u8BF7\u8F93\u5165\u540D\u79F0\uFF0C\u6700\u5927\u9650\u523660\u4E2A\u5B57\u7B26',className:"input-100-45 greyInput",onInput:this.shixunNameInput,autoComplete:'off',addonAfter:String(!this.state.shixunName?0:this.state.shixunName.length)+'/'+this.state.NAME_COUNT},'className','newViewAfter')))),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11_antd_lib_form___default.a.Item,{label:'\u7B80\u4ECB',style:{"borderBottom":'none'},className:'chooseDes pr'},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_25__challengesnew_TPMMDEditor__["a" /* default */],{ref:this.contentMdRef,placeholder:'\u8BF7\u8F93\u5165\u7B80\u4ECB',mdID:'courseContentMD',refreshTimeout:1500,className:'courseMessageMD'// initValue={this.state.description === null ? "" : this.state.description}
})),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11_antd_lib_form___default.a.Item,{label:"难易度",style:{"borderBottom":'none'},className:'chooseDes pr'},getFieldDecorator('select',{rules:[{required:true,message:'请选择难易度'}]})(__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('div',{className:'with15 fl pr'},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_19_antd_lib_select___default.a,{placeholder:'\u8BF7\u9009\u62E9\u96BE\u6613\u5EA6',style:{width:180},onChange:this.Selectthestudent},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(Option,{value:1},'\u521D\u7EA7'),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(Option,{value:2},'\u4E2D\u7EA7'),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(Option,{value:3},'\u4E2D\u9AD8\u7EA7'),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(Option,{value:4},'\u9AD8\u7EA7')))),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('span',{className:'fl ml20 color-grey'},'\uFF08\u5B9E\u8BAD\u7684\u96BE\u6613\u7A0B\u5EA6\uFF09')),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11_antd_lib_form___default.a.Item,{label:"实验环境",style:{"borderBottom":'none','width':'18%','float':'left'},className:'chooseDes pr'},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('div',null,getFieldDecorator('main_type',{rules:[{required:true,message:'请选择主类别'}]})(__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('div',{className:'width100 fl mr20'},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_19_antd_lib_select___default.a,{placeholder:'\u8BF7\u9009\u62E9\u4E3B\u7C7B\u522B',style:{width:180},onChange:this.main_type,defaultOpen:false},newshixunlist===undefined?"":this.state.Radiovalue==="2"?newshixunlist.main_type.map(function(item,key){var itemtype=item.type_name.toLowerCase().indexOf('jupyter'.toLowerCase());if(itemtype>-1){return __WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(Option,{value:item.id,key:key,name:item.description},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_tooltip___default.a,{placement:'right',title:item.description===""?"无描述":item.description},item.type_name));}}):"",newshixunlist===undefined?"":this.state.Radiovalue==="1"?newshixunlist.main_type.map(function(item,key){var itemtype=item.type_name.toLowerCase().indexOf('jupyter'.toLowerCase());if(itemtype===-1){return __WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(Option,{value:item.id,key:key,name:item.description},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_tooltip___default.a,{placement:'right',title:item.description===""?"无描述":item.description},item.type_name));}}):""))))),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('style',null,'\n                      .Selectlittle .ant-select-selection__rendered{\n                        line-height:25px;\n                      }\n                      '),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11_antd_lib_form___default.a.Item,{style:{"borderBottom":'none','width':'82%','float':'left','marginTop':'40px'},className:'chooseDes pr'},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('div',{className:' fl pr mr20'},getFieldDecorator('sub_type')(__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('div',{className:' fl pr mr20'},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_19_antd_lib_select___default.a,{placeholder:'\u8BF7\u9009\u62E9\u5C0F\u7C7B\u522B',mode:'multiple',style:{width:280},onChange:this.sub_type,defaultOpen:false,className:"Selectlittle"},newshixunlist===undefined?"":newshixunlist.small_type.map(function(item,key){return __WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(Option,{value:item.id,key:key,name:item.description},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_tooltip___default.a,{placement:'right',title:item.description===""?"无描述":item.description},item.type_name));})))),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('span',{className:'fl ml20 color-grey lineh-20'},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('div',null,this.state.mainvalues===undefined&&this.state.subvalues===undefined||this.state.mainvalues===""&&this.state.subvalues===""?"":__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('div',{className:"font-12",style:{'max-width':'600px'}},''+(this.state.mainvalues===undefined||this.state.mainvalues===""?"":this.state.mainvalues),''+(this.state.subvalues===undefined||this.state.subvalues===""?"":this.state.mainvalues===undefined||this.state.mainvalues===""?this.state.subvalues:this.state.subvalues),''+(this.state.mainvalues===undefined||this.state.mainvalues===""?"":this.state.mainvalues)+(this.state.subvalues===undefined||this.state.subvalues===""?"":this.state.mainvalues===undefined||this.state.mainvalues===""?this.state.subvalues:this.state.subvalues))))))),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('div',{className:"both"}),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('div',{className:' color-grey lineh-20'},'\u6CA1\u6709\u5B9E\u9A8C\u73AF\u5883\uFF1F',__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('a',{className:'color-blue',onClick:this.post_apply},' \u7533\u8BF7\u65B0\u5EFA')),postapplyvisible===true?__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('style',null,'\n                   body{\n                    overflow: hidden !important;\n                    }\n                    '):"",__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_15_antd_lib_modal___default.a,{keyboard:false,title:'\u7533\u8BF7\u65B0\u5EFA',visible:postapplyvisible,closable:false,footer:null,width:850,heigth:720},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('div',null,__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('li',{className:'clearfix ml82'},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('label',{className:'fl mt10 '},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('span',{className:'color-red fl mt3'},'*'),'\u8BED\u8A00\uFF1A\xA0\xA0'),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('textarea',{className:this.state.languagewritetype===true?"fl task-form-80 task-height-150 bor-reds":"fl task-form-80 task-height-150",style:{width:'89%',height:'100px'},onInput:this.setlanguage,value:this.state.language,placeholder:'\u8BF7\u586B\u5199\u8BE5\u955C\u50CF\u662F\u57FA\u4E8E\u4EC0\u4E48\u8BED\u8A00\uFF1A\u793A\u4F8B\uFF1APython',id:'demand_info'})),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('div',{className:"color-red shixunspanred"},this.state.languagewritetype===true?"请填写该镜像语言":""),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('li',{className:'clearfix ml1'},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('label',{className:'panel-form-label fl ml50'},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('span',{className:'color-red fl mt3'},'*'),'\u7CFB\u7EDF\u73AF\u5883\uFF1A\xA0\xA0'),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('textarea',{className:this.state.systemenvironmenttype===true?"fl task-form-80 task-height-150 bor-reds":"fl task-form-80 task-height-150",onInput:this.setruntime,style:{height:'100px'},value:this.state.runtime,placeholder:'\u8BF7\u586B\u5199\u8BE5\u955C\u50CF\u662F\u57FA\u4E8E\u4EC0\u4E48linux\u7CFB\u7EDF\u73AF\u5883,\u4EE3\u7801\u8FD0\u884C\u73AF\u5883',id:'demand_info'})),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('div',{className:"color-red shixunspanred"},this.state.systemenvironmenttype===true?"请填写该镜像语言系统环境":""),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('li',{className:'clearfix'},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('label',{className:'fl mt10'},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('span',{className:'color-red fl mt3'},'*'),'\u6D4B\u8BD5\u4EE3\u7801\u8FD0\u884C\u65B9\u5F0F\uFF1A\xA0\xA0'),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('textarea',{className:this.state.testcoderunmodetype===true?"fl task-form-80 task-height-150 bor-reds":"fl task-form-80 task-height-150",onInput:this.setrun_method,value:this.state.run_method,style:{height:'100px'},placeholder:'\u8BF7\u586B\u5199\u8BE5\u955C\u50CF\u4E2D\u6D4B\u8BD5\u4EE3\u7801\u8FD0\u884C\u65B9\u5F0F',id:'demand_info'})),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('div',{className:"color-red shixunspanred"},this.state.testcoderunmodetype===true?"请填写该镜像测试代码运行方式":""),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('li',{className:'clearfix ml50'},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('label',{className:'panel-form-label fl mt-5'},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('span',{className:'color-red fl'},'*'),'\u6D4B\u8BD5\u4EE3\u7801\uFF1A\xA0\xA0'),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('div',{className:'mt10',style:{display:"inline-block"}},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_upload___default.a,uploadProps,__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_icon___default.a,{type:'upload',className:'fl mt3'},' '),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('span',{className:'color-blue fl cdefault'},'\u4E0A\u4F20\u9644\u4EF6'),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('span',{className:'color-grey-c fl ml10 '},'(\u5355\u4E2A\u6587\u4EF650M\u4EE5\u5185)')))),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('div',{className:"color-red shixunspanred"},this.state.attachmentidstype===true?"请上传附件":""),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('li',{className:'edu-txt-center clearfix '},__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('a',{className:'pop_close task-btn  mr30',onClick:function onClick(){return _this3.sendhideModaly();}},'\u53D6\u6D88'),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_button___default.a,{type:'primary',onClick:function onClick(){return _this3.sendsure_apply();},className:'task-btn task-btn-orange'},'\u786E\u5B9A')),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement('div',{className:'cl'}))))))),__WEBPACK_IMPORTED_MODULE_20_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_26__modals_Bottomsubmit__["a" /* default */],Object.assign({},this.props,this.state,{url:"/shixuns",onSubmits:function onSubmits(){return _this3.handleSubmit();},loadings:this.state.loading})));}}]);return Newshixuns;}(__WEBPACK_IMPORTED_MODULE_20_react__["Component"]);var NewshixunsNew=__WEBPACK_IMPORTED_MODULE_11_antd_lib_form___default.a.create({name:'newshixun'})(Newshixuns);/* harmony default export */ __webpack_exports__["default"] = (Object(__WEBPACK_IMPORTED_MODULE_22_educoder__["w" /* SnackbarHOC */])()(Object(__WEBPACK_IMPORTED_MODULE_21__TPMIndexHOC__["a" /* TPMIndexHOC */])(NewshixunsNew)));
