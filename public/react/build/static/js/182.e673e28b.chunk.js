...
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var HelpCenter=function(_React$Component){_inherits(HelpCenter,_React$Component);function HelpCenter(props){_classCallCheck(this,HelpCenter);var _this=_possibleConstructorReturn(this,(HelpCenter.__proto__||Object.getPrototypeOf(HelpCenter)).call(this,props));_this.state={loading:true,content:null};return _this;}_createClass(HelpCenter,[{key:'componentDidMount',value:function componentDidMount(){window.document.title="帮助中心";this.getContent();}},{key:'getContent',value:function getContent(){var _this2=this;__WEBPACK_IMPORTED_MODULE_4_axios___default.a.get("/helps/help_center.json").then(function(result){if(result){_this2.setState({content:result.data.content,loading:false});}}).catch(function(error){console.log(error);_this2.setState({loading:false});});}},{key:'render',value:function render(){var _state=this.state,loading=_state.loading,content=_state.content;return __WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('div',null,__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('div',{className:'help-center-container'},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_card___default.a,{title:'\u5E2E\u52A9\u4E2D\u5FC3',bordered:false,loading:loading,style:{minHeight:600}},__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement('div',{className:'help-center-content'},content&&__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_educoder__["s" /* MarkdownToHtml */],{content:content,selector:'work_content',className:''})))));}}]);return HelpCenter;}(__WEBPACK_IMPORTED_MODULE_2_react___default.a.Component);/* harmony default export */ __webpack_exports__["default"] = (HelpCenter);
