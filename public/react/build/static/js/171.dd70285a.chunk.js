...
// load the styles
var content = __webpack_require__(4848);
if(typeof content === 'string') content = [[module.i, content, '']];
// Prepare cssTransformation
var transform;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__css_index_css__ = __webpack_require__(2249);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__css_index_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11__css_index_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__Branch_branch_css__ = __webpack_require__(2281);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__Branch_branch_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_12__Branch_branch_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__activity_css__ = __webpack_require__(3705);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__activity_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_13__activity_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__Nodata__ = __webpack_require__(1736);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__ActivityItem__ = __webpack_require__(4849);
...
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var LIMIT=15;var ARRAY=[{id:1,name:'1天'},{id:3,name:'3天'},{id:7,name:'1周'},{id:30,name:'1个月'}];// const dataformat="YYYY-MM-DD HH:mm";
var Activity=function(_Component){_inherits(Activity,_Component);function Activity(props){_classCallCheck(this,Activity);var _this=_possibleConstructorReturn(this,(Activity.__proto__||Object.getPrototypeOf(Activity)).call(this,props));_this.componentDidMount=function(){var _this$state=_this.state,time=_this$state.time,type=_this$state.type,status=_this$state.status,page=_this$state.page;_this.setState({isSpin:true});_this.getInfo(time,type,status,page);};_this.getInfo=function(time,type,status,page){var projectsId=_this.props.match.params.projectsId;var url='/projects/'+projectsId+'/project_trends.json';__WEBPACK_IMPORTED_MODULE_16_axios___default.a.get(url,{params:{time:time,type:type,status:status,page:page}}).then(function(result){if(result){_this.setState({data:result.data,project_trends:result.data.project_trends,isSpin:false});}}).catch(function(error){console.log(error);});};_this.changeTime=function(e){_this.setState({time:e.key,isSpin:true});var _this$state2=_this.state,type=_this$state2.type,status=_this$state2.status,page=_this$state2.page;_this.getInfo(e.key,type,status,page);};_this.changeTrends=function(type,status){_this.setState({type:type,status:status});var _this$state3=_this.state,time=_this$state3.time,page=_this$state3.page;_this.getInfo(time,type,status,page);};_this.ChangePage=function(page){_this.setState({page:page});var _this$state4=_this.state,time=_this$state4.time,type=_this$state4.type,status=_this$state4.status;_this.getInfo(time,type,status,page);};_this.state={time:'30',type:undefined,state:undefined,page:1,data:undefined,project_trends:undefined,isSpin:false};return _this;}// 切换周期
//筛选
// 分页
_createClass(Activity,[{key:'render',value:function render(){var _this2=this;var _state=this.state,time=_state.time,data=_state.data,page=_state.page,project_trends=_state.project_trends,isSpin=_state.isSpin;var menu=__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_menu___default.a,null,ARRAY&&ARRAY.map(function(item,key){return __WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_antd_lib_menu___default.a.Item,{key:item.id,onClick:_this2.changeTime},item.name);}));var name=time&&ARRAY.filter(function(item){return item.id===parseInt(time);});// console.log(name);
var second_per=parseInt(data&&data.close_issues_count)/parseInt(data&&data.issues_count)*100+'%';var third_per=parseInt(data&&data.close_issues_count)/parseInt(data&&data.issues_count)*100+'%';var fourth_per=parseInt(data&&data.open_issues_count)/parseInt(data&&data.issues_count)*100+'%';return __WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('div',{className:'main'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('div',{className:'normalBox'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('div',{'class':'normalBox-title'},'\u6982\u89C8'),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('div',{className:'orderInfo'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('div',null,__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('div',{className:'percentLine prPercent'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('p',{className:'percent_purple',style:{width:'100%'}}),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('p',{className:'percent_green resetStyle',style:{width:''+second_per}})),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',null,data&&data.pr_all_count,'\u5408\u5E76\u8BF7\u6C42')),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('div',null,__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('div',{className:'percentLine'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('p',{className:'percent_red',style:{width:''+third_per}}),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('p',{className:'percent_green',style:{width:''+fourth_per}})),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',null,data&&data.issues_count,'\u4EFB\u52A1'))),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('ul',{className:'percentBox'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('li',null,__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',{className:'purple'},data&&data.pr_count),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',{className:'change',onClick:function onClick(){return _this2.changeTrends("PullRequest","close");}},'\u5DF2\u5904\u7406\u7684\u5408\u5E76\u8BF7\u6C42')),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('li',null,__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',{className:'green'},data&&data.new_pr_count),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',{className:'change',onClick:function onClick(){return _this2.changeTrends("PullRequest","create");}},'\u672A\u5904\u7406\u7684\u5408\u5E76\u8BF7\u6C42')),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('li',null,__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',{className:'red'},data&&data.close_issues_count),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',{className:'change',onClick:function onClick(){return _this2.changeTrends("Issue","close");}},'\u5DF2\u5173\u95ED\u7684\u4EFB\u52A1')),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('li',null,__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',{className:'green'},data&&data.open_issues_count),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',{className:'change',onClick:function onClick(){return _this2.changeTrends("Issue","create");}},'\u672A\u5904\u7406\u7684\u4EFB\u52A1')))),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('div',{className:'df trendsTop mt20'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('div',{className:'branchDropdown f-wrap-alignCenter'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_dropdown___default.a,{overlay:menu,trigger:['click'],placement:'bottomLeft'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('a',{className:'ant-dropdown-link'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('span',{className:'color-grey-9 mr3'},'\u5468\u671F:'),name&&name.length>0&&name[0].name,' ',__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_icon___default.a,{type:'down'}))))),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_spin___default.a,{spinning:isSpin},project_trends&&project_trends.length>0?__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('div',{className:'activity_list'},project_trends&&project_trends.map(function(item,key){return __WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_15__ActivityItem__["a" /* default */],Object.assign({item:item},_this2.props));})):__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_14__Nodata__["a" /* default */],{_html:'\u6682\u65F6\u8FD8\u6CA1\u6709\u76F8\u5173\u6570\u636E\u54E6!'})),data&&data.project_trends_size>0&&data.project_trends_size>LIMIT&&__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement('div',{className:'pageDIV'},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_pagination___default.a,{showQuickJumper:true,defaultCurrent:page,total:data&&data.project_trends_size,pageSize:LIMIT,onChange:this.ChangePage})));}}]);return Activity;}(__WEBPACK_IMPORTED_MODULE_10_react__["Component"]);/* harmony default export */ __webpack_exports__["default"] = (Activity);
...
// module
exports.push([module.i, ".trendsTop{padding-bottom:15px;border-bottom:1px solid #ddd}.pageDIV{text-align:center;margin-top:20px;margin-bottom:40px}.orderInfo{padding:15px;display:-ms-flexbox;display:flex;-ms-flex-pack:justify;justify-content:space-between}.orderInfo>div{width:45%}.percentLine{width:100%;display:-ms-flexbox;display:flex;height:8px;border-radius:2px;background:#888;position:relative}.percent_green{background-color:#6cc644;color:#6cc644}.percent_purple{background-color:#6e5494;color:#6e5494}.percent_red{background-color:#d95c5c}.green{color:#6cc644}.purple{color:#6e5494}.red{color:#d95c5c}.percentBox{border-top:1px solid #f4f4f4}.percentBox,.percentBox>li{display:-ms-flexbox;display:flex}.percentBox>li{-ms-flex-direction:column;flex-direction:column;text-align:center;-ms-flex:1 1;flex:1 1;border-right:1px solid #f4f4f4;padding:20px 0;color:#4183c4}.percentBox>li:last-child{border-right:none}.activity_list .activity_item{border-bottom:1px solid #f4f4f4;padding:15px 0;display:-ms-flexbox;display:flex;-ms-flex-align:start;align-items:flex-start}.prPercent>p{position:absolute;height:100%;top:0;left:0;z-index:0}.prPercent>p.resetStyle{left:unset;right:0;z-index:1}.itemLine{display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center}.activity_type{display:block;padding:0 5px;height:20px;line-height:20px;background:#6cc644;margin-left:10px;color:#fff;border-radius:3px;font-size:12px}.createImage{margin-right:5px;height:22px;line-height:22px;border-radius:50%}.change{color:#000;cursor:pointer}.change:hover{color:#4183c4}", "", {"version":3,"sources":["/Users/jasder/work/trustie3.0/forgeplus-react/src/forge/Activity/activity.css"],"names":[],"mappings":"AAAA,WACE,oBAAqB,AACrB,4BAA6B,CAC9B,AAED,SACE,kBAAmB,AACnB,gBAAiB,AACjB,kBAAoB,CACrB,AACD,WACE,aAAa,AACb,oBAAqB,AACrB,aAAc,AACd,sBAAuB,AACnB,6BAA+B,CACpC,AACD,eACE,SAAW,CACZ,AACD,aACE,WAAY,AACZ,oBAAoB,AACpB,aAAa,AACb,WAAY,AACZ,kBAAmB,AACnB,gBAAiB,AACjB,iBAAmB,CACpB,AACD,eACE,yBAA0B,AAC1B,aAAe,CAChB,AACD,gBACE,yBAA0B,AAC1B,aAAe,CAChB,AACD,aACE,wBAA0B,CAC3B,AACD,OACE,aAAe,CAChB,AACD,QACE,aAAe,CAChB,AACD,KACE,aAAe,CAChB,AACD,YAGE,4BAA8B,CAC/B,AACD,2BAJE,oBAAqB,AACrB,YAAc,CAcf,AAXD,eAGE,0BAA2B,AACvB,sBAAuB,AAC3B,kBAAmB,AACnB,aAAc,AACV,SAAU,AACd,+BAAgC,AAChC,eAAiB,AACjB,aAAe,CAChB,AACD,0BACE,iBAAmB,CACpB,AACD,8BACE,gCAAiC,AACjC,eAAiB,AACjB,oBAAqB,AACrB,aAAc,AACd,qBAAsB,AAClB,sBAAwB,CAC7B,AACD,aACE,kBAAmB,AACnB,YAAa,AACb,MAAQ,AACR,OAAU,AACV,SAAW,CACZ,AACD,wBACE,WAAY,AACZ,QAAW,AACX,SAAW,CACZ,AACD,UACE,oBAAqB,AACrB,aAAc,AACd,sBAAuB,AACnB,kBAAoB,CACzB,AACD,eACE,cAAe,AACf,cAAgB,AAChB,YAAa,AACb,iBAAkB,AAClB,mBAAoB,AACpB,iBAAkB,AAClB,WAAY,AACZ,kBAAmB,AACnB,cAAgB,CACjB,AACD,aACE,iBAAkB,AAClB,YAAa,AACb,iBAAkB,AAClB,iBAAmB,CACpB,AACD,QACE,WAAc,AACd,cAAgB,CACjB,AACD,cACE,aAAe,CAChB","file":"activity.css","sourcesContent":[".trendsTop{\n  padding-bottom: 15px;\n  border-bottom:1px solid #ddd;\n}\n\n.pageDIV{\n  text-align: center;\n  margin-top: 20px;\n  margin-bottom: 40px;\n}\n.orderInfo{\n  padding:15px;\n  display: -ms-flexbox;\n  display: flex;\n  -ms-flex-pack: justify;\n      justify-content: space-between;\n}\n.orderInfo > div{\n  width: 45%;\n}\n.percentLine{\n  width: 100%;\n  display:-ms-flexbox;\n  display:flex;\n  height: 8px;\n  border-radius: 2px;\n  background: #888;\n  position: relative;\n}\n.percent_green{\n  background-color: #6cc644;\n  color: #6cc644;\n}\n.percent_purple{\n  background-color: #6e5494;\n  color: #6e5494;\n}\n.percent_red{\n  background-color: #d95c5c;\n}\n.green{\n  color: #6cc644;\n}\n.purple{\n  color: #6e5494;\n}\n.red{\n  color: #d95c5c;\n}\n.percentBox{\n  display: -ms-flexbox;\n  display: flex;\n  border-top: 1px solid #f4f4f4;\n}\n.percentBox > li{\n  display: -ms-flexbox;\n  display: flex;\n  -ms-flex-direction: column;\n      flex-direction: column;\n  text-align: center;\n  -ms-flex: 1 1;\n      flex: 1 1;\n  border-right: 1px solid #f4f4f4;\n  padding:20px 0px;\n  color: #4183c4;\n}\n.percentBox > li:last-child{\n  border-right: none;\n}\n.activity_list .activity_item{\n  border-bottom: 1px solid #f4f4f4;\n  padding:15px 0px;\n  display: -ms-flexbox;\n  display: flex;\n  -ms-flex-align: start;\n      align-items: flex-start;\n}\n.prPercent > p{\n  position: absolute;\n  height: 100%;\n  top:0px;\n  left: 0px;\n  z-index: 0;\n}\n.prPercent > p.resetStyle{\n  left: unset;\n  right: 0px;\n  z-index: 1;\n}\n.itemLine{\n  display: -ms-flexbox;\n  display: flex;\n  -ms-flex-align: center;\n      align-items: center;\n}\n.activity_type{\n  display: block;\n  padding:0px 5px;\n  height: 20px;\n  line-height: 20px;\n  background: #6cc644;\n  margin-left: 10px;\n  color: #fff;\n  border-radius: 3px;\n  font-size: 12px;\n}\n.createImage{\n  margin-right: 5px;\n  height: 22px;\n  line-height: 22px;\n  border-radius: 50%;\n}\n.change{\n  color:  black;\n  cursor: pointer;\n}\n.change:hover{\n  color: #4183c4;\n}"],"sourceRoot":""}]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__activity_css__ = __webpack_require__(3705);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__activity_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__activity_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_educoder__ = __webpack_require__(5);
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var ActivityItem=function(_Component){_inherits(ActivityItem,_Component);function ActivityItem(){_classCallCheck(this,ActivityItem);return _possibleConstructorReturn(this,(ActivityItem.__proto__||Object.getPrototypeOf(ActivityItem)).apply(this,arguments));}_createClass(ActivityItem,[{key:'render',value:function render(){var projectsId=this.props.match.params.projectsId;var item=this.props.item;return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'activity_item'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div',{className:'flex1'},item.trend_type==="VersionRelease"?__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('p',{className:'itemLine'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["b" /* Link */],{to:'/projects/'+projectsId+'/version',className:'color-blue font-16'},item.name),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('span',{className:'activity_type'},item.trend_type)):// 如果是任务
item.trend_type==="Issue"?__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('p',{className:'itemLine'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["b" /* Link */],{to:'/projects/'+projectsId+'/orders/'+item.trend_id+'/detail',className:'color-blue font-16'},item.name),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('span',{className:'activity_type'},item.trend_type)):// 如果是合并请求
__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('p',{className:'itemLine'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["b" /* Link */],{to:'/projects/'+projectsId+'/merge/'+item.trend_id+'/Messagecount',className:'color-blue font-16'},item.name),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('span',{className:'activity_type'},item.trend_type)),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('p',{className:'itemLine mt15'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["b" /* Link */],{to:'/users/'+(item&&item.login)+'/projects',className:'show-user-link'},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('img',{alt:'',src:Object(__WEBPACK_IMPORTED_MODULE_3_educoder__["M" /* getImageUrl */])('images/'+item.user_avatar),className:'createImage'}),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('span',{className:'mr20'},item.user_name)),item.created_at&&__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('span',{className:'color-grey-9'},'\u521B\u5EFA\u4E8E',__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('span',{className:'ml2 color-grey-6'},item.created_at)))));}}]);return ActivityItem;}(__WEBPACK_IMPORTED_MODULE_0_react__["Component"]);/* harmony default export */ __webpack_exports__["a"] = (ActivityItem);
