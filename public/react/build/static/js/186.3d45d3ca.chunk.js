...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(32), __webpack_require__(308)(module)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_antd_lib_icon_style_css__ = __webpack_require__(178);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__css_members_css__ = __webpack_require__(312);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__css_busyWork_css__ = __webpack_require__(1069);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_react_infinite_scroller__ = __webpack_require__(1317);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__coursesPublic_NoneData__ = __webpack_require__(313);
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var Search=__WEBPACK_IMPORTED_MODULE_9_antd_lib_input___default.a.Search;var pageCount=20;// "poll", #normal 普通作业题库； group 分组作业题库； poll问卷题库； exercise试卷题库; gtask 毕设选题题库；gtopic 毕设任务
var engNameMap={poll:'问卷',normal:'普通作业',group:'分组作业',exercise:'试卷',gtask:'毕设任务',gtopic:'毕设选题'};var UseBank=function(_Component){_inherits(UseBank,_Component);function UseBank(props){_classCallCheck(this,UseBank);var _this=_possibleConstructorReturn(this,(UseBank.__proto__||Object.getPrototypeOf(UseBank)).call(this,props));_this.onCheckBoxChange=function(checkBoxValues){_this.setState({checkBoxValues:checkBoxValues});if(checkBoxValues.length!=0){_this.setState({isChecked:""});}};_this.fetchAll=function(arg_page){console.log('fetchAll');var courseId=_this.props.match.params.coursesId;var page=arg_page||_this.state.page;var _this$state=_this.state,nav_my=_this$state.nav_my,search=_this$state.search;/**
     normal 普通作业题库； group 分组作业题库； poll问卷题库； exercise试卷题库; gtask 毕设选题题库；gtopic 毕设任务
     filter		string	public公共题库 2， myself我的题库 1
    */var object_type=_this.props.object_type;var url="/question_banks/bank_list.json?page="+page+"&limit="+pageCount+"&object_type="+(object_type||'')+"&search="+(search||'')+"&filter="+nav_my;_this.setState({loading:true});__WEBPACK_IMPORTED_MODULE_14_axios___default.a.get(url//   , {
//   params: {
//   }
// }
).then(function(response){if(response.data){_this.setState({is_teacher:response.data.is_teacher});}if(!response.data.object_list||response.data.object_list.length==0){_this.setState({object_list:page==1?[]:_this.state.object_list,page:page,loading:false,hasMore:false});}else{_this.setState({object_list:page==1?response.data.object_list:_this.state.object_list.concat(response.data.object_list),page:page,loading:false,hasMore:response.data.object_list.length==pageCount});}}).catch(function(error){console.log(error);});};_this.openSelectBank=function(){_this.setState({search:'',flag:true},function(){_this.fetchAll();});};_this.closeSelectBank=function(){_this.setState({flag:false,nav_my:'myself',search:'',page:1,checkBoxValues:[],isChecked:'',is_teacher:undefined,hometypepvisible:false});};_this.changeNav=function(index){_this.setState({nav_my:index},function(){_this.fetchAll(1);});};_this.onSearchChange=function(e){_this.setState({search:e.target.value});};_this.onSave=function(){debugger;var checkBoxValues=_this.state.checkBoxValues;var object_type=_this.props.object_type;if(checkBoxValues.length==0){_this.setState({isChecked:"请先选择"+engNameMap[object_type]});return;}_this.setState({hometypepvisible:true});var courseId=_this.props.match.params.coursesId;var url="/question_banks/save_banks.json";_this.setState({loading:true});__WEBPACK_IMPORTED_MODULE_14_axios___default.a.post(url,{"object_type":object_type,"bank_id":checkBoxValues,"course_id":courseId}).then(function(response){if(response.data.status==0){_this.props.useBankSuccess&&_this.props.useBankSuccess(checkBoxValues,response.data.object_ids);_this.props.showNotification('题库选用成功');_this.closeSelectBank();_this.props.updataleftNavfun();_this.setState({hometypepvisible:false,checkBoxValues:[]});}else{_this.setState({hometypepvisible:false,checkBoxValues:[]});_this.props.showNotification(response.data.message);}}).catch(function(error){console.log(error);_this.setState({hometypepvisible:false,checkBoxValues:[]});});};_this.getotiku=function(url){window.open(url,'_blank');};_this.state={flag:false,nav_my:'myself',search:'',page:1,checkBoxValues:[],isChecked:'',is_teacher:undefined,hometypepvisible:false};return _this;}_createClass(UseBank,[{key:"componentDidMount",value:function componentDidMount(){// console.log("UseBank");
// console.log(this.props);
}//切换tab
},{key:"render",value:function render(){var _this2=this;var _state=this.state,flag=_state.flag,nav_my=_state.nav_my,loading=_state.loading,hasMore=_state.hasMore,object_list=_state.object_list,search=_state.search,checkBoxValues=_state.checkBoxValues,isChecked=_state.isChecked,page=_state.page,is_teacher=_state.is_teacher;var object_type=this.props.object_type;var antIcon=__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_icon___default.a,{type:"loading",style:{fontSize:24},spin:true});// console.log("题库选用2222");
// console.log("UseBank");
// console.log(this.props);
return __WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("a",null,__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("style",null,"\n        .bankModal .task-hide {\n          max-width: 290px;\n        }\n        .d_middle{\n          justify-content: center;\n          align-items: center;\n          display: -webkit-flex;\n        }\n        .setImgW .edu-nodata-img{\n          width: 170px !important;\n        }\n        .bankwidth{\n\t\t\t\t\twidth:32% !important;\n\t\t\t\t\toverflow:hidden;\n\t\t\t\t\ttext-overflow:ellipsis;\n\t\t\t\t\twhite-space:nowrap\n        }\n        .bankwidth76{\n\t\t\t\t\twidth:76px !important;\n\t\t\t\t\toverflow:hidden;\n\t\t\t\t\ttext-overflow:ellipsis;\n\t\t\t\t\twhite-space:nowrap;\n\t\t\t\t\ttext-align: center;\n        }\n        .bankwidth2{\n\t\t\t\t\twidth:24% !important;\n\t\t\t\t\toverflow:hidden;\n\t\t\t\t\ttext-overflow:ellipsis;\n\t\t\t\t\twhite-space:nowrap\n        }\n        .with58{\n        width:58% !important;\n        Margin-left:15px\n        }\n        .with63{\n        width: 60% !important;\n        box-sizing: border-box;\n        margin-left: 15px;\n        }\n        "),flag===true?__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("style",null,"\n              body {\n\t\t\t\t\t\t\t  overflow: hidden !important;\n\t\t\t\t\t\t\t}\n              "):"",this.props.user&&this.props.user.main_site===true?__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13_educoder__["A" /* WordsBtn */],{style:"blue",className:"mr30 font-16",onClick:function onClick(){return _this2.openSelectBank();}},engNameMap[object_type]=="问卷"?"问卷选用":engNameMap[object_type]=="试卷"?"试卷选用":"题库选用"):"",flag===true?__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_modal___default.a,{title:"\u9898\u5E93\u9009\u7528",visible:flag,closable:false,width:"800px",footer:null,keyboard:false,destroyOnClose:true,centered:true},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("div",{className:"newupload_conbox clearfix bankModal"},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_spin___default.a,{indicator:antIcon,spinning:this.state.hometypepvisible,className:"newnext-loading",color:"#4AC7FF",size:"large"},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("div",{className:"clearfix mb30"},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("ul",{className:"fl mt2 bankNav"},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("li",{className:nav_my==='myself'?"active":"",onClick:function onClick(){return _this2.changeNav('myself');}},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("a",null,"\u6211\u7684\u9898\u5E93")),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("li",{className:nav_my==='myself'?"":"active",onClick:function onClick(){return _this2.changeNav('public');}},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("a",null,"\u516C\u5171\u9898\u5E93"))),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(Search,{placeholder:"\u8F93\u5165\u6807\u9898\u3001\u9002\u7528\u8BFE\u7A0B\u8FDB\u884C\u641C\u7D22",className:"searchView fr",style:{"width":"268px","height":"30px"},onSearch:function onSearch(){return _this2.fetchAll(1);},onChange:this.onSearchChange,value:search})),object_list&&object_list.length==0&&page==1?"":nav_my==='myself'?__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("p",{className:"color-grey-6 mb25 edu-txt-center"},"\u9009\u7528\u5BF9\u8C61\uFF1A\u4F60\u5728\u8BFE\u5802",engNameMap[object_type],"\u5217\u8868\u4E2D\u5DF2",__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("span",{className:"color-orange-tip"},"\u201C\u52A0\u5165\u9898\u5E93\u201D"),"\u7684",engNameMap[object_type]):__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("p",{className:"color-grey-6 mb25 edu-txt-center"},"\u9009\u7528\u5BF9\u8C61\uFF1A\u9898\u5E93\u4E2D\u5DF2\u8BBE\u7F6E\u6210\u516C\u5171\u5C5E\u6027\u7684\u6240\u6709",engNameMap[object_type]),nav_my!='myself'&&is_teacher==false?__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("div",{style:{"height":"230px"},className:"d_middle edu-txt-center"},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("div",null,__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("p",{className:"font-16 mb20 color-grey-3"},"\u901A\u8FC7\u804C\u4E1A\u8BA4\u8BC1\u7684\u6559\u5E08\u624D\u80FD\u8BBF\u95EE\u516C\u5171\u9898\u5E93"),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("a",{className:"white-btn edu-orangeback-btn",target:"_blank",href:"/account/certification"},"\u7ACB\u5373\u8BA4\u8BC1"))):object_list&&object_list.length==0&&page==1?__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("div",{className:"setImgW"},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_16__coursesPublic_NoneData__["a" /* default */],null)):__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("div",{className:"edu-back-skyblue padding20",style:{"height":"230px","overflowY":'auto'}},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_15_react_infinite_scroller___default.a,{threshold:10,initialLoad:false,pageStart:0,loadMore:function loadMore(){return _this2.fetchAll(_this2.state.page+1);},hasMore:!loading&&hasMore,useWindow:false},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_checkbox___default.a.Group,{style:{width:'100%'},onChange:this.onCheckBoxChange,value:checkBoxValues},object_list&&object_list.map(function(item){/**
                        course_list_name: "C++程序设计"
                        id: 3889
                        name: "作业3：第四章 控制结构 "
                        username: "Coder"
                      */return __WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("p",{className:"clearfix mb7",key:item.id},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_checkbox___default.a,{className:"fl",value:item.id,key:item.id}),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("span",{className:nav_my==='myself'?"fl with58":"fl with63"},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("label",{className:"task-hide fl",title:item.name&&item.name.length>30?item.name:"",style:{"maxWidth":"100%"}},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("a",{title:item.name},item.name))),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("span",{title:item.course_list_name&&item.course_list_name.length>10&&item.course_list_name,className:nav_my==='myself'?"fl with30 color-grey-6 task-hide pl5 bankwidth":"fl with30 color-grey-6 task-hide pl5 bankwidth2"},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("a",{title:item.course_list_name},item.course_list_name)),nav_my==='public'&&__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("span",{className:"fl with16 color-grey-6 task-hide pl10 bankwidth76"},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("a",{title:item.username,style:{width:"76px"}},item.username)),nav_my==="myself"?_this2.props.object_type&&_this2.props.object_type==="normal"?__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("a",{style:{textAlign:"center"},key:item.id,className:"color-blue font-14 pl5",onClick:function onClick(){return _this2.getotiku("/banks/normal/"+item.id+"/edit/personal?tab=0");}},"\u7F16\u8F91"):_this2.props.object_type&&_this2.props.object_type==="group"?__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("a",{style:{textAlign:"center"},key:item.id,className:"color-blue font-14 pl5",onClick:function onClick(){return _this2.getotiku("/banks/group/"+item.id+"/edit/publicly?tab=0");}},"\u7F16\u8F91"):_this2.props.object_type&&_this2.props.object_type==="exercise"?__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("a",{style:{textAlign:"center"},key:item.id,className:"color-blue font-14 pl5",onClick:function onClick(){return _this2.getotiku("/banks/exercise/"+item.id+"/edit/personal");}},"\u7F16\u8F91"):_this2.props.object_type&&_this2.props.object_type==="poll"?__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("a",{style:{textAlign:"center"},key:item.id,className:"color-blue font-14 pl5",onClick:function onClick(){return _this2.getotiku("/banks/poll/"+item.id+"/edit/personal");}},"\u7F16\u8F91"):"":"");})))),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("p",{style:{height:"20px",lineHeight:"20px;",marginTop:'4px'}},isChecked!=""?__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("span",{className:"color-red"},isChecked):""),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("div",{className:"mt10 marginauto clearfix edu-txt-center"},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("a",{onClick:this.closeSelectBank,className:"pop_close task-btn mr30"},"\u53D6\u6D88"),object_list&&object_list.length==0&&page==1?nav_my!='myself'&&is_teacher==false?__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("a",{onClick:this.closeSelectBank,className:"task-btn task-btn-orange"},"\u786E\u5B9A"):__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("a",{onClick:this.closeSelectBank,className:"task-btn task-btn-orange"},"\u786E\u5B9A"):__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("a",{className:"task-btn task-btn-orange",id:"submit_send_shixun",onClick:this.onSave},"\u786E\u5B9A"))))):"");}}]);return UseBank;}(__WEBPACK_IMPORTED_MODULE_10_react__["Component"]);/* harmony default export */ __webpack_exports__["a"] = (UseBank);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_antd_lib_pagination_style_css__ = __webpack_require__(895);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_antd_lib_pagination__ = __webpack_require__(896);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_antd_lib_checkbox__ = __webpack_require__(304);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_antd_lib_checkbox___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_antd_lib_checkbox__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_antd_lib_menu_style_css__ = __webpack_require__(962);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_antd_lib_menu__ = __webpack_require__(909);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__UseBank__ = __webpack_require__(1705);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__css_members_css__ = __webpack_require__(312);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__css_busyWork_css__ = __webpack_require__(1069);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__CommonWorkItem__ = __webpack_require__(2232);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__PublishRightnow__ = __webpack_require__(1659);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__ConnectProject__ = __webpack_require__(2199);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__coursesPublic_NoneData__ = __webpack_require__(313);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__common_titleSearch_TitleSearchSection__ = __webpack_require__(1390);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__common__ = __webpack_require__(1928);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21_lodash__ = __webpack_require__(1303);
...
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}// const Search = Input.Search;
// const map={1:"普通作业",2:"",3:"分组作业"}
// const COMMON_WORK = 1
// const COMMON_WORK = 2
var commonWork=function(_Component){_inherits(commonWork,_Component);function commonWork(props){_classCallCheck(this,commonWork);var _this=_possibleConstructorReturn(this,(commonWork.__proto__||Object.getPrototypeOf(commonWork)).call(this,props));_this.inputStudent=function(e){_this.setState({search:e.target.value});};_this.searchStudent=function(){var _this$state=_this.state,page=_this$state.page,search=_this$state.search,order=_this$state.order;_this.getList(1,search,order);};_this.openConnectionProject=function(work){_this.refs['connectProject'].openConnectionProject(work);};_this.createCommonWork=function(type){_this.props.toNewPage(_this.props.match.params);};_this.cancelDelClasses=function(){_this.setState({modalsType:false,modalsTopval:"",modalsBottomval:"",modalCancel:false});};_this._getList=function(){_this.setState({isSpin:true});var _this$state2=_this.state,page=_this$state2.page,search=_this$state2.search,order=_this$state2.order;_this.getList(page,search,order);};_this.updateNavSuccess=function(){_this._getList();};_this.useBankSuccess=function(checkBoxValues,newWorkIdArray){_this.setState({page:1,checkBoxValues:newWorkIdArray},function(){_this.refs['publishModalRef'].open();});var _this$state3=_this.state,search=_this$state3.search,order=_this$state3.order;_this.getList(1,search,order);};_this.getList=function(page,search,order){_this.setState({isSpin:true});var id=_this.props.match.params.coursesId;var workType=_this.props.getModuleType();var url="/courses/"+id+"/homework_commons.json?type="+workType+"&page="+page;if(order!=""){url+="&order="+order;}if(search!=""){url+="&search="+search;}__WEBPACK_IMPORTED_MODULE_20_axios___default.a.get(encodeURI(url)).then(function(result){if(result.status==200){_this.setState(Object.assign({mainList:result.data,totalCount:result.data.task_count,isSpin:false,page:page},result.data));}}).catch(function(error){_this.setState({isSpin:false});});};_this.selectedStatus=function(e){_this.clearSelection();_this.setState({order:e.key==="all"?"":e.key,selectedKeys:e.key,page:1,isSpin:true,checkBoxValues:[],checkAll:false});var search=_this.state.search;_this.getList(1,search,e.key==="all"?"":e.key);};_this.onPageChange=function(pageNumber){_this.setState({page:pageNumber,checkBoxValues:[]});var _this$state4=_this.state,search=_this$state4.search,order=_this$state4.order;_this.getList(pageNumber,search,order);};_this.changeAll=function(e){_this.setState({checkAll:e.target.checked});var valueId=_this.state.mainList.homeworks.map(function(item){return item.homework_id;});if(e.target.checked){var concated=_this.state.checkBoxValues.concat(valueId);var sortedUniqed=__WEBPACK_IMPORTED_MODULE_21_lodash___default.a.uniq(concated);_this.setState({checkBoxValues:sortedUniqed});}else{_this.setState({checkBoxValues:__WEBPACK_IMPORTED_MODULE_21_lodash___default.a.difference(_this.state.checkBoxValues,valueId)});}};_this.onChangeSelect=function(checkedValues){_this.setState({checkBoxValues:checkedValues,checkAll:checkedValues.length==_this.state.mainList.homeworks.length});};_this.onWorkDelete=function(){var checkBoxValues=_this.state.checkBoxValues;var len=checkBoxValues.length;if(len==0){_this.props.showNotification('请先选择要删除的作业');return;}_this.props.confirm({// content: `确认要删除所选的${len}个作业吗？`,
content:__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("div",null,__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("div",null,"\u5DF2\u63D0\u4EA4\u4F5C\u54C1\u5C06\u5168\u90E8\u88AB\u5220\u9664\uFF0C\u4E0D\u53EF\u6062\u590D"),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("div",null,"\u662F\u5426\u786E\u8BA4\u5220\u9664?")),onOk:function onOk(){var coursesId=_this.props.match.params.coursesId;var url="/courses/"+coursesId+"/homework_commons/multi_destroy.json";__WEBPACK_IMPORTED_MODULE_20_axios___default.a.post(url,{homework_ids:checkBoxValues,all_check:0// group_ids
}).then(function(response){if(response.data.status==0){_this.props.showNotification('删除成功');_this.clearSelection();var _this$state5=_this.state,search=_this$state5.search,order=_this$state5.order;_this.getList(1,search,order);_this.props.updataleftNavfun();}}).catch(function(error){console.log(error);});}});};_this.clearSelection=function(){_this.setState({checkBoxValues:[],checkAll:false});};_this.onSetPublic=function(){var checkBoxValues=_this.state.checkBoxValues;var len=checkBoxValues.length;if(len==0){_this.props.showNotification('请先选择要公开的作业');return;}_this.props.confirm({content:__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("div",null,__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("div",null,"\u8BBE\u4E3A\u516C\u5F00\u540E\uFF0C\u975E\u8BFE\u5802\u6210\u5458\u4E5F\u53EF\u4EE5\u8BBF\u95EE\u67E5\u770B"),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("div",null,"\u662F\u5426\u786E\u8BA4\u8BBE\u4E3A\u516C\u5F00\uFF1F")),onOk:function onOk(){var coursesId=_this.props.match.params.coursesId;var url="/courses/"+coursesId+"/homework_commons/set_public.json";__WEBPACK_IMPORTED_MODULE_20_axios___default.a.post(url,{homework_ids:checkBoxValues,all_check:0}).then(function(response){if(response.data.status==0){_this.props.showNotification('设为公开操作成功');var _this$state6=_this.state,search=_this$state6.search,order=_this$state6.order,page=_this$state6.page;_this.getList(page,search,order);}}).catch(function(error){console.log(error);});}});};_this.doWhenSuccess=function(){var _this$state7=_this.state,search=_this$state7.search,order=_this$state7.order,page=_this$state7.page;_this.getList(page,search,order);_this.setState({checkBoxValues:[]});};_this.onItemClick=function(item){var checkBoxValues=_this.state.checkBoxValues.slice(0);var index=checkBoxValues.indexOf(item.id);if(index!=-1){__WEBPACK_IMPORTED_MODULE_21_lodash___default.a.remove(checkBoxValues,function(listItem){return listItem===item.id;});}else{checkBoxValues.push(item.id);}_this.onChangeSelect(checkBoxValues);};_this.addToBank=function(){var checkBoxValues=_this.state.checkBoxValues;var len=checkBoxValues.length;if(len==0){_this.props.showNotification('请先选择要加入题库的作业');return;}var coursesId=_this.props.match.params.coursesId;var url="/courses/"+coursesId+"/homework_commons/add_to_homework_bank.json";__WEBPACK_IMPORTED_MODULE_20_axios___default.a.post(url,{homework_ids:checkBoxValues,all_check:0}).then(function(response){if(response.data.status==0){_this.props.showNotification('加入成功');var _this$state8=_this.state,search=_this$state8.search,order=_this$state8.order;_this.getList(1,search,order);}}).catch(function(error){console.log(error);});};_this.connectSuccess=function(){var _this$state9=_this.state,page=_this$state9.page,search=_this$state9.search,order=_this$state9.order;_this.getList(page,search,order);};_this.cancelConnectionProject=function(work){var workId=_this.props.match.params.workId;var courseId=_this.props.match.params.coursesId;var url="/homework_commons/"+work.homework_id+"/student_works/cancel_relate_project.json";__WEBPACK_IMPORTED_MODULE_20_axios___default.a.get(url).then(function(response){if(response.data.status==0){var _this$state10=_this.state,page=_this$state10.page,search=_this$state10.search,order=_this$state10.order;_this.getList(page,search,order);_this.props.showNotification('取消关联成功');}}).catch(function(error){console.log(error);});};_this.state={modalsType:"",modalsTopval:"",modalsBottomval:"",modalCancel:"",mainList:undefined,selectedKeys:'all',order:"",page:1,search:"",totalCount:0,checkAll:false,checkBoxValues:[],isSpin:false};return _this;}//输入搜索条件
//搜索查询
// 新建
_createClass(commonWork,[{key:"sureDelClasses",value:function sureDelClasses(){}},{key:"componentDidUpdate",value:function componentDidUpdate(prevProps,prevState){var _this2=this;if(prevProps.match.path!=this.props.match.path){this.clearSelection();this.setState({selectedKeys:'all',order:''},function(){_this2._getList();});}}},{key:"componentDidMount",value:function componentDidMount(){this._getList();Object(__WEBPACK_IMPORTED_MODULE_15_educoder__["_2" /* on */])('updateNavSuccess',this.updateNavSuccess);}},{key:"componentWillUnmount",value:function componentWillUnmount(){Object(__WEBPACK_IMPORTED_MODULE_15_educoder__["_1" /* off */])('updateNavSuccess',this.updateNavSuccess);}//筛选条件
// 全选和反选
// 
},{key:"render",value:function render(){var _this3=this;var _state=this.state,search=_state.search,page=_state.page,modalsType=_state.modalsType,modalsTopval=_state.modalsTopval,modalsBottomval=_state.modalsBottomval,mainList=_state.mainList,totalCount=_state.totalCount,checkAll=_state.checkAll,checkBoxValues=_state.checkBoxValues,task_count=_state.task_count,published_count=_state.published_count,unpublished_count=_state.unpublished_count,main_category_name=_state.main_category_name;var coursedata=this.props.coursedata;if(!coursedata){return'';}var workType=this.props.getModuleType();var moduleChineseName=this.props.getModuleName(true);var course_public=coursedata.course_public;var isGroup=this.props.isGroup();var isAdmin=this.props.isAdmin();// <CourseLayoutcomponent {...this.props}>
// </CourseLayoutcomponent>
return __WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("div",null,__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_14__ConnectProject__["a" /* default */],Object.assign({ref:"connectProject"},this.props,{connectSuccess:this.connectSuccess})),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_18__common_titleSearch_TitleSearchSection__["a" /* default */],{title:main_category_name,searchValue:search// searchtype={this.props.isAdmin||this.props.isStudent ?true:false}
,onInputSearchChange:this.inputStudent,onPressEnter:this.searchStudent,allowClearonChange:this.inputStudent,firstRowRight:__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_8_react___default.a.Fragment,null,isAdmin&&__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_15_educoder__["A" /* WordsBtn */],{style:"blue",className:"fr",onClick:function onClick(){return _this3.createCommonWork(1);}},"\u65B0\u5EFA"),isAdmin&&__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("li",{className:"fr"},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9__UseBank__["a" /* default */],Object.assign({},this.props,this.state,{object_type:isGroup?"group":"normal",useBankSuccess:this.useBankSuccess})))),secondRowBotton:__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("div",{className:"fl mt6 task_menu_ul"},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_menu___default.a,{mode:"horizontal",selectedKeys:this.state.selectedKeys,onClick:this.selectedStatus},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_menu___default.a.Item,{key:"all"},"\u5168\u90E8"),isAdmin&&__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_menu___default.a.Item,{key:"0"},"\u672A\u53D1\u5E03"),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_menu___default.a.Item,{key:"1"},"\u63D0\u4EA4\u4E2D"),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_menu___default.a.Item,{key:"2"},"\u8865\u4EA4\u4E2D"),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_menu___default.a.Item,{key:"3"},"\u533F\u8BC4\u4E2D"),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_menu___default.a.Item,{key:"4"},"\u7533\u8BC9\u4E2D"),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_menu___default.a.Item,{key:"5"},"\u5DF2\u622A\u6B62"))),secondRowLeft:__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("div",{style:{"display":"inline-block","marginTop":"22px"}},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("span",null,"\u5171 ",mainList&&mainList.all_count," \u4E2A",moduleChineseName),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("span",{style:{"marginLeft":"16px"}},"\u5DF2\u53D1\u5E03\uFF1A",published_count,"\u4E2A"),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("span",{style:{"marginLeft":"16px"}},"\u672A\u53D1\u5E03\uFF1A",unpublished_count,"\u4E2A")),searchPlaceholder:"请输入名称进行搜索",showSearchInput:true}),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13__PublishRightnow__["a" /* default */],Object.assign({ref:"publishModalRef",showActionButton:true},this.props,{checkBoxValues:checkBoxValues,showActionButton:false,isPublish:true,islist:true,isPublishtype:1,doWhenSuccess:this.doWhenSuccess,fromListPage:true})),mainList&&mainList.course_identity<5&&mainList.homeworks.length>0&&__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("div",{className:"mt20 edu-back-white padding20-30"},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("div",{className:"clearfix"},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_checkbox___default.a,{className:"fl",onChange:this.changeAll,checked:checkAll},"\u5DF2\u9009 ",checkBoxValues.length," \u4E2A     \uFF08\u4E0D\u652F\u6301\u8DE8\u9875\u52FE\u9009\uFF09"),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("div",{className:"studentList_operation_ul"},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("li",{className:"li_line"},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("a",{href:"javascript:void(0)",className:"color-grey-9",onClick:this.onWorkDelete},"\u5220\u9664")),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("li",{className:"li_line"},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("a",{href:"javascript:void(0)",className:"color-grey-9",onClick:function onClick(){return _this3.refs['publishModalRef'].homeworkstart();}},"立即发布")),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("li",{className:"li_line"},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13__PublishRightnow__["a" /* default */],Object.assign({showActionButton:true},this.props,{checkBoxValues:checkBoxValues,isPublish:false,doWhenSuccess:this.doWhenSuccess,fromListPage:true}))),!!course_public&&__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("li",{className:"li_line"},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("a",{href:"javascript:void(0)",onClick:this.onSetPublic,className:"color-grey-9"},"\u8BBE\u4E3A\u516C\u5F00")),this.props.user&&this.props.user.main_site===true?__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("li",null,__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("a",{href:"javascript:void(0)",className:"color-grey-9",onClick:this.addToBank},"\u52A0\u5165\u9898\u5E93")):""),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_16__modals_Modals__["a" /* default */],{modalsType:modalsType,modalsTopval:modalsTopval,modalsBottomval:modalsBottomval,modalCancel:this.cancelDelClasses,modalSave:this.sureDelClasses}))),__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_spin___default.a,{size:"large",spinning:this.state.isSpin},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_checkbox___default.a.Group,{style:{"width":"100%"},onChange:this.onChangeSelect,value:checkBoxValues},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_12__CommonWorkItem__["a" /* default */],Object.assign({mainList:mainList},this.props,{workType:workType,onItemClick:this.onItemClick,openConnectionProject:this.openConnectionProject,cancelConnectionProject:this.cancelConnectionProject})))),mainList&&mainList.homeworks&&mainList.homeworks.length==0&&__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_17__coursesPublic_NoneData__["a" /* default */],null),!!totalCount&&totalCount>15&&__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement("div",{className:"edu-txt-center pt30 pb10 clearfix"},__WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_pagination___default.a,{current:page,showQuickJumper:true,pageSize:15,total:totalCount,onChange:this.onPageChange})));}}]);return commonWork;}(__WEBPACK_IMPORTED_MODULE_8_react__["Component"]);/* harmony default export */ __webpack_exports__["default"] = (Object(__WEBPACK_IMPORTED_MODULE_19__common__["a" /* RouteHOC */])()(commonWork));
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_antd_lib_tooltip_style_css__ = __webpack_require__(172);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_antd_lib_tooltip__ = __webpack_require__(171);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_antd_lib_checkbox_style_css__ = __webpack_require__(307);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__css_members_css__ = __webpack_require__(312);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__css_members_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__css_members_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__css_busyWork_css__ = __webpack_require__(1069);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__css_busyWork_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__css_busyWork_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__coursesPublic_CoursesListType__ = __webpack_require__(1113);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_educoder__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__coursesPublic_AccessoryModal2__ = __webpack_require__(2233);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__coursesPublic_AccessoryModal__ = __webpack_require__(1389);
...
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var CommonWorkItem=function(_Component){_inherits(CommonWorkItem,_Component);function CommonWorkItem(props){_classCallCheck(this,CommonWorkItem);var _this=_possibleConstructorReturn(this,(CommonWorkItem.__proto__||Object.getPrototypeOf(CommonWorkItem)).call(this,props));_this.onItemClick=function(item){if(_this.props.checkIfLogin()===false){_this.props.showLoginDialog();return;}// if(this.props.checkIfProfileCompleted()===false){
// 	this.setState({
...
// 	return
// }
var isStudent=_this.props.isStudent();if(isStudent){_this.props.toWorkQuestionPage(_this.props.match.params,item.homework_id);}else{_this.props.toWorkListPage(_this.props.match.params,item.homework_id);}};_this.sendMoreAttachment=function(item){_this.handleItem=item;var url="/student_works/"+item.work_id+"/supply_attachments.json";__WEBPACK_IMPORTED_MODULE_11_axios___default.a.get(url,{}).then(function(response){if(response.data.revise_attachments){// response.data.revise_attachments = [
//   {
//       "id": 8686,
//       "title": "lasdl",
//       "filesize": 12323,
...
// attach to fileList
var fileList=response.data.revise_attachments.map(function(item){return{id:item.id,uid:item.id,name:item.title,url:item.url,status:'done',description:item.description,delete:item.delete,filesize:item.filesize};});_this.setState({aModalVisible:true,fileList:fileList,revise_reason:response.data.revise_reason});}}).catch(function(error){console.log(error);});};_this.toProductPage=function(item){};_this.onAccessoryModalSaves=function(newfileList,description){var url="/student_works/"+_this.handleItem.work_id+"/revise_attachment.json";__WEBPACK_IMPORTED_MODULE_11_axios___default.a.post(url,{"description":description,"attachment_ids":newfileList}).then(function(response){if(response.data.status==0){_this.props.showNotification('提交成功');}}).catch(function(error){console.log(error);});};_this.Cancelvisible=function(){_this.setState({accessoryVisible:false});};_this.addAccessory=function(){_this.setState({accessoryVisible:true});};_this.setupdate=function(){};_this.state={aModalVisible:false};return _this;}// Cancelvisible = () => {
//   this.setState({ aModalVisible: false })
// }
// 补交附件
_createClass(CommonWorkItem,[{key:"render",value:function render(){var _this2=this;var _props=this.props,mainList=_props.mainList,workType=_props.workType;var _state=this.state,aModalVisible=_state.aModalVisible,fileList=_state.fileList,revise_reason=_state.revise_reason;var coursesId=this.props.match.params.coursesId;var isStudent=this.props.isStudent();var isAdmin=this.props.isAdmin();var isAdminOrStudent=this.props.isAdminOrStudent();return __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("div",{className:"workList"},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("style",null,"\n            .comnonwidth580{\n              max-width: 580px;\n              overflow: hidden;\n              text-overflow: ellipsis;\n              white-space: nowrap;\n             }\n             a:hover{\n                 color: #4cacff;\n             }\n            "),mainList&&mainList.homeworks&&mainList.homeworks.length>0&&mainList.homeworks.map(function(item,index){var canNotLink=!isAdminOrStudent&&item.private_icon==true;return __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("div",{className:"mt20 edu-back-white padding02010",key:index},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("div",{className:"clearfix"},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("div",{className:"workList_Item"},mainList&&isAdmin&&__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("span",{className:"fl mr12"},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_checkbox___default.a,{value:item.homework_id,key:item.homework_id})),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("div",{className:"flex1",onClick:function onClick(){return _this2.props.onItemClick(Object.assign({},item,{id:item.homework_id}));}},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("p",{className:"clearfix mb20"},canNotLink?__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("span",{className:"fl font-16 font-bd mt2 comnonwidth580 pointer color-grey-name",title:canNotLink?"私有属性，非课堂成员不能访问":item.name},item.name):__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("a",{className:"fl font-16 font-bd mt2 comnonwidth580 pointer",onClick:canNotLink?function(){}:function(){return _this2.onItemClick(item);},title:item.name},item.name),item.private_icon===true?__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_tooltip___default.a,{title:"私有属性，非课堂成员不能访问",placement:"bottom"},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("i",{className:"iconfont icon-guansuo color-grey-c ml10 font-16 fl"})):"",__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("span",{className:"fl"},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7__coursesPublic_CoursesListType__["a" /* default */],{typelist:item.status}))),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("p",{className:"color-grey-9 clearfix"},item.author&&__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("span",{className:"mr20 fl"},item.author),item.commit_count===undefined?"":__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("span",{className:"mr20 fl"},item.commit_count," \u5DF2\u4EA4"),item.uncommit_count===undefined?"":__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("span",{className:"mr20 fl"},item.uncommit_count," \u672A\u4EA4"),item.status_time!=""&&__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("span",{className:"mr20 fl"},item.status_time),isAdmin&&__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("div",{className:"fr"},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_8_educoder__["A" /* WordsBtn */],{style:"blue",className:"fl font-16 ml28",onClick:canNotLink?function(){}:function(){return _this2.onItemClick(item);}},"\u67E5\u770B\u8BE6\u60C5"),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_8_educoder__["A" /* WordsBtn */],{style:"blue",className:"fl font-16 ml28",onClick:function onClick(){_this2.props.toEditPage(_this2.props.match.params,item.homework_id);}},"\u7F16\u8F91"),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_8_educoder__["A" /* WordsBtn */],{style:"blue",className:"fl font-16 ml28",onClick:function onClick(){_this2.props.toWorkSettingPage(_this2.props.match.params,item.homework_id);}},"\u8BBE\u7F6E")),//  
isStudent&&__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement("li",{className:"fr"},__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_8_educoder__["A" /* WordsBtn */],{style:"blue",className:"fl font-16",onClick:canNotLink?function(){}:function(){return _this2.onItemClick(item);}},"\u67E5\u770B\u8BE6\u60C5"),//
item.work_status&&item.work_status.indexOf('关联项目')!=-1&&__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4_react___default.a.Fragment,null,__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_8_educoder__["A" /* WordsBtn */],{style:"blue",className:" font-16 fl ml28",onClick:function onClick(){return _this2.props.toCreateProject(item);}},"\u521B\u5EFA\u9879\u76EE"),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_8_educoder__["A" /* WordsBtn */],{style:"blue",className:" font-16 fl ml28",onClick:function onClick(){return _this2.props.openConnectionProject(item);}},"\u5173\u8054\u9879\u76EE")),//
item.work_status&&item.work_status.indexOf('取消关联')!=-1&&__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_8_educoder__["A" /* WordsBtn */],{style:"blue",className:" font-16 fl ml28",onClick:function onClick(){return _this2.props.cancelConnectionProject(item);}},"\u53D6\u6D88\u5173\u8054"),//
item.work_status&&item.work_status.indexOf('提交作品')!=-1&&__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_8_educoder__["A" /* WordsBtn */],{style:"blue",className:"fl font-16 ml28",onClick:function onClick(){return _this2.props.toWorkPostPage(_this2.props.match.params,item.homework_id);}},"\u63D0\u4EA4\u4F5C\u54C1"),// 
item.work_status&&item.work_status.indexOf('补交作品')!=-1&&__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_8_educoder__["A" /* WordsBtn */],{style:"blue",className:"fl font-16 ml28",onClick:function onClick(){return _this2.props.toWorkPostPage(_this2.props.match.params,item.homework_id);}},"\u8865\u4EA4\u4F5C\u54C1"),//
item.work_status&&item.work_status.indexOf('修改作品')!=-1&&__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_8_educoder__["A" /* WordsBtn */],{style:"blue",className:"fl font-16 ml28",onClick:function onClick(){return _this2.props.toWorkPostPage(_this2.props.match.params,item.homework_id,true,item.work_id);}},"\u4FEE\u6539\u4F5C\u54C1"),//
item.work_status&&item.work_status.indexOf('补交附件')!=-1&&__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4_react___default.a.Fragment,null,__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_10__coursesPublic_AccessoryModal__["a" /* default */],Object.assign({},_this2.props,{modalname:"补交附件",visible:_this2.state.accessoryVisible,Cancelname:"取消",Savesname:"确认",Cancel:_this2.Cancelvisible,setupdate:_this2.setupdate,reviseAttachmentUrl:"/student_works/"+item.work_id+"/revise_attachment.json",seeworks:"/courses/"+_this2.props.match.params.coursesId+"/common_homeworks/"+item.homework_id+"/"+item.work_id+"/appraise"})),__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_8_educoder__["A" /* WordsBtn */],{style:"blue",className:"fl font-16 ml28",onClick:function onClick(){return _this2.addAccessory(item);}},"\u8865\u4EA4\u9644\u4EF6")),// 
item.work_status&&item.work_status.indexOf('查看作品')!=-1&&__WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_8_educoder__["A" /* WordsBtn */],{style:"blue",className:"fl font-16 ml28",onClick:function onClick(){return _this2.props.toWorkDetailPage(_this2.props.match.params,item.homework_id,item.work_id);}},"\u67E5\u770B\u4F5C\u54C1")))))));}));}}]);return CommonWorkItem;}(__WEBPACK_IMPORTED_MODULE_4_react__["Component"]);/* harmony default export */ __webpack_exports__["a"] = (CommonWorkItem);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_antd_lib_modal__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_antd_lib_modal___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_antd_lib_modal__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_antd_lib_upload_style_css__ = __webpack_require__(1076);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_antd_lib_upload__ = __webpack_require__(1077);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_antd_lib_button_style_css__ = __webpack_require__(89);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_antd_lib_button__ = __webpack_require__(75);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_antd_lib_icon__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_antd_lib_icon___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_antd_lib_icon__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_antd_lib_checkbox_style_css__ = __webpack_require__(307);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_antd_lib_checkbox__ = __webpack_require__(304);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__modals_Modals__ = __webpack_require__(175);
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var CheckboxGroup=__WEBPACK_IMPORTED_MODULE_9_antd_lib_checkbox___default.a.Group;var AccessoryModal2=function(_Component){_inherits(AccessoryModal2,_Component);function AccessoryModal2(props){_classCallCheck(this,AccessoryModal2);var _this=_possibleConstructorReturn(this,(AccessoryModal2.__proto__||Object.getPrototypeOf(AccessoryModal2)).call(this,props));_this.shixunhomeworkedit=function(list){_this.setState({group_ids:list});};_this.handleChange=function(info){if(info.file.status==='uploading'||info.file.status==='done'||info.file.status==='removed'){var fileList=info.fileList;console.log(fileList);// for(var list of fileList ){
//   console.log(fileList)
// }
_this.setState({fileList:fileList});}};_this.onAttachmentRemove=function(file){// confirm({
//   title: '确定要删除这个附件吗?',
//   okText: '确定',
//   cancelText: '取消',
...
// })
// return false;
if(!file.percent||file.percent==100){_this.deleteAttachment(file);}};_this.deleteAttachment=function(file){var url="/attachments/"+(file.response?file.response.id:file.uid)+".json";__WEBPACK_IMPORTED_MODULE_12_axios___default.a.delete(url,{}).then(function(response){if(response.data){var status=response.data.status;if(status==0){console.log('--- success');_this.setState(function(state){var index=state.fileList.indexOf(file);var newFileList=state.fileList.slice();newFileList.splice(index,1);return{fileList:newFileList};});}}}).catch(function(error){console.log(error);});};_this.ModalCancelModalCancel=function(){_this.setState({Modalstype:false,Modalstopval:"",ModalSave:_this.ModalCancelModalCancel,loadtype:false});_this.props.Cancel();};_this.componentDidUpdate=function(prevProps){if(JSON.stringify(prevProps.fileList)!=JSON.stringify(_this.props.fileList)){_this.setState({fileList:_this.props.fileList});}if(prevProps.description!=_this.props.description){_this.setState({description:_this.props.description});}};_this.Saves=function(){// debugger
var _this$state=_this.state,fileList=_this$state.fileList,description=_this$state.description;var newfileList=[];if(fileList!=undefined&&fileList.length>0){var _iteratorNormalCompletion=true;var _didIteratorError=false;var _iteratorError=undefined;try{for(var _iterator=fileList[Symbol.iterator](),_step;!(_iteratorNormalCompletion=(_step=_iterator.next()).done);_iteratorNormalCompletion=true){var list=_step.value;newfileList.push(list.response.id);}}catch(err){_didIteratorError=true;_iteratorError=err;}finally{try{if(!_iteratorNormalCompletion&&_iterator.return){_iterator.return();}}finally{if(_didIteratorError){throw _iteratorError;}}}}_this.props.Saves&&_this.props.Saves(newfileList,description);return;var id=_this.props.categoryid;console.log(newfileList);var url="/graduation_works/"+id+"/revise_attachment.json";__WEBPACK_IMPORTED_MODULE_12_axios___default.a.post(url,{description:description,attachment_ids:newfileList}).then(function(result){// console.log(result)
if(result.data.status===0){_this.props.setupdate();_this.setState({Modalstype:true,Modalstopval:result.data.message,ModalSave:_this.ModalCancelModalCancel,loadtype:true});}}).catch(function(error){});};_this.settextarea=function(e){_this.setState({description:e.target.value});};_this.state={group_ids:[],fileList:[],Modalstype:false,Modalstopval:"",ModalCancel:"",ModalSave:"",loadtype:false};return _this;}_createClass(AccessoryModal2,[{key:"componentDidMount",value:function componentDidMount(){}//勾选实训
// 附件相关 START
},{key:"render",value:function render(){var _this2=this;var _state=this.state,description=_state.description,fileList=_state.fileList,Modalstype=_state.Modalstype,Modalstopval=_state.Modalstopval,ModalCancel=_state.ModalCancel,ModalSave=_state.ModalSave,loadtype=_state.loadtype;var course_groups=this.props.course_groups;var uploadProps={width:600,// https://github.com/ant-design/ant-design/issues/15505
// showUploadList={false}，然后外部拿到 fileList 数组自行渲染列表。
// showUploadList: false,
action:Object(__WEBPACK_IMPORTED_MODULE_11_educoder__["R" /* getUploadActionUrl */])(),onChange:this.handleChange,onRemove:this.onAttachmentRemove,beforeUpload:function beforeUpload(file){console.log('beforeUpload',file.name);var isLt150M=file.size/1024/1024<150;if(!isLt150M){_this2.props.showNotification('文件大小必须小于150MB!');}return isLt150M;}};return __WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("div",null,__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13__modals_Modals__["a" /* default */],{modalsType:Modalstype,modalsTopval:Modalstopval,modalCancel:ModalCancel,modalSave:ModalSave,loadtype:loadtype}),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_modal___default.a,{className:"HomeworkModal",title:this.props.modalname||"补交附件",visible:this.props.visible,closable:false,footer:null,destroyOnClose:true,keyboard:false},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("div",{className:"task-popup-content"},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("p",{className:"task-popup-text-center font-16"},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("span",{className:"color-blue underline"}," ")),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("style",null,"\n                .uploadBtn.ant-btn {\n                  border: none;\n                  color: #4CACFF;\n                  box-shadow: none;\n                  background: transparent;\n                  padding: 0 6px;\n                }\n                .ant-upload-list-item:hover .ant-upload-list-item-info{\n                  background-color:#fff;\n                }\n                .upload_1 .ant-upload-list {\n                  width: 350px;\n                }\n                .ant-upload-select{\n                  float: left;\n                }\n                .ant-upload-list :nth-child(1).ant-upload-list-item {\n                 margin-top:31px;\n                }\n              "),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("p",null,__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_upload___default.a,Object.assign({},uploadProps,{fileList:this.state.fileList,className:"upload_1"}),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_antd_lib_button___default.a,{className:"uploadBtn"},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_antd_lib_icon___default.a,{type:"upload"})," \u9009\u62E9\u6587\u4EF6"),"(\u5355\u4E2A\u6587\u4EF6\u6700\u5927150M)")),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("textarea",{placeholder:"\u8BF7\u5728\u6B64\u8F93\u5165\u8865\u4EA4\u9644\u4EF6\u7684\u539F\u56E0\uFF0C\u6700\u5927\u9650\u5236100\u4E2A\u5B57\u7B26",className:"mt20",value:description,onInput:this.settextarea,style:{width:'100%',height:'150px',border:'1px solid rgba(234,234,234,1)',padding:'10px'}}),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("div",{className:"clearfix mt30 edu-txt-center mb10"},__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("a",{className:"task-btn color-white mr70",onClick:this.props.Cancel},this.props.Cancelname||'取消'),__WEBPACK_IMPORTED_MODULE_10_react___default.a.createElement("a",{className:"task-btn task-btn-orange",onClick:function onClick(){return _this2.Saves();}},this.props.Savesname||'确认')))));}}]);return AccessoryModal2;}(__WEBPACK_IMPORTED_MODULE_10_react__["Component"]);/* unused harmony default export */ var _unused_webpack_default_export = (AccessoryModal2);
