...
;(function(factory) {
    ...
    editormd.prototype    = editormd.fn = {
        ...
        init : function (id, options) {
            ...
            var settings         = settingNew     = $.extend(true, editormd.defaults, options);
        ...
        setTheme : function(theme) {
            ...
            var oldTheme    = settingNew.theme;
            var themePrefix = this.classPrefix + "theme-";
            
            editor.removeClass(themePrefix + oldTheme).addClass(themePrefix + theme);
            
            settingNew.theme = theme;
        ...
        setPreviewTheme : function(theme) {  
            ...
            var oldTheme    = settingNew.previewTheme;
            var themePrefix = this.classPrefix + "preview-theme-";
            
            preview.removeClass(themePrefix + oldTheme).addClass(themePrefix + theme);
            
            settingNew.previewTheme = theme;
        ...
        setMarkdown : function(md) {
            this.cm.setValue(md || settingNew.markdown);
        ...
        getHTML : function() {
            if (!settingNew.saveHTMLToTextarea)
            {
    ...
    editormd.dialogLockScreen = function() {
        var settings = settingNew || {dialogLockScreen : true};
    ...
    editormd.dialogShowMask = function(dialog) {
        var editor   = this.editor;
        var settings = settingNew || {dialogShowMask : true};
    ...
    editormd.toolbarHandlers = {
        ...
        datetime : function() {
            ...
            var selection = cm.getSelection();
            var date      = new Date();
            var langName  = settingNew.lang.name;
        ...
        watch : function() {    
            this[settingNew.watch ? "unwatch" : "watch"]();
        },
